...
define&&define.amd?define(["jquery"],e):e(jQuery)}(function($){"use strict";$.jgrid=$.jgrid||{},$.jgrid.hasOwnProperty("defaults")||($.jgrid.defaults={}),$.extend($.jgrid,{version:"5.5.4",trim:function(e){return"string"==typeof
...
e||"function"==typeof
e?"object":typeof
e},htmlDecode:function(e){return e&&("&nbsp;"===e||"&#160;"===e||1===e.length&&160===e.charCodeAt(0))?"":e&&String(e).replace(/&gt;/g,">").replace(/&lt;/g,"<").replace(/&quot;/g,'"').replace(/&amp;/g,"&")},htmlEncode:function(e){return e&&String(e).replace(/&/g,"&amp;").replace(/\"/g,"&quot;").replace(/</g,"&lt;").replace(/>/g,"&gt;")},template:function(e){var
o,n=$.makeArray(arguments).slice(1),s=n.length;return null==e&&(e=""),e.replace(/\{([\w\-]+)(?:\:([\w\.]*)(?:\((.*?)?\))?)?\}/g,function(e,t){if(!isNaN(parseInt(t,10)))return n[parseInt(t,10)];for(o=0;o<s;o++)if(Array.isArray(n[o]))for(var
...
JSON.parse?JSON.parse(js):eval("("+js+")")},parseDate:function(e,t,i,r){function
o(e,t){for(e=String(e),t=parseInt(t,10)||2;e.length<t;)e="0"+e;return e}function
n(e,t){return 0===e?12===t&&(t=0):12!==t&&(t+=12),t}var
s,a,l,d=new
RegExp("^/Date\\((([-+])?[0-9]+)(([-+])([0-9]{2})([0-9]{2}))?\\)/$"),c="string"==typeof
t?t.match(d):null,p={m:1,d:1,y:1970,h:0,i:0,s:0,u:0},u=0,g=0;if(void
...
if(null!==c)u=new
Date(parseInt(c[1],10)),c[3]&&(g=60*Number(c[5])+Number(c[6]),g*="-"===c[4]?1:-1,g-=u.getTimezoneOffset(),u.setTime(Number(Number(u)+60*g*1e3))),r.validate=!1;else{for("ISO8601Long"===r.srcformat&&"Z"===t.charAt(t.length-1)&&(g-=(new
Date).getTimezoneOffset()),t=String(t).replace(/\T/g,"#").replace(/\t/,"%").split(r.parseRe),a=0,l=(e=e.replace(/\T/g,"#").replace(/\t/,"%").split(r.parseRe)).length;a<l;a++){switch(e[a]){case"M":-1!==(s=$.inArray(t[a],r.monthNames))&&s<12&&(t[a]=s+1,p.m=t[a]);break;case"F":-1!==(s=$.inArray(t[a],r.monthNames,12))&&11<s&&(t[a]=s+1-12,p.m=t[a]);break;case"n":e[a]="m";break;case"j":e[a]="d";break;case"a":-1!==(s=$.inArray(t[a],r.AmPm))&&s<2&&t[a]===r.AmPm[s]&&(t[a]=s,p.h=n(t[a],p.h));break;case"A":-1!==(s=$.inArray(t[a],r.AmPm))&&1<s&&t[a]===r.AmPm[s]&&(t[a]=s-2,p.h=n(t[a],p.h));break;case"g":p.h=parseInt(t[a],10)}void
0!==t[a]&&(p[e[a].toLowerCase()]=parseInt(t[a],10))}if(p.f&&(p.m=p.f),0===p.m&&0===p.y&&0===p.d)return"&#160;";p.m=parseInt(p.m,10)-1;var
h=p.y;70<=h&&h<=99?p.y=1900+p.y:0<=h&&h<=69&&(p.y=2e3+p.y),u=new
Date(p.y,p.m,p.d,p.h,p.i,p.s,p.u),0!==g&&u.setTime(Number(Number(u)+60*g*1e3))}else
u=new
Date(1e3*parseFloat(t)),r.validate=!1;else
u=new
Date(p.y,p.m,p.d,p.h,p.i,p.s,p.u);if(r&&!0===r.validate){const
D=new
Date(p.y,+p.m,p.d,p.h,p.i);return Boolean(+D)&&D.getDate()===p.d&&D.getHours()===p.h&&D.getMinutes()===p.i}if(r.userLocalTime&&0===g&&0!==(g-=(new
...
f=u.getHours(),m=u.getMinutes(),v=u.getDate(),w=u.getMonth()+1,j=u.getTimezoneOffset(),_=u.getSeconds(),b=u.getMilliseconds(),d=u.getDay(),c=u.getFullYear(),h=(d+6)%7+1,g=(new
Date(c,w-1,v)-new
Date(c,0,1))/864e5,y={d:o(v),D:r.dayNames[d],j:v,l:r.dayNames[d+7],N:h,S:r.S(v),w:d,z:g,W:h<5?Math.floor((g+h-1)/7)+1:Math.floor((g+h-1)/7)||((new
Date(c-1,0,1).getDay()+6)%7<4?53:52),F:r.monthNames[w-1+12],m:o(w),M:r.monthNames[w-1],n:w,t:"?",L:"?",o:"?",Y:c,y:String(c).substring(2),a:f<12?r.AmPm[0]:r.AmPm[1],A:f<12?r.AmPm[2]:r.AmPm[3],B:"?",g:f%12||12,G:f,h:o(f%12||12),H:o(f),i:o(m),s:o(_),u:b,e:"?",I:"?",O:(0<j?"-":"+")+o(100*Math.floor(Math.abs(j)/60)+Math.abs(j)%60,4),P:"?",T:(String(u).match(/\b(?:[PMCEA][SDP]T|(?:Pacific|Mountain|Central|Eastern|Atlantic) (?:Standard|Daylight|Prevailing) Time|(?:GMT|UTC)(?:[-+]\d{4})?)\b/g)||[""]).pop().replace(/[^-+\dA-Z]/g,""),Z:"?",c:"?",r:"?",U:Math.floor(u/1e3)};return i.replace(/\\.|[dDjlNSwzWFmMntLoYyaABgGhHisueIOPTZcrU]/g,function(e){return y.hasOwnProperty(e)?y[e]:e.substring(1)})},jqID:function(e){return String(e).replace(/[!"#$%&'()*+,.\/:; <=>?@\[\\\]\^`{|}~]/g,"\\$&")},guid:1,uidPref:"jqg",randId:function(e){return(e||$.jgrid.uidPref)+$.jgrid.guid++},getAccessor:function(e,t){var
...
r=Object.prototype.toString;return void
0===i&&(i=1),void
0===e&&(e=null),void
0===t&&(t=null),null===e&&null===t?0:null===e&&null!==t?1:null!==e&&null===t?-1:("[object Date]"===r.call(e)&&"[object Date]"===r.call(t)||_usecase||"number"==typeof
e||"number"==typeof
t||(e=String(e),t=String(t)),e<t?-i:t<e?i:0)},this._performSort=function(){0!==_sorting.length&&(_data=self._doSort(_data,0))},this._doSort=function(e,t){var
i=_sorting[t].by,r=_sorting[t].dir,o=_sorting[t].type,n=_sorting[t].datefmt,s=_sorting[t].sfunc;if(t===_sorting.length-1)return self._getOrder(e,i,r,o,n,s);t++;for(var
a,l,d=self._getGroup(e,i,r,o,n),c=[],p=0;p<d.length;p++)for(l=self._doSort(d[p].items,t),a=0;a<l.length;a++)c.push(l[a]);return c},this._getOrder=function(e,i,t,r,o,n){var
s,a,l,d,c=[],p=[],u="a"===t?1:-1;void
...
0===(a=""!==i?$.jgrid.getAccessor(t,i):t)&&(a=""),a=d(a,t),p.push({vSort:a,index:e})}),$.jgrid.isFunction(n)?p.sort(function(e,t){return n.call(this,e.vSort,t.vSort,u,e,t)}):p.sort(function(e,t){return self._compare(e.vSort,t.vSort,u)}),l=0;for(var
g=e.length;l<g;)s=p[l].index,c.push(e[s]),l++;return c},this._getGroup=function(e,i,t,r,o){var
n,s=[],a=null,l=null;return $.each(self._getOrder(e,i,t,r,o),function(e,t){null==(n=$.jgrid.getAccessor(t,i))&&(n=""),self._equals(l,n)||(l=n,null!==a&&s.push(a),a=self._group(i,n)),a.items.push(t)}),null!==a&&s.push(a),s},this.ignoreCase=function(){return _usecase=!1,self},this.useCase=function(){return _usecase=!0,self},this.trim=function(){return _trim=!0,self},this.noTrim=function(){return _trim=!1,self},this.execute=function(){var
...
0===i&&(i=null);var
s=i,a=void
0===o.stype?"text":o.stype;if(null!==i)switch(a){case"int":case"integer":n="parseInt("+n+",10)",s="parseInt("+(s=isNaN(Number(s))||""===s?Number.NEGATIVE_INFINITY:s)+",10)";break;case"float":case"number":case"numeric":s=String(s).replace(_stripNum,""),n="parseFloat("+n+")",s="parseFloat("+(s=isNaN(Number(s))||""===s?Number.NEGATIVE_INFINITY:Number(s))+")";break;case"date":case"datetime":s=String($.jgrid.parseDate.call($t,o.srcfmt||"Y-m-d",s).getTime()),n='jQuery.jgrid.parseDate.call(jQuery("#'+$.jgrid.jqID($t.p.id)+'")[0],"'+o.srcfmt+'",'+n+").getTime()";break;default:n=self._getStr(n),s=self._getStr('"'+self._toStr(s)+'"')}return self._append(n+" "+r+" "+s),self._setCommand(e,t),self._resetNegate(),self},this.equals=function(e,t,i){return self._compareValues(self.equals,e,t,"==",i)},this.notEquals=function(e,t,i){return self._compareValues(self.equals,e,t,"!==",i)},this.isNull=function(e,t,i){return self._compareValues(self.equals,e,null,"===",i)},this.greater=function(e,t,i){return self._compareValues(self.greater,e,t,">",i)},this.less=function(e,t,i){return self._compareValues(self.less,e,t,"<",i)},this.greaterOrEquals=function(e,t,i){return self._compareValues(self.greaterOrEquals,e,t,">=",i)},this.lessOrEquals=function(e,t,i){return self._compareValues(self.lessOrEquals,e,t,"<=",i)},this.startsWith=function(e,t){var
...
0!==n[r]?n[r]:o,n=null))),(a={})[h.id]=o,m&&(i=$.jgrid.getAccessor(i,m)||i),c=Array.isArray(i)?l:d,t=0;t<c.length;t++)s=$.jgrid.getAccessor(i,c[t]),a[f[t+v].name]=s;u[e]=a}},oe=function(){var
e,t,i=W.p.data.length,r=!1!==W.p.keyName?W.p.keyName:r=W.p.localReader.id;for(W.p._index={},e=0;e<i;e++)void
0===(t=$.jgrid.getAccessor(W.p.data[e],r))&&(t=String(e+1)),W.p._index[t]=e},ne=function(e,t,i,r,o){var
n,s="-1",a="",t=t?"display:none;":"",l=$(W).triggerHandler("jqGridRowAttr",[r,o,e]);if("object"!=typeof
l&&(l=$.jgrid.isFunction(W.p.rowattr)?W.p.rowattr.call(W,r,o,e):"string"==typeof
W.p.rowattr&&null!=$.jgrid.rowattr&&$.jgrid.isFunction($.jgrid.rowattr[W.p.rowattr])?$.jgrid.rowattr[W.p.rowattr].call(W,r,o,e):{}),!$.isEmptyObject(l)){l.hasOwnProperty("id")&&(e=l.id,delete
l.id),l.hasOwnProperty("tabindex")&&(s=l.tabindex,delete
l.tabindex),l.hasOwnProperty("style")&&(t+=l.style,delete
l.style),l.hasOwnProperty("class")&&(i+=" "+l.class,delete
l.class);try{delete
l.role}catch(e){}for(n
in
l)l.hasOwnProperty(n)&&(a+=" "+n+"="+l[n])}return'<tr role="row" id="'+e+'" tabindex="'+s+'" class="'+i+'"'+(""===t?"":' style="'+t+'"')+a+">"},m=function(e,i,t,r){var
o=new
Date,n="local"!==W.p.datatype&&W.p.loadonce||"xmlstring"===W.p.datatype,s="_id_",a=W.p.xmlReader,l=[],d="local"===W.p.datatype?"local":"xml";if(n&&(W.p.data=[],W.p._index={},W.p.localReader.id=s),W.p.reccount=0,$.isXMLDoc(e)){i=-1!==W.p.treeANode||W.p.scroll?1<i?i:1:(re.call(W,!1,!1),1);var
c,p,u,g,h,f,m,v,w,j=$(W),_=0,b=!0===W.p.multiselect?1:0,y=0,D=!0===W.p.rownumbers?1:0,x=[],q={},C=[],I=K(X,"rowBox",!0,"jqgrow ui-row-"+W.p.direction);!0===W.p.subGrid&&(y=1,g=$.jgrid.getMethod("addSubGridCell")),a.repeatitems||(x=te(d)),h=!1===W.p.keyName?$.jgrid.isFunction(a.id)?a.id.call(W,e):a.id:W.p.keyName,a.repeatitems&&W.p.keyName&&isNaN(h)&&(h=W.p.keyIndex),f=-1===String(h).indexOf("[")?x.length?function(e,t){return $(h,e).text()||t}:function(e,t){return $(a.cell,e).eq(h).text()||t}:function(e,t){return e.getAttribute(h.replace(/[\[\]]/g,""))||t},W.p.userData={},W.p.page=Y($.jgrid.getXmlData(e,a.page),W.p.page),W.p.lastpage=Y($.jgrid.getXmlData(e,a.total),1),W.p.records=Y($.jgrid.getXmlData(e,a.records)),$.jgrid.isFunction(a.userdata)?W.p.userData=a.userdata.call(W,e)||{}:$.jgrid.getXmlData(e,a.userdata,!0).each(function(){W.p.userData[this.getAttribute("name")]=$(this).text()});var
G,S,k=$.jgrid.getXmlData(e,a.root,!0),N=(k=(k=$.jgrid.getXmlData(k,a.row,!0))||[]).length,M=0,R=[],z=parseInt(W.p.rowNum,10),F=W.p.scroll?$.jgrid.randId():1,P=$(W).find("tbody").first(),B=!1;if(W.p.grouping&&(B=!0===W.p.groupingView.groupCollapse,G=$.jgrid.getMethod("groupingPrepare")),0<N&&W.p.page<=0&&(W.p.page=1),k&&N){r&&(z*=r+1);for(var
A=$.jgrid.isFunction(W.p.afterInsertRow),O=D?K(X,"rownumBox",!1,"jqgrid-rownum"):"",T=b?K(X,"multiBox",!1,"cbox"):"";M<N;){v=k[M],w=f(v,F+M),w=W.p.idPrefix+w,W.p.preserveSelection&&(W.p.multiselect?(S=-1!==W.p.selarrrow.indexOf(w),V=S?V+1:V):S=w===W.p.selrow);var
H=C.length;if(C.push(""),D&&C.push(ee(0,M,W.p.page,W.p.rowNum,O)),b&&C.push(Z(w,D,M,S,T)),y&&C.push(g.call(j,b+D,M+i)),a.repeatitems){m=m||ie(b+y+D);var
L=$.jgrid.getXmlData(v,a.cell,!0);$.each(m,function(e){var
t=L[this];if(!t)return!1;u=t.textContent||t.text||"",q[W.p.colModel[e+b+y+D].name]=u,C.push(J(w,u,e+b+y+D,M+i,v,q))})}else
for(c=0;c<x.length;c++)u=$.jgrid.getXmlData(v,x[c]),q[W.p.colModel[c+b+y+D].name]=u,C.push(J(w,u,c+b+y+D,M+i,v,q));if(C[H]=ne(w,B,I,q,v),C.push("</tr>"),W.p.grouping&&(R.push(C),W.p.groupingView._locgr||G.call(j,q,M),C=[]),(n||!0===W.p.treeGrid&&!W.p._ald)&&(q[s]=$.jgrid.stripPref(W.p.idPrefix,w),W.p.data.push(q),W.p._index[q[s]]=W.p.data.length-1,-1<W.p.treeANode&&"adjacency"===W.p.treeGridModel&&l.push(q)),!1===W.p.gridview&&(P.append(C.join("")),j.triggerHandler("jqGridAfterInsertRow",[w,q,v]),A&&W.p.afterInsertRow.call(W,w,q,v),C=[]),q={},M++,++_===z)break}}if(V=W.p.multiselect&&W.p.preserveSelection&&_===V,!0===W.p.gridview&&(p=-1<W.p.treeANode?W.p.treeANode:0,W.p.grouping?n||(j.jqGrid("groupingRender",R,W.p.colModel.length,W.p.page,z),R=null):!0===W.p.treeGrid&&0<p?$(W.rows[p]).after(C.join("")):(P.append(C.join("")),W.grid.cols=W.rows[0].cells)),W.p.totaltime=new
Date-o,C=null,0<_&&0===W.p.records&&(W.p.records=N),!0===W.p.treeGrid){try{j.jqGrid("setTreeNode",p+1,_+p+1)}catch(e){}if(-1<W.p.treeANode&&"adjacency"===W.p.treeGridModel&&(u=W.rows[W.p.treeANode].id,1<=(u=W.p._index[u]+1))){for(W.p.data.splice(-N,N),c=0;c<N;c++)W.p.data.splice(u+c,0,l[c]);oe()}}if(W.p.reccount=_,W.p.treeANode=-1,W.p.userDataOnFooter&&j.jqGrid("footerData","set",W.p.userData,W.p.formatFooterData),W.p.userDataOnHeader&&j.jqGrid("headerData","set",W.p.userData,W.p.formatHeaderData),n&&(W.p.records=N,W.p.lastpage=Math.ceil(N/z)),t||W.updatepager(!1,!0),V&&se(!0),n){for(;_<N;){if(v=k[_],w=f(v,_+F),w=W.p.idPrefix+w,a.repeatitems){m=m||ie(b+y+D);var
U=$.jgrid.getXmlData(v,a.cell,!0);$.each(m,function(e){var
t=U[this];if(!t)return!1;u=t.textContent||t.text||"",q[W.p.colModel[e+b+y+D].name]=u})}else
for(c=0;c<x.length;c++)u=$.jgrid.getXmlData(v,x[c]),q[W.p.colModel[c+b+y+D].name]=u;q[s]=$.jgrid.stripPref(W.p.idPrefix,w),W.p.grouping&&G.call(j,q,_),W.p.data.push(q),W.p._index[q[s]]=W.p.data.length-1,q={},_++}W.p.grouping&&(W.p.groupingView._locgr=!0,j.jqGrid("groupingRender",R,W.p.colModel.length,W.p.page,z),R=null)}if(!0===W.p.subGrid)try{j.jqGrid("addSubGrid",b+D)}catch(e){}}},j=function(e,t,i,r){var
o,n,s=new
Date;if(e){t=-1!==W.p.treeANode||W.p.scroll?1<t?t:1:(re.call(W,!1,!1),1),n="local"===W.p.datatype?(o=W.p.localReader,"local"):(o=W.p.jsonReader,"json");var
a,l,d,c,p,u,g,h,f,m,v,w,j="_id_",_="local"!==W.p.datatype&&W.p.loadonce||"jsonstring"===W.p.datatype,b=$(W),y=0,D=[],x=W.p.multiselect?1:0,q=!0===W.p.subGrid?1:0,C=!0===W.p.rownumbers?1:0,I=W.p.scroll&&"local"!==W.p.datatype?$.jgrid.randId():1,G=parseInt(W.p.rowNum,10),S=!1,k=ie(x+q+C),N=te(n),M={},R=[],z=[],F=K(X,"rowBox",!0,"jqgrow ui-row-"+W.p.direction),P=$.jgrid.isFunction(W.p.afterInsertRow),B=[],A=!1,O=$(W).find("tbody").first(),T=C?K(X,"rownumBox",!1,"jqgrid-rownum"):"",H=x?K(X,"multiBox",!1,"cbox"):"";for(_&&(W.p.data=[],W.p._index={},W.p.localReader.id=j),W.p.reccount=0,W.p.page=Y($.jgrid.getAccessor(e,o.page),W.p.page),W.p.lastpage=Y($.jgrid.getAccessor(e,o.total),1),W.p.records=Y($.jgrid.getAccessor(e,o.records)),W.p.userData=$.jgrid.getAccessor(e,o.userdata)||{},q&&(c=$.jgrid.getMethod("addSubGridCell")),f=!1===W.p.keyName?$.jgrid.isFunction(o.id)?o.id.call(W,e):o.id:W.p.keyName,o.repeatitems&&W.p.keyName&&isNaN(f)&&(f=W.p.keyIndex),null==(h=$.jgrid.getAccessor(e,o.root))&&Array.isArray(e)&&(h=e),(l=0)<(g=(h=h||[]).length)&&W.p.page<=0&&(W.p.page=1),r&&(G*=r+1),"local"!==W.p.datatype||W.p.deselectAfterSort||(S=!0),W.p.grouping&&(A=!0===W.p.groupingView.groupCollapse,v=$.jgrid.getMethod("groupingPrepare"));l<g;){var
L,U=h[l];void
0===(L=$.jgrid.getAccessor(U,f))&&("number"==typeof
f&&null!=W.p.colModel[f+x+q+C]&&(L=$.jgrid.getAccessor(U,W.p.colModel[f+x+q+C].name)),void
0===L&&(L=I+l,0===D.length&&o.cell&&(L=null!=(E=$.jgrid.getAccessor(U,o.cell)||U)&&void
0!==E[f]?E[f]:L,E=null))),L=W.p.idPrefix+L,(S||W.p.preserveSelection)&&(W.p.multiselect?(p=-1!==W.p.selarrrow.indexOf(L),V=p?V+1:V):p=L===W.p.selrow);var
E=R.length;for(R.push(""),C&&R.push(ee(0,l,W.p.page,W.p.rowNum,T)),x&&R.push(Z(L,C,l,p,H)),q&&R.push(c.call(b,x+C,l+t)),u=N,o.repeatitems&&(o.cell&&(U=$.jgrid.getAccessor(U,o.cell)||U),Array.isArray(U)&&(u=k)),d=0;d<u.length;d++)a=$.jgrid.getAccessor(U,u[d]),M[W.p.colModel[d+x+q+C].name]=a,R.push(J(L,a,d+x+q+C,l+t,U,M));if(R[E]=ne(L,A,p?F+" "+Q:F,M,U),R.push("</tr>"),W.p.grouping&&(B.push(R),W.p.groupingView._locgr||v.call(b,M,l),R=[]),(_||!0===W.p.treeGrid&&!W.p._ald)&&(M[j]=$.jgrid.stripPref(W.p.idPrefix,L),W.p.data.push(M),W.p._index[M[j]]=W.p.data.length-1,-1<W.p.treeANode&&"adjacency"===W.p.treeGridModel&&z.push(M)),!1===W.p.gridview&&(O.append(R.join("")),b.triggerHandler("jqGridAfterInsertRow",[L,M,U]),P&&W.p.afterInsertRow.call(W,L,M,U),R=[]),M={},l++,++y===G)break}if(V=W.p.multiselect&&(W.p.preserveSelection||S)&&y===V,!0===W.p.gridview&&(m=-1<W.p.treeANode?W.p.treeANode:0,W.p.grouping?_||(b.jqGrid("groupingRender",B,W.p.colModel.length,W.p.page,G),B=null):!0===W.p.treeGrid&&0<m?$(W.rows[m]).after(R.join("")):(O.append(R.join("")),W.grid.cols=W.rows[0].cells)),W.p.totaltime=new
Date-s,R=null,0<y&&0===W.p.records&&(W.p.records=g),!0===W.p.treeGrid){try{b.jqGrid("setTreeNode",m+1,y+m+1)}catch(e){}if(-1<W.p.treeANode&&"adjacency"===W.p.treeGridModel&&(a=W.rows[W.p.treeANode].id,1<=(a=W.p._index[a]+1))){for(W.p.data.splice(-g,g),l=0;l<g;l++)W.p.data.splice(a+l,0,z[l]);oe()}}if(W.p.reccount=y,W.p.treeANode=-1,W.p.userDataOnFooter&&b.jqGrid("footerData","set",W.p.userData,W.p.formatFooterData),W.p.userDataOnHeader&&b.jqGrid("headerData","set",W.p.userData,W.p.formatHeaderData),_&&(W.p.records=g,W.p.lastpage=Math.ceil(g/G)),i||W.updatepager(!1,!0),V&&se(!0),_){for(;y<g&&h[y];){if(U=h[y],void
0===(L=$.jgrid.getAccessor(U,f))&&("number"==typeof
f&&null!=W.p.colModel[f+x+q+C]&&(L=$.jgrid.getAccessor(U,W.p.colModel[f+x+q+C].name)),void
0===L&&(L=I+y,0===D.length&&o.cell&&(L=null!=(w=$.jgrid.getAccessor(U,o.cell)||U)&&void
0!==w[f]?w[f]:L,w=null))),U){for(L=W.p.idPrefix+L,u=N,o.repeatitems&&(o.cell&&(U=$.jgrid.getAccessor(U,o.cell)||U),Array.isArray(U)&&(u=k)),d=0;d<u.length;d++)M[W.p.colModel[d+x+q+C].name]=$.jgrid.getAccessor(U,u[d]);M[j]=$.jgrid.stripPref(W.p.idPrefix,L),W.p.grouping&&v.call(b,M,y),W.p.data.push(M),W.p._index[M[j]]=W.p.data.length-1,M={}}y++}W.p.grouping&&(W.p.groupingView._locgr=!0,b.jqGrid("groupingRender",B,W.p.colModel.length,W.p.page,G),B=null)}if(!0===W.p.subGrid)try{b.jqGrid("addSubGrid",x+C)}catch(e){}}},D=function(e){var
t,i,r,o,n=W.p.multiSort?[]:"",s=[],a=!1,c={},l=[],d=[];if(Array.isArray(W.p.data)){var
p,u,g,h=!!W.p.grouping&&W.p.groupingView;if($.each(W.p.colModel,function(){if("cb"===this.name||"subgrid"===this.name||"rn"===this.name)return!0;if(i=this.sorttype||"text",g=this.index||this.name,"date"===i||"datetime"===i?(this.formatter&&"string"==typeof
this.formatter&&"date"===this.formatter?(t=this.formatoptions&&this.formatoptions.srcformat?this.formatoptions.srcformat:$.jgrid.getRegional(W,"formatter.date.srcformat"),r=this.formatoptions&&this.formatoptions.newformat?this.formatoptions.newformat:$.jgrid.getRegional(W,"formatter.date.newformat")):t=r=this.datefmt||"Y-m-d",c[g]={stype:i,srcfmt:t,newfmt:r,sfunc:this.sortfunc||null,name:this.name}):c[g]={stype:i,srcfmt:"",newfmt:"",sfunc:this.sortfunc||null,name:this.name},W.p.grouping)for(u=0,p=h.groupField.length;u<p;u++)this.name===h.groupField[u]&&(l[u]=c[g],d[u]=g);W.p.multiSort||a||g!==W.p.sortname||(n=g,a=!0)}),W.p.multiSort&&(n=I,s=G),!W.p.treeGrid||!W.p._sort){var
f={eq:function(e){return e.equals},ne:function(e){return e.notEquals},lt:function(e){return e.less},le:function(e){return e.lessOrEquals},gt:function(e){return e.greater},ge:function(e){return e.greaterOrEquals},cn:function(e){return e.contains},nc:function(e,t){return("OR"===t?e.orNot():e.andNot()).contains},bw:function(e){return e.startsWith},bn:function(e,t){return("OR"===t?e.orNot():e.andNot()).startsWith},en:function(e,t){return("OR"===t?e.orNot():e.andNot()).endsWith},ew:function(e){return e.endsWith},ni:function(e,t){return("OR"===t?e.orNot():e.andNot()).inData},in:function(e){return e.inData},nu:function(e){return e.isNull},nn:function(e,t){return("OR"===t?e.orNot():e.andNot()).isNull}},m=$.jgrid.from.call(W,W.p.data);if(W.p.ignoreCase&&(m=m.ignoreCase()),!0===W.p.search){var
v=W.p.postData.filters;if(v)"string"==typeof
v&&(v=$.jgrid.parse(v)),function
e(t){var
i,r,o,n,s,a,l,d=0;if(null!=t.groups){for((r=t.groups.length&&"OR"===t.groupOp.toString().toUpperCase())&&m.orBegin(),i=0;i<t.groups.length;i++){0<d&&r&&m.or();try{e(t.groups[i])}catch(e){alert(e)}d++}r&&m.orEnd()}if(null!=t.rules)try{for((l=t.rules.length&&"OR"===t.groupOp.toString().toUpperCase())&&m.orBegin(),i=0;i<t.rules.length;i++){if(n=t.rules[i],o=t.groupOp.toString().toUpperCase(),f[n.op]&&n.field){0<d&&o&&"OR"===o&&(m=m.or()),a=n.field,W.p.useNameForSearch&&c.hasOwnProperty(n.field)&&(a=c[n.field].name);try{"date"===(s=c[n.field]).stype&&"string"==typeof
s.srcfmt&&"string"==typeof
s.newfmt&&(n.data=$.jgrid.parseDate.call(W,s.newfmt,n.data,s.srcfmt)),m=f[n.op](m,o)(a,n.data,s)}catch(e){}}else
void
0!==W.p.customFilterDef&&void
0!==W.p.customFilterDef[n.op]&&$.jgrid.isFunction(W.p.customFilterDef[n.op].action)&&(m=m.user.call(W,n.op,n.field,n.data));d++}l&&m.orEnd()}catch(e){alert(e)}}(v);else
try{"date"===(o=c[W.p.postData.searchField]).stype&&o.srcfmt&&o.newfmt&&o.srcfmt!==o.newfmt&&(W.p.postData.searchString=$.jgrid.parseDate.call(W,o.newfmt,W.p.postData.searchString,o.srcfmt)),f[W.p.postData.searchOper]?m=f[W.p.postData.searchOper](m)(W.p.postData.searchField,W.p.postData.searchString,c[W.p.postData.searchField]):void
0!==W.p.customFilterDef&&void
0!==W.p.customFilterDef[W.p.postData.searchOper]&&$.jgrid.isFunction(W.p.customFilterDef[W.p.postData.searchOper].action)&&(m=m.user.call(W,W.p.postData.searchOper,W.p.postData.searchField,W.p.postData.searchString))}catch(e){}}if(W.p.treeGrid&&"nested"===W.p.treeGridModel&&m.orderBy(W.p.treeReader.left_field,"asc","integer","",null),W.p.treeGrid&&"adjacency"===W.p.treeGridModel&&(p=0,n=null),W.p.grouping)for(u=0;u<p;u++)m.orderBy(d[u],h.groupOrder[u],l[u].stype,l[u].srcfmt);W.p.multiSort?$.each(n,function(e){m.orderBy(this,s[e],c[this].stype,c[this].srcfmt,c[this].sfunc)}):n&&W.p.sortorder&&a&&("DESC"===W.p.sortorder.toUpperCase()?m.orderBy(W.p.sortname,"d",c[n].stype,c[n].srcfmt,c[n].sfunc):m.orderBy(W.p.sortname,"a",c[n].stype,c[n].srcfmt,c[n].sfunc));var
w=m.select(),j=parseInt(W.p.rowNum,10),_=w.length,b=parseInt(W.p.page,10),y=Math.ceil(_/j),v={};if((W.p.search||W.p.resetsearch)&&W.p.grouping&&W.p.groupingView._locgr){W.p.groupingView.groups=[];var
D,x,q,C=$.jgrid.getMethod("groupingPrepare");if(W.p.footerrow&&W.p.userDataOnFooter){for(x
in
W.p.userData)W.p.userData.hasOwnProperty(x)&&(W.p.userData[x]=0);q=!0}for(D=0;D<_;D++){if(q)for(x
in
W.p.userData)W.p.userData.hasOwnProperty(x)&&(W.p.userData[x]+=parseFloat(w[D][x]||0));C.call($(W),w[D],D,j)}}return e?w:(w=W.p.treeGrid&&W.p.search?$(W).jqGrid("searchTree",w):w.slice((b-1)*j,b*j),c=m=null,v[W.p.localReader.total]=y,v[W.p.localReader.page]=b,v[W.p.localReader.records]=_,v[W.p.localReader.root]=w,v[W.p.localReader.userdata]=W.p.userData,w=null,v)}$(W).jqGrid("SortTree",n,W.p.sortorder,c[n].stype||"text",c[n].srcfmt||"")}},x=function(){W.grid.hDiv.loading=!0,W.p.hiddengrid||$(W).jqGrid("progressBar",{method:"show",loadtype:W.p.loadui,htmlcontent:$.jgrid.getRegional(W,"defaults.loadtext",W.p.loadtext)})},q=function(){W.grid.hDiv.loading=!1,$(W).jqGrid("progressBar",{method:"hide",loadtype:W.p.loadui})},C=function(e,t,i){var
r=void
0===(r=$(W).triggerHandler("jqGridBeforeProcessing",[e,t,i]))||"boolean"!=typeof
r||r;return $.jgrid.isFunction(W.p.beforeProcessing)&&!1===W.p.beforeProcessing.call(W,e,t,i)&&(r=!1),r},S=function(e,t){$(W).triggerHandler("jqGridLoadComplete",[e]),t&&W.p.loadComplete.call(W,e),$(W).triggerHandler("jqGridAfterLoadComplete",[e]),W.p.datatype="local",W.p.datastr=null,q()},k=function(r){if(!W.grid.hDiv.loading){var
o,n=W.p.scroll&&!1===r,e={},t=W.p.prmNames;V=0,W.p.page<=0&&(W.p.page=Math.min(1,W.p.lastpage)),null!==t.search&&(e[t.search]=W.p.search),null!==t.nd&&(e[t.nd]=(new
Date).getTime()),null!==t.rows&&(e[t.rows]=W.p.rowNum),null!==t.page&&(e[t.page]=W.p.page),null!==t.sort&&(e[t.sort]=W.p.sortname),null!==t.order&&(e[t.order]=W.p.sortorder),null!==W.p.rowTotal&&null!==t.totalrows&&(e[t.totalrows]=W.p.rowTotal);var
i=$.jgrid.isFunction(W.p.loadComplete),s=i?W.p.loadComplete:null,a=0;if(1<(r=r||1)?null!==t.npage?(e[t.npage]=r,a=r-1,r=1):s=function(e){W.p.page++,W.grid.hDiv.loading=!1,i&&W.p.loadComplete.call(W,e),k(r-1)}:null!==t.npage&&delete
W.p.postData[t.npage],W.p.grouping){$(W).jqGrid("groupingSetup");for(var
l,d=W.p.groupingView,c=[],p=0;p<d.groupField.length;p++){var
u=d.groupField[p];$.each(W.p.colModel,function(e,t){t.name===u&&t.index&&(u=t.index)}),c.push(u+" "+d.groupOrder[p])}l=c.join(),""!==$.jgrid.trim(e[t.sort])?e[t.sort]=l+" ,"+e[t.sort]:(e[t.sort]=l,e[t.order]="")}$.extend(W.p.postData,e);var
g=W.p.scroll?W.rows.length-1:1;if($.jgrid.isFunction(W.p.datatype))W.p.datatype.call(W,W.p.postData,"load_"+W.p.id,g,r,a);else{e=$(W).triggerHandler("jqGridBeforeRequest");if(!1!==e&&"stop"!==e&&(!$.jgrid.isFunction(W.p.beforeRequest)||!1!==(e=W.p.beforeRequest.call(W))&&"stop"!==e)){switch($.jgrid.isFunction(W.treeGrid_beforeRequest)&&W.treeGrid_beforeRequest.call(W),o=W.p.datatype.toLowerCase()){case"json":case"jsonp":case"xml":case"script":$.ajax($.extend({url:W.p.url,type:W.p.mtype,dataType:o,data:$.jgrid.isFunction(W.p.serializeGridData)?W.p.serializeGridData.call(W,W.p.postData):W.p.postData,success:function(e,t,i){C(e,t,i)?(("xml"===o?m:j)(e,g,1<r,a),$(W).triggerHandler("jqGridLoadComplete",[e]),s&&s.call(W,e),$(W).triggerHandler("jqGridAfterLoadComplete",[e]),n&&W.grid.populateVisible(),W.p.treeGrid_bigData?W.p.loadonce&&(W.p.datatype="local"):(W.p.loadonce||W.p.treeGrid)&&(W.p.datatype="local"),e=null,1===r&&q(),$.jgrid.isFunction(W.treeGrid_afterLoadComplete)&&W.treeGrid_afterLoadComplete.call(W)):q()},error:function(e,t,i){$(W).triggerHandler("jqGridLoadError",[e,t,i]),$.jgrid.isFunction(W.p.loadError)&&W.p.loadError.call(W,e,t,i),1===r&&q(),e=null},beforeSend:function(e,t){var
i=!0,i=$(W).triggerHandler("jqGridLoadBeforeSend",[e,t]);if($.jgrid.isFunction(W.p.loadBeforeSend)&&(i=W.p.loadBeforeSend.call(W,e,t)),void
0===i&&(i=!0),!1===i)return!1;x()}},$.jgrid.ajaxOptions,W.p.ajaxGridOptions));break;case"xmlstring":if(x(),h="string"!=typeof
W.p.datastr?W.p.datastr:$.parseXML(W.p.datastr),!C(h,200,null))return void
q();m(h),S(h,i);break;case"jsonstring":if(x(),h="string"==typeof
W.p.datastr?$.jgrid.parse(W.p.datastr):W.p.datastr,!C(h,200,null))return void
q();j(h),S(h,i);break;case"local":case"clientside":x(),W.p.datatype="local",W.p._ald=!0;var
h=D(!1);if(!C(h,200,null))return void
q();j(h,g,1<r,a),$(W).triggerHandler("jqGridLoadComplete",[h]),s&&s.call(W,h),$(W).triggerHandler("jqGridAfterLoadComplete",[h]),n&&W.grid.populateVisible(),q(),W.p._ald=!1}W.p._sort=!1}}}},se=function(e){$("#cb_"+$.jgrid.jqID(W.p.id),W.grid.hDiv)[W.p.useProp?"prop":"attr"]("checked",e),(W.p.frozenColumns?W.p.id+"_frozen":"")&&$("#cb_"+$.jgrid.jqID(W.p.id),W.grid.fhDiv)[W.p.useProp?"prop":"attr"]("checked",e)},N=function(e,a){function
l(e,t){var
i=$(W).triggerHandler("jqGridPaging",[e,t]);return"stop"!==i&&($.jgrid.isFunction(W.p.onPaging)&&(i=W.p.onPaging.call(W,e,t)),"stop"!==i&&(W.p.selrow=null,W.p.multiselect&&(W.p.preserveSelection||(W.p.selarrrow=[]),se(!1)),W.p.savedRow=[]))}var
t,i,r,o,n,s,d,c,p,u="<td class='ui-pg-button "+w+"'><span class='ui-separator'></span></td>",g="",h="<table class='ui-pg-table ui-common-table ui-paging-pager'><tbody><tr>",f="";if(a+="_"+e,t="pg_"+e,p=e+"_left",d=e+"_center",c=e+"_right",$("#"+$.jgrid.jqID(e)).append("<div id='"+t+"' class='ui-pager-control' role='group'><table "+K(X,"pagerTable",!1,"ui-pg-table ui-common-table ui-pager-table")+"><tbody><tr><td id='"+p+"' align='left'></td><td id='"+d+"' align='center' style='white-space:pre;'></td><td id='"+c+"' align='right'></td></tr></tbody></table></div>").attr("dir",v),0<W.p.rowList.length){var
m,f='<td dir="'+v+'">';for(f+="<select "+K(X,"pgSelectBox",!1,"ui-pg-selbox")+' size="1" role="listbox" title="'+($.jgrid.getRegional(W,"defaults.pgrecs",W.p.pgrecs)||"")+'">',i=0;i<W.p.rowList.length;i++)1===(m=W.p.rowList[i].toString().split(":")).length&&(m[1]=m[0]),f+='<option role="option" value="'+m[0]+'"'+(Y(W.p.rowNum,0)===Y(m[0],0)?' selected="selected"':"")+">"+m[1]+"</option>";f+="</select></td>"}"rtl"===v&&(h+=f,$("#"+c).attr("align","left")),!0===W.p.pginput&&(g="<td id='input"+a+"' dir='"+v+"'>"+$.jgrid.template($.jgrid.getRegional(W,"defaults.pgtext",W.p.pgtext)||"","<input class='ui-pg-input' type='text' size='2' maxlength='7' value='0' role='textbox'/>","<span id='sp_1_"+$.jgrid.jqID(e)+"'></span>")+"</td>"),!0===W.p.pgbuttons?(o=["first"+a,"prev"+a,"next"+a,"last"+a],n=K(X,"pgButtonBox",!0,"ui-pg-button"),p=[$.jgrid.getRegional(W,"defaults.pgfirst",W.p.pgfirst)||"",$.jgrid.getRegional(W,"defaults.pgprev",W.p.pgprev)||"",$.jgrid.getRegional(W,"defaults.pgnext",W.p.pgnext)||"",$.jgrid.getRegional(W,"defaults.pglast",W.p.pglast)||""],"rtl"===v&&(o.reverse(),p.reverse()),s="<td id='"+o[0]+"' class='"+n+"' title='"+p[0]+"'><span "+K(X,"icon_first",!1,b)+"></span></td>",d="<td id='"+o[1]+"' class='"+n+"'  title='"+p[1]+"'><span "+K(X,"icon_prev",!1,b)+"></span></td>",c="<td id='"+o[2]+"' class='"+n+"' title='"+p[2]+"'><span "+K(X,"icon_next",!1,b)+"></span></td>",p="<td id='"+o[3]+"' class='"+n+"' title='"+p[3]+"'><span "+K(X,"icon_end",!1,b)+"></span></td>",u=""!==g?u+g+u:"",h+="ltr"===v?s+d+u+c+p:p+c+u+d+s):""!==g&&(h+=g),"ltr"===v&&(h+=f),h+="</tr></tbody></table>",e=$.jgrid.jqID(e),t=$.jgrid.jqID(t),!0===W.p.viewrecords&&$("td#"+e+"_"+W.p.recordpos,"#"+t).append("<div dir='"+v+"' style='text-align:"+W.p.recordpos+"' class='ui-paging-info'></div>"),$("td#"+e+"_"+W.p.pagerpos,"#"+t).append(h),s=$("#gbox_"+$.jgrid.jqID(W.p.id)).css("font-size")||"11px",$("#gbox_"+$.jgrid.jqID(W.p.id)).append("<div id='testpg' "+K(X,"entrieBox",!1,"ui-jqgrid")+" style='font-size:"+s+";visibility:hidden;' ></div>"),s=$(h).clone().appendTo("#testpg").width(),$("#testpg").remove(),0<s&&(""!==g&&(s+=50),r=s>$("td#"+e+"_"+W.p.pagerpos,"#"+t).innerWidth(),$("td#"+e+"_"+W.p.pagerpos,"#"+t).width(s)),W.p._nvtd=[],W.p._nvtd[0]=s?Math.floor((W.p.width-s)/2):Math.floor(W.p.width/3),W.p._nvtd[1]=0,h=null,$(".ui-pg-selbox","#"+t).on("change",function(){return l("records",this)&&(W.p.page=Math.round(W.p.rowNum*(W.p.page-1)/this.value-.5)+1,W.p.rowNum=this.value,W.p.pager&&$(".ui-pg-selbox",W.p.pager).val(this.value),W.p.toppager&&$(".ui-pg-selbox",W.p.toppager).val(this.value),k()),!1}),!0===W.p.pgbuttons&&($(".ui-pg-button","#"+t).hover(function(){$(this).hasClass(w)?this.style.cursor="default":($(this).addClass(_),this.style.cursor="pointer")},function(){$(this).hasClass(w)||($(this).removeClass(_),this.style.cursor="default")}),$("#first"+$.jgrid.jqID(a)+", #prev"+$.jgrid.jqID(a)+", #next"+$.jgrid.jqID(a)+", #last"+$.jgrid.jqID(a)).click(function(){if($(this).hasClass(w))return!1;var
e=Y(W.p.page,1),t=Y(W.p.lastpage,1),i=!1,r=!0,o=!0,n=!0,s=!0;return 0===t||1===t?s=n=o=r=!1:1<t&&1<=e?1===e?o=r=!1:e===t&&(s=n=!1):1<t&&0===e&&(s=n=!1,e=t-1),l(this.id.split("_")[0],this)&&(this.id==="first"+a&&r&&(W.p.page=1,i=!0),this.id==="prev"+a&&o&&(W.p.page=e-1,i=!0),this.id==="next"+a&&n&&(W.p.page=e+1,i=!0),this.id==="last"+a&&s&&(W.p.page=t,i=!0),i&&k(),$.jgrid.setSelNavIndex(W,this)),!1})),!0===W.p.pginput&&$("#"+t).on("keypress","input.ui-pg-input",function(e){return 13===(e.charCode||e.keyCode||0)?(l("user",this)&&($(this).val(Y($(this).val(),1)),W.p.page=0<$(this).val()?$(this).val():W.p.page,k()),!1):this}),r&&W.p.responsive&&!W.p.forcePgButtons&&($("#"+o[0]+",#"+o[3]+",#input"+$.jgrid.jqID(a)).hide(),$(".ui-paging-info","td#"+e+"_"+W.p.recordpos).hide(),$(".ui-pg-selbox","td#"+e+"_"+W.p.pagerpos).hide())},M=function(e,t,i,r,o){if(W.p.colModel[t].sortable&&!(0<W.p.savedRow.length)){if(i||(W.p.lastsort===t&&""!==W.p.sortname?"asc"===W.p.sortorder?W.p.sortorder="desc":"desc"===W.p.sortorder&&(W.p.sortorder="asc"):W.p.sortorder=W.p.colModel[t].firstsortorder||"asc",W.p.page=1),W.p.multiSort)!function(e,t,i){var
r=W.p.colModel,o=W.p.frozenColumns?t:W.grid.headers[e].el,n="";$("span.ui-grid-ico-sort",o).addClass(w),$(o).attr({"aria-selected":"false","aria-sort":"none"}),t=r[e].index||r[e].name,void
0===i?r[e].lso?"asc"===r[e].lso?(r[e].lso+="-desc",n="desc"):"desc"===r[e].lso?(r[e].lso+="-asc",n="asc"):"asc-desc"!==r[e].lso&&"desc-asc"!==r[e].lso||(r[e].lso=""):r[e].lso=n=r[e].firstsortorder||"asc":r[e].lso=n=i,n?($("span.s-ico",o).show(),$("span.ui-icon-"+n,o).removeClass(w),$(o).attr({"aria-selected":"true","aria-sort":n+"ending"})):W.p.viewsortcols[0]||$("span.s-ico",o).hide(),-1===(o=I.indexOf(t))?(I.push(t),G.push(n)):n?G[o]=n:(G.splice(o,1),I.splice(o,1)),W.p.sortorder="",W.p.sortname="";for(var
s=0,a=I.length;s<a;s++)0<s&&(W.p.sortname+=", "),W.p.sortname+=I[s],s!==a-1&&(W.p.sortname+=" "+G[s]);W.p.sortorder=G[a-1]}(t,o,r);else{if(r){if(W.p.lastsort===t&&W.p.sortorder===r&&!i)return;W.p.sortorder=r}var
i=W.grid.headers[W.p.lastsort]?W.grid.headers[W.p.lastsort].el:null,n=W.p.frozenColumns?o:W.grid.headers[t].el,r="single"===W.p.viewsortcols[1],o=$(i).find("span.ui-grid-ico-sort");o.addClass(w),r&&$(o).css("display","none"),$(i).attr({"aria-selected":"false","aria-sort":"none"}),W.p.frozenColumns&&((o=W.grid.fhDiv.find("span.ui-grid-ico-sort")).addClass(w),r&&o.css("display","none"),W.grid.fhDiv.find("th").attr({"aria-selected":"false","aria-sort":"none"})),(o=$(n).find("span.ui-icon-"+W.p.sortorder)).removeClass(w),r&&o.css("display",""),$(n).attr({"aria-selected":"true","aria-sort":W.p.sortorder+"ending"}),W.p.viewsortcols[0]||(W.p.lastsort!==t?(W.p.frozenColumns&&W.grid.fhDiv.find("span.s-ico").hide(),$("span.s-ico",i).hide(),$("span.s-ico",n).show()):""===W.p.sortname&&$("span.s-ico",n).show()),e=e.substring(5+W.p.id.length+1),W.p.sortname=W.p.colModel[t].index||e}"stop"===$(W).triggerHandler("jqGridSortCol",[W.p.sortname,t,W.p.sortorder])||$.jgrid.isFunction(W.p.onSortCol)&&"stop"===W.p.onSortCol.call(W,W.p.sortname,t,W.p.sortorder)?W.p.lastsort=t:(se(!1),"local"===W.p.datatype?W.p.deselectAfterSort&&!W.p.preserveSelection&&$(W).jqGrid("resetSelection"):(W.p.selrow=null,W.p.multiselect&&(W.p.preserveSelection||(W.p.selarrrow=[])),W.p.savedRow=[]),W.p.scroll&&(n=W.grid.bDiv.scrollLeft,re.call(W,!0,!1),W.grid.hDiv.scrollLeft=n),W.p.subGrid&&"local"===W.p.datatype&&$("td.sgexpanded","#"+$.jgrid.jqID(W.p.id)).each(function(){$(this).trigger("click")}),W.p._sort=!0,k(),W.p.lastsort=t,W.p.sortname!==e&&t&&(W.p.lastsort=t))}},R=function(e){for(var
t=W.grid.headers,i=$.jgrid.getCellIndex(e),r=0;r<t.length;r++)if(e===t[r].el){i=r;break}return i},z=function(){var
e,t,i='{"groupOp":"AND","rules":[], "groups" : [',r=0;for(e
in
W.p.colFilters)W.p.colFilters.hasOwnProperty(e)&&(t=W.p.colFilters[e],$.isEmptyObject(t)||(0<r&&(i+=","),i+='{"groupOp": "'+t.rule+'", "rules" : [',i+='{"field":"'+e+'",',i+='"op":"'+t.oper1+'",',t.value1+="",i+='"data":"'+t.value1.replace(/\\/g,"\\\\").replace(/\"/g,'\\"')+'"}',t.value2&&(i+=',{"field":"'+e+'",',i+='"op":"'+t.oper2+'",',t.value2+="",i+='"data":"'+t.value2.replace(/\\/g,"\\\\").replace(/\"/g,'\\"')+'"}'),i+="]}",r++));return i+="]}"},F=function(w,e,t){var
i=$(h.hDiv).height();$(".ui-search-toolbar",h.hDiv)[0]&&!isNaN($(".ui-search-toolbar",h.hDiv).height())&&(i-=$(".ui-search-toolbar",h.hDiv).height()),$(h.cDiv).is(":hidden")||(i+=$(h.cDiv).outerHeight()),W.p.toolbar[1]&&"bottom"!==W.p.toolbar[2]&&null!==$(h.uDiv)&&(i+=$(h.uDiv).outerHeight()),W.p.toppager&&(i+=$("#"+$.jgrid.jqID(W.p.id)+"_toppager").outerHeight()),e=parseInt(e,10),t=i;var
r,o,n,s,a,l,d="",c=W.p.colModel[w],j=$.extend({sorting:!0,columns:!0,filtering:!0,seraching:!0,grouping:!0,freeze:!0},c.coloptions),p=$.jgrid.getRegional(W,"colmenu"),i=W.p.colNames[w],u=[],g=$.jgrid.trim(c.name);for(s
in
u.push(d),c.sortable&&j.sorting&&(d='<li class="ui-menu-item" role="presentation"><a class="g-menu-item" tabindex="0" role="menuitem" data-value="sortasc"><table class="ui-common-table"><tr><td class="menu_icon"><span class="'+b+" "+y.icon_sort_asc+'"></span></td><td class="menu_text">'+p.sortasc+"</td></tr></table></a></li>",d+='<li class="ui-menu-item" role="presentation"><a class="g-menu-item" tabindex="0" role="menuitem" data-value="sortdesc"><table class="ui-common-table"><tr><td class="menu_icon"><span class="'+b+" "+y.icon_sort_desc+'"></span></td><td class="menu_text">'+p.sortdesc+"</td></tr></table></a></li>",u.push(d)),j.columns&&(d='<li class="ui-menu-item divider" role="separator"></li>',d+='<li class="ui-menu-item" role="presentation"><a class="g-menu-item" tabindex="0" role="menuitem" data-value="columns"><table class="ui-common-table"><tr><td class="menu_icon"><span class="'+b+" "+y.icon_columns+'"></span></td><td class="menu_text">'+p.columns+"</td></tr></table></a></li>",u.push(d)),j.filtering&&(d='<li class="ui-menu-item divider" role="separator"></li>',d+='<li class="ui-menu-item" role="presentation"><a class="g-menu-item" tabindex="0" role="menuitem" data-value="filtering"><table class="ui-common-table"><tr><td class="menu_icon"><span class="'+b+" "+y.icon_filter+'"></span></td><td class="menu_text">'+p.filter+" "+i+"</td></tr></table></a></li>",u.push(d)),j.grouping&&(o=$.inArray(c.name,W.p.groupingView.groupField),d='<li class="ui-menu-item divider" role="separator"></li>',d+='<li class="ui-menu-item" role="presentation"><a class="g-menu-item" tabindex="0" role="menuitem" data-value="grouping"><table class="ui-common-table"><tr><td class="menu_icon"><span class="'+b+" "+y.icon_group+'"></span></td><td class="menu_text">'+(-1!==o?p.ungrouping:p.grouping+" "+i)+"</td></tr></table></a></li>",u.push(d)),j.freeze&&(W.p.subGrid||W.p.treeGrid||W.p.cellEdit||(n=!c.frozen||!W.p.frozenColumns,d='<li class="ui-menu-item divider" role="separator"></li>',d+='<li class="ui-menu-item" role="presentation"><a class="g-menu-item" tabindex="0" role="menuitem" data-value="freeze"><table class="ui-common-table"><tr><td class="menu_icon"><span class="'+b+" "+y.icon_freeze+'"></span></td><td class="menu_text">'+(n?p.freeze+" "+i:p.unfreeze)+"</td></tr></table></a></li>",u.push(d))),W.p.colMenuCustom)W.p.colMenuCustom.hasOwnProperty(s)&&(l=(a=W.p.colMenuCustom[s]).exclude.split(","),l=$.map(l,function(e){return $.jgrid.trim(e)}),(a.colname===g||"_all_"===a.colname&&-1===$.inArray(g,l))&&(r='<li class="ui-menu-item divider" role="separator"></li>',d='<li class="ui-menu-item" role="presentation"><a class="g-menu-item" tabindex="0" role="menuitem" data-value="'+a.id+'"><table class="ui-common-table"><tr><td class="menu_icon"><span class="'+b+" "+a.icon+'"></span></td><td class="menu_text">'+a.title+"</td></tr></table></a></li>","last"===a.position?(u.push(r),u.push(d)):"first"===a.position&&(u.unshift(r),u.unshift(d))));u.unshift('<ul id="column_menu" role="menu" tabindex="0">'),u.push("</ul>"),$("#gbox_"+W.p.id).append(u.join("")),$("#column_menu").addClass("ui-search-menu modal-content column-menu jqgrid-column-menu ui-menu "+y.menu_widget).css({left:e,top:t}),"ltr"===W.p.direction&&(t=$("#column_menu").width()+26,$("#column_menu").css("left",e-t+"px")),$("#column_menu > li > a").hover(function(){var
e,t,i,r,o,n,s,a,l,d,c,p,u,g,h,f,m,v;$("#col_menu").remove(),$("#search_menu").remove(),"columns"===$(this).attr("data-value")&&(s=$(this).parent().width()+8,$(this).parent().position().top,function(e,t,i){var
r,o=W.p.colModel,n=o.length,s=[],a=!0,l=[],d=$.jgrid.getRegional(W,"colmenu"),c='<ul id="col_menu" class="ui-search-menu  ui-col-menu modal-content" role="menu" tabindex="0" style="left:'+e+'px;">';for(i.columns_selectAll&&(c+='<li class="ui-menu-item disabled" role="presentation" draggable="false"><a class="g-menu-item" tabindex="0" role="menuitem" ><table class="ui-common-table" ><tr><td class="menu_icon" title="'+d.reorder+'"><span class="'+b+" "+y.icon_move+' notclick" style="visibility:hidden"></span></td><td class="menu_icon"><input id="chk_all" class="'+y.input_checkbox+'" type="checkbox" name="check_all"></td><td class="menu_text">Check/Uncheck</td></tr></table></a></li>'),r=0;r<n;r++){var
p,u=o[r].hidden?"":"checked",g=o[r].name,h=W.p.colNames[r];c+="<li "+(p="cb"===g||"subgrid"===g||"rn"===g||o[r].hidedlg?"style='display:none'":"")+' class="ui-menu-item" role="presentation" draggable="true"><a class="g-menu-item" tabindex="0" role="menuitem" ><table class="ui-common-table" ><tr><td class="menu_icon" title="'+d.reorder+'"><span class="'+b+" "+y.icon_move+' notclick"></span></td><td class="menu_icon"><input class="'+y.input_checkbox+' chk_selected" type="checkbox" name="'+g+'" '+u+'></td><td class="menu_text">'+h+"</td></tr></table></a></li>",s.push(r),p||l.push(g),a&&!u&&(a=!1)}c+="</ul>",$(t).append(c),$("#col_menu").addClass("ui-menu "+y.menu_widget),$("#chk_all","#col_menu").prop("checked",a),$.jgrid.isElementInViewport($("#col_menu")[0])||$("#col_menu").css("left",-parseInt($("#column_menu").innerWidth(),10)+"px"),$.fn.html5sortable()&&$("#col_menu").html5sortable({handle:"span",items:":not(.disabled)",forcePlaceholderSize:!0}).on("sortupdate",function(e,t){for(s.splice(t.startindex,1),s.splice(t.endindex,0,t.startindex),$(W).jqGrid("destroyFrozenColumns"),$(W).jqGrid("remapColumns",s,!0),$(W).triggerHandler("jqGridColMenuColumnDone",[s,null,null]),$.jgrid.isFunction(W.p.colMenuColumnDone)&&W.p.colMenuColumnDone.call(W,s,null,null),$(W).jqGrid("setFrozenColumns"),r=0;r<n;r++)s[r]=r}),$("#col_menu > li > a").on("click",function(e){var
t;$(e.target).hasClass("notclick")||($(e.target).is(":input")?t=$(e.target).is(":checked"):(t=!$("input",this).is(":checked"),$("input",this).prop("checked",t)),"check_all"===(e=$("input",this).attr("name"))?t?($("input","#col_menu").prop("checked",!0),$(W).jqGrid("showCol",l)):($("input","#col_menu").prop("checked",!1),$(W).jqGrid("hideCol",l)):($(W).triggerHandler("jqGridColMenuColumnDone",[s,e,t]),$.jgrid.isFunction(W.p.colMenuColumnDone)&&W.p.colMenuColumnDone.call(W,s,e,t),t?($(W).jqGrid("showCol",e),$(this).parent().attr("draggable","true")):($(W).jqGrid("hideCol",e),$(this).parent().attr("draggable","false")),i.columns_selectAll&&$("#chk_all","#col_menu").prop("checked",$(".chk_selected:checked","#col_menu").length===$(".chk_selected","#col_menu").length)))}).hover(function(){$(this).addClass(_)},function(){$(this).removeClass(_)})}(s,$(this).parent(),j)),"filtering"===$(this).attr("data-value")&&(s=$(this).parent().width()+8,$(this).parent().position().top,e=w,t=s,i=$(this).parent(),d=W.p.colModel[e],f=h=g=u=p=c="",m=$.jgrid.getRegional(W,"search"),v=$.jgrid.styleUI[W.p.styleUI||"jQueryUI"].common,d&&((l=!(!W.p.colFilters||!W.p.colFilters[d.name])&&W.p.colFilters[d.name])&&!$.isEmptyObject(l)&&(c=l.oper1,p=l.value1,u=l.rule,g=l.oper2,h=l.value2),d.searchoptions||(d.searchoptions={}),r=d.searchoptions.sopt||("text"===d.sorttype?["eq","ne","bw","bn","ew","en","cn","nc","nu","nn","in","ni"]:["eq","ne","lt","le","gt","ge","nu","nn","in","ni"]),o=d.searchoptions.groupOps||m.groupOps,s=$("<form></form>"),a="<div>"+$.jgrid.getRegional(W,"colmenu.searchTitle")+"</div>",a+='<div><select size="1" id="oper1" class="'+y.filter_select+'">',$.each(m.odata,function(e,t){n=t.oper===c?'selected="selected"':"",-1!==$.inArray(t.oper,r)&&(f+='<option value="'+t.oper+'" '+n+">"+t.text+"</option>")}),a+=f,a+="</select></div>",s.append(a),e="",d.searchoptions.defaultValue&&(e=$.jgrid.isFunction(d.searchoptions.defaultValue)?d.searchoptions.defaultValue.call(W):d.searchoptions.defaultValue),p&&(e=p),l=$.extend(d.searchoptions,{name:d.index||d.name,id:"sval1_"+W.p.idPrefix+d.name,oper:"search"}),p=$.jgrid.createEl.call(W,d.stype,l,e,!1,$.extend({},$.jgrid.ajaxOptions,W.p.ajaxSelectOptions||{})),$(p).addClass(y.filter_input),a=$("<div></div>").append(p),s.append(a),a='<div><select size="1" id="operand" class="'+y.filter_select+'">',$.each(o,function(e,t){n=t.op===u?'selected="selected"':"",a+="<option value='"+t.op+"' "+n+">"+t.text+"</option>"}),a+="</select></div>",s.append(a),f="",$.each(m.odata,function(e,t){n=t.oper===g?'selected="selected"':"",-1!==$.inArray(t.oper,r)&&(f+='<option value="'+t.oper+'" '+n+">"+t.text+"</option>")}),a='<div><select size="1" id="oper2" class="'+y.filter_select+'">'+f+"</select></div>",s.append(a),e=h||"",l=$.extend(d.searchoptions,{name:d.index||d.name,id:"sval2_"+W.p.idPrefix+d.name,oper:"search"}),p=$.jgrid.createEl.call(W,d.stype,l,e,!1,$.extend({},$.jgrid.ajaxOptions,W.p.ajaxSelectOptions||{})),$(p).addClass(y.filter_input),a=$("<div></div>").append(p),s.append(a),a="<div>",a+="<div class='search_buttons'><a tabindex='0' id='bs_reset' class='fm-button "+v.button+" ui-reset'>"+m.Reset+"</a></div>",a+="<div class='search_buttons'><a tabindex='0' id='bs_search' class='fm-button "+v.button+" ui-search'>"+m.Find+"</a></div>",a+="</div>",s.append(a),s=$('<li class="ui-menu-item" role="presentation"></li>').append(s),s=$('<ul id="search_menu" class="ui-search-menu modal-content" role="menu" tabindex="0" style="left:'+t+'px;"></ul>').append(s),$(i).append(s),$("#search_menu").addClass("ui-menu "+y.menu_widget),$.jgrid.isElementInViewport($("#search_menu")[0])||$("#search_menu").css("left",-parseInt($("#column_menu").innerWidth(),10)+"px"),$("#bs_reset, #bs_search","#search_menu").hover(function(){$(this).addClass(_)},function(){$(this).removeClass(_)}),$("#bs_reset",s).on("click",function(e){W.p.colFilters[d.name]={},W.p.postData.filters=z(),W.p.search=!1,$.jgrid.isFunction(W.p.colMenuBeforeProcess)&&W.p.colMenuBeforeProcess.call(W,{module:"filtering",action:"reset",column:d.name}),$(W).trigger("reloadGrid"),$("#column_menu").remove()}),$("#bs_search",s).on("click",function(e){W.p.colFilters[d.name]={oper1:$("#oper1","#search_menu").val(),value1:$("#sval1_"+W.p.idPrefix+d.name,"#search_menu").val(),rule:$("#operand","#search_menu").val(),oper2:$("#oper2","#search_menu").val(),value2:$("#sval2_"+W.p.idPrefix+d.name,"#search_menu").val()},W.p.postData.filters=z(),W.p.search=!0,$.jgrid.isFunction(W.p.colMenuBeforeProcess)&&W.p.colMenuBeforeProcess.call(W,{module:"filtering",action:"search",column:d.name}),$(W).trigger("reloadGrid"),$("#column_menu").remove()}))),$(this).addClass(_)},function(){$(this).removeClass(_)}).click(function(){var
e,t,i=$(this).attr("data-value"),r=W.grid.headers[w].el;"sortasc"===i||"sortdesc"===i?($.jgrid.isFunction(W.p.colMenuBeforeProcess)&&W.p.colMenuBeforeProcess.call(W,{module:"sorting",action:"sortasc"===i?"asc":"desc",column:c.name}),M("jqgh_"+W.p.id+"_"+c.name,w,!0,"sortasc"===i?"asc":"desc",r)):"grouping"===i?(e=w,t=o,r=W.p.colModel[e],e=W.p.groupingView,-1!==t?e.groupField.splice(t,1):e.groupField.push(r.name),$.jgrid.isFunction(W.p.colMenuBeforeProcess)&&W.p.colMenuBeforeProcess.call(W,{module:"grouping",action:-1!==t?"ungroup":"group",column:r.name}),$(W).jqGrid("groupingGroupBy",e.groupField),W.p.frozenColumns&&($(W).jqGrid("destroyFrozenColumns"),$(W).jqGrid("setFrozenColumns"))):"freeze"===i&&function(e,t){for(var
i=[],r=W.p.colModel.length,o=-1,n=W.p.colModel,s=0;s<r;s++)n[s].frozen&&(o=s),i.push(s);i.splice(e,1),i.splice(o+(t?1:0),0,e),n[e].frozen=t,$.jgrid.isFunction(W.p.colMenuBeforeProcess)&&W.p.colMenuBeforeProcess.call(W,{module:"freeze",action:t?"freeze":"unfreeze",column:n.name}),$(W).jqGrid("destroyFrozenColumns"),$(W).jqGrid("remapColumns",i,!0),$(W).jqGrid("setFrozenColumns")}(w,n),-1===i.indexOf("sort")&&"grouping"!==i&&"freeze"!==i||$(this).remove(),W.p.colMenuCustom.hasOwnProperty(i)&&(i=W.p.colMenuCustom[i],$.jgrid.isFunction(i.funcname)&&(i.funcname.call(W,g),i.closeOnRun&&$(this).remove()))}),parseFloat($("#column_menu").css("left"))<0&&$("#column_menu").css("left",$(W).css("left"))};for((W.p.colMenu||W.p.menubar)&&$("body").on("click",function(e){if(!$(e.target).closest("#column_menu").length)try{$("#column_menu").remove()}catch(e){}if(!$(e.target).closest(".ui-jqgrid-menubar").length)try{$("#"+W.p.id+"_menubar").hide()}catch(e){}}),this.p.id=this.id,-1===$.inArray(W.p.multikey,["shiftKey","altKey","ctrlKey"])&&(W.p.multikey=!1),W.p.keyName=!1,i=0;i<W.p.colModel.length;i++)l="string"==typeof
W.p.colModel[i].template?null!=$.jgrid.cmTemplate&&"object"==typeof
$.jgrid.cmTemplate[W.p.colModel[i].template]?$.jgrid.cmTemplate[W.p.colModel[i].template]:{}:W.p.colModel[i].template,W.p.colModel[i]=$.extend(!0,{},W.p.cmTemplate,l||{},W.p.colModel[i]),!1===W.p.keyName&&!0===W.p.colModel[i].key&&(W.p.keyName=W.p.colModel[i].name,W.p.keyIndex=i);W.p.sortorder=W.p.sortorder.toLowerCase(),$.jgrid.cell_width=$.jgrid.cellWidth();var
P=$("<table style='visibility:hidden'><tr class='jqgrow'><td>1</td></tr></table)").addClass(K(X,"rowTable",!0,"ui-jqgrid-btable ui-common-table"));if($(a).append(P),W.p.cellLayout=parseInt($("td",P).css("padding-left"),10)+parseInt($("td",P).css("padding-right"),10)+1,W.p.cellLayout<=0&&(W.p.cellLayout=5),$(P).remove(),!null===W.p.grouping&&(W.p.scroll=!1,W.p.rownumbers=!1,W.p.treeGrid=!1,W.p.gridview=!0),!0===this.p.treeGrid){try{$(this).jqGrid("setTreeGrid")}catch(e){}"local"!==W.p.datatype?W.p.localReader={id:"_id_"}:!1!==W.p.keyName&&(W.p.localReader={id:W.p.keyName})}if(this.p.subGrid)try{$(W).jqGrid("setSubGrid")}catch(e){}this.p.multiselect&&(this.p.colNames.unshift("<input role='checkbox' id='cb_"+this.p.id+"' class='cbox' type='checkbox'/>"),this.p.colModel.unshift({name:"cb",width:$.jgrid.cell_width?W.p.multiselectWidth+W.p.cellLayout:W.p.multiselectWidth,sortable:!1,resizable:!1,hidedlg:!0,search:!1,align:"center",fixed:!0,frozen:!0,classes:"jqgrid-multibox"})),this.p.rownumbers&&(this.p.colNames.unshift(""),this.p.colModel.unshift({name:"rn",width:W.p.rownumWidth,sortable:!1,resizable:!1,hidedlg:!0,search:!1,align:"center",fixed:!0,frozen:!0})),W.p.xmlReader=$.extend(!0,{root:"rows",row:"row",page:"rows>page",total:"rows>total",records:"rows>records",repeatitems:!0,cell:"cell",id:"[id]",userdata:"userdata",subgrid:{root:"rows",row:"row",repeatitems:!0,cell:"cell"}},W.p.xmlReader),W.p.jsonReader=$.extend(!0,{root:"rows",page:"page",total:"total",records:"records",repeatitems:!0,cell:"cell",id:"id",userdata:"userdata",subgrid:{root:"rows",repeatitems:!0,cell:"cell"}},W.p.jsonReader),W.p.localReader=$.extend(!0,{root:"rows",page:"page",total:"total",records:"records",repeatitems:!1,cell:"cell",id:"id",userdata:"userdata",subgrid:{root:"rows",repeatitems:!0,cell:"cell"}},W.p.localReader),W.p.scroll&&(W.p.pgbuttons=!1,W.p.pginput=!1,W.p.rowList=[]),W.p.data.length&&(f(),oe());var
B,A,O,T,H,L,U,E,ae="<thead><tr class='ui-jqgrid-labels' role='row'>",le="",de="",ce="";if(!0===W.p.shrinkToFit&&!0===W.p.forceFit)for(i=W.p.colModel.length-1;0<=i;i--)if(!W.p.colModel[i].hidden){W.p.colModel[i].resizable=!1;break}if("horizontal"===W.p.viewsortcols[1]?(de=" ui-i-asc",ce=" ui-i-desc"):"single"===W.p.viewsortcols[1]&&(de=" ui-single-sort-asc",ce=" ui-single-sort-desc",le=" style='display:none'",W.p.viewsortcols[0]=!1),B=o?"class='ui-th-div-ie'":"",L="<span class='s-ico' style='display:none'>",L+="<span sort='asc'  class='ui-grid-ico-sort ui-icon-asc"+de+" ui-sort-"+v+" "+w+" "+b+" "+K(X,"icon_asc",!0)+"'"+le+"></span>",L+="<span sort='desc' class='ui-grid-ico-sort ui-icon-desc"+ce+" ui-sort-"+v+" "+w+" "+b+" "+K(X,"icon_desc",!0)+"'"+le+"></span></span>",W.p.multiSort&&W.p.sortname)for(I=W.p.sortname.split(","),i=0;i<I.length;i++)n=$.jgrid.trim(I[i]).split(" "),I[i]=$.jgrid.trim(n[0]),G[i]=n[1]?$.jgrid.trim(n[1]):W.p.sortorder||"asc";for(i=0;i<this.p.colNames.length;i++){var
pe,ue=W.p.headertitles?' title="'+(W.p.colModel[i].tooltip||$.jgrid.stripHtml(W.p.colNames[i]))+'"':"";(pe=W.p.colModel[i]).hasOwnProperty("colmenu")||(pe.colmenu="rn"!==pe.name&&"cb"!==pe.name&&"subgrid"!==pe.name),ae+="<th id='"+W.p.id+"_"+pe.name+"' role='columnheader' "+K(X,"headerBox",!1,"ui-th-column ui-th-"+v+("cb"===pe.name?" jqgrid-multibox":""))+" "+ue+">",ue=pe.index||pe.name,ae+="<div class='ui-th-div' id='jqgh_"+W.p.id+"_"+pe.name+"' "+B+">"+W.p.colNames[i],pe.width?pe.width=parseInt(pe.width,10):pe.width=150,"boolean"!=typeof
pe.title&&(pe.title=!0),pe.lso="",ue===W.p.sortname&&(W.p.lastsort=i),W.p.multiSort&&-1!==(n=$.inArray(ue,I))&&(pe.lso=G[n]),ae+=L,W.p.colMenu&&pe.colmenu&&(ae+="<a class='"+("ltr"===W.p.direction?"colmenu":"colmenu-rtl")+"'><span class='colmenuspan "+b+" "+y.icon_menu+"'></span></a>"),ae+="</div></th>"}ae+="</tr></thead>",pe=L=null,$(this).append(ae),$("thead tr",this).first().find("th").hover(function(){$(this).addClass(_)},function(){$(this).removeClass(_)}),this.p.multiselect&&(U=[],$("#cb_"+$.jgrid.jqID(W.p.id),this).on("click",function(){W.p.preserveSelection||(W.p.selarrrow=[]);var
t=!0===W.p.frozenColumns?W.p.id+"_frozen":"";this.checked?($(W.rows).each(function(e){0<e&&($(this).hasClass("ui-subgrid")||$(this).hasClass("jqgroup")||$(this).hasClass(w)||$(this).hasClass("jqfoot")||($("#jqg_"+$.jgrid.jqID(W.p.id)+"_"+$.jgrid.jqID(this.id))[W.p.useProp?"prop":"attr"]("checked",!0),$(this).addClass(Q).attr("aria-selected","true"),W.p.preserveSelection&&-1!==W.p.selarrrow.indexOf(this.id)||W.p.selarrrow.push(this.id),W.p.selrow=this.id,t&&($("#jqg_"+$.jgrid.jqID(W.p.id)+"_"+$.jgrid.jqID(this.id),W.grid.fbDiv)[W.p.useProp?"prop":"attr"]("checked",!0),$("#"+$.jgrid.jqID(this.id),W.grid.fbDiv).addClass(Q))))}),E=!0,U=[]):($(W.rows).each(function(e){0<e&&($(this).hasClass("ui-subgrid")||$(this).hasClass("jqgroup")||$(this).hasClass(w)||$(this).hasClass("jqfoot")||($("#jqg_"+$.jgrid.jqID(W.p.id)+"_"+$.jgrid.jqID(this.id))[W.p.useProp?"prop":"attr"]("checked",!1),$(this).removeClass(Q).attr("aria-selected","false"),U.push(this.id),!W.p.preserveSelection||-1<(e=W.p.selarrrow.indexOf(this.id))&&W.p.selarrrow.splice(e,1),t&&($("#jqg_"+$.jgrid.jqID(W.p.id)+"_"+$.jgrid.jqID(this.id),W.grid.fbDiv)[W.p.useProp?"prop":"attr"]("checked",!1),$("#"+$.jgrid.jqID(this.id),W.grid.fbDiv).removeClass(Q))))}),W.p.selrow=null,E=!1),$(W).triggerHandler("jqGridSelectAll",[E?W.p.selarrrow:U,E]),$.jgrid.isFunction(W.p.onSelectAll)&&W.p.onSelectAll.call(W,E?W.p.selarrrow:U,E)})),!0===W.p.autowidth&&(Re=$(a).parent().width(),pe=$(window).width(),W.p.width=3<pe-Re?Re:pe);var
ge,he,fe,me,$e,ve,we,je,_e,be,ye,De="",xe="",qe=-1===W.p.styleUI.search("Bootstrap")||isNaN(W.p.height)?0:2;ve=0,we=$.jgrid.cell_width?0:Y(W.p.cellLayout,0),je=0,_e=Y(W.p.scrollOffset,0),be=!1,ye=0,$.each(W.p.colModel,function(){var
e;void
0===this.hidden&&(this.hidden=!1),W.p.grouping&&W.p.autowidth&&(0<=(e=$.inArray(this.name,W.p.groupingView.groupField))&&W.p.groupingView.groupColumnShow.length>e&&(this.hidden=!W.p.groupingView.groupColumnShow[e])),this.widthOrg=he=Y(this.width,0),!1===this.hidden&&(ve+=he+we,this.fixed?ye+=he+we:je++)}),isNaN(W.p.width)&&(W.p.width=ve+(!1!==W.p.shrinkToFit||isNaN(W.p.height)?0:_e)),h.width=parseInt(W.p.width,10),W.p.tblwidth=ve,!1===W.p.shrinkToFit&&!0===W.p.forceFit&&(W.p.forceFit=!1),!0===W.p.shrinkToFit&&0<je&&(fe=h.width-we*je-ye,isNaN(W.p.height)||(fe-=_e,be=!0),ve=0,$.each(W.p.colModel,function(e){!1!==this.hidden||this.fixed||(he=Math.round(fe*this.width/(W.p.tblwidth-we*je-ye)),this.width=he,ve+=he,ge=e)}),$e=(me=0)===qe?-1:0,be?h.width-ye-(ve+we*je)!==_e&&(me=h.width-ye-(ve+we*je)-_e):be||0===Math.abs(h.width-ye-(ve+we*je))||(me=h.width-ye-(ve+we*je)-qe),W.p.colModel[ge].width+=me+$e,W.p.tblwidth=ve+me+we*je+ye,W.p.tblwidth>W.p.width&&(W.p.colModel[ge].width-=W.p.tblwidth-parseInt(W.p.width,10),W.p.tblwidth=W.p.width)),P=-1!==W.p.styleUI.search("Bootstrap"),$(a).css("width",h.width+"px").append("<div class='ui-jqgrid-resize-mark' id='rs_m"+W.p.id+"'>&#160;</div>"),W.p.scrollPopUp&&$(a).append("<div "+K(X,"scrollBox",!1,"loading ui-scroll-popup")+" id='scroll_g"+W.p.id+"'></div>"),$(s).css("width",h.width+"px"),ae=$(W).find("thead").first().get(0),W.p.footerrow&&(De+="<table role='presentation' style='width:"+W.p.tblwidth+"px' "+K(X,"footerTable",!1,"ui-jqgrid-ftable ui-common-table")+"><tbody><tr role='row' "+K(X,"footerBox",!1,"footrow footrow-"+v)+">"),W.p.headerrow&&(xe+="<table role='presentation' style='width:"+W.p.tblwidth+"px' "+K(X,"headerRowTable",!1,"ui-jqgrid-hrtable ui-common-table")+"><tbody><tr role='row' "+K(X,"headerRowBox",!1,"hrheadrow hrheadrow-"+v)+">");var
Ce=$(ae).find("tr").first(),Ie="<tr class='jqgfirstrow' role='row'>",Ge=0;if(W.p.disableClick=!1,$("th",Ce).each(function(e){pe=W.p.colModel[e],A=pe.width,void
0===pe.resizable&&(pe.resizable=!0),pe.resizable?(O=document.createElement("span"),$(O).html("&#160;").addClass("ui-jqgrid-resize ui-jqgrid-resize-"+v).css("cursor","col-resize"),$(this).addClass(W.p.resizeclass)):O="",$(this).css("width",A+"px").prepend(O),O=null;var
t="";pe.hidden&&($(this).css("display","none"),t="display:none;"),Ie+="<td role='gridcell' style='height:0px;width:"+A+"px;"+t+"'></td>",h.headers[e]={width:A,el:this},"boolean"!=typeof(le=pe.sortable)&&(pe.sortable=!0,le=!0);t=pe.name;"cb"!==t&&"subgrid"!==t&&"rn"!==t&&W.p.viewsortcols[2]&&$(">div",this).addClass("ui-jqgrid-sortable"),le&&(W.p.multiSort?W.p.viewsortcols[0]?($("div span.s-ico",this).show(),pe.lso&&$("div span.ui-icon-"+pe.lso,this).removeClass(w).css("display","")):pe.lso&&($("div span.s-ico",this).show(),$("div span.ui-icon-"+pe.lso,this).removeClass(w).css("display","")):W.p.viewsortcols[0]?($("div span.s-ico",this).show(),e===W.p.lastsort&&$("div span.ui-icon-"+W.p.sortorder,this).removeClass(w).css("display","")):e===W.p.lastsort&&""!==W.p.sortname&&($("div span.s-ico",this).show(),$("div span.ui-icon-"+W.p.sortorder,this).removeClass(w).css("display",""))),W.p.footerrow&&(De+="<td role='gridcell' "+c(e,0,"",null,"",!1)+">&#160;</td>"),W.p.headerrow&&(xe+="<td role='gridcell' "+c(e,0,"",null,"",!1)+">&#160;</td>")}).mousedown(function(e){if(1===$(e.target).closest("th>span.ui-jqgrid-resize").length){var
t,i=R(this);if(e.preventDefault(),Ge++,setTimeout(function(){Ge=0},400),2!==Ge)return!0===W.p.forceFit&&(W.p.nv=function(e){for(var
t=e,i=e,r=e+1;r<W.p.colModel.length;r++)if(!0!==W.p.colModel[r].hidden){i=r;break}return i-t}(i)),h.dragStart(i,e,function(e){e=$(W.grid.headers[e].el),e=[e.position().left+e.outerWidth()];return"rtl"===W.p.direction&&(e[0]=W.p.width-e[0]),e[0]-=W.grid.bDiv.scrollLeft,e.push($(W.grid.hDiv).position().top),e.push($(W.grid.bDiv).offset().top-$(W.grid.hDiv).offset().top+$(W.grid.bDiv).height()),e}(i)),!1;try{!0===W.p.colModel[i].autosize&&(t=$(W).jqGrid("getCol",i,!1,"maxwidth"),$(W).jqGrid("resizeColumn",i,t+(P?W.p.cellLayout:0)).jqGrid("refreshGroupHeaders"))}catch(e){}finally{Ge=0}}}).click(function(e){if(W.p.disableClick)return W.p.disableClick=!1;var
t,i,r="th>div.ui-jqgrid-sortable";W.p.viewsortcols[2]||(r="th>div>span>span.ui-grid-ico-sort");var
o,n,s=$(e.target).closest(r);if(1===s.length){if(W.p.frozenColumns?(n=$(this)[0].id.substring(W.p.id.length+1),$(W.p.colModel).each(function(e){if(this.name===n)return o=e,!1})):o=R(this),$(e.target).hasClass("colmenuspan")){if(null!=$("#column_menu")[0]&&$("#column_menu").remove(),void
0===o)return;r=$("#gbox_"+W.p.id).offset(),r=$(this).offset().left-r.left;return"ltr"===W.p.direction&&(r+=$(this).outerWidth()),F(o,r,0),!0===W.p.menubar&&$("#"+W.p.id+"_menubar").hide(),void
e.stopPropagation()}return W.p.viewsortcols[2]||(t=!0,i=s.attr("sort")),null!=o&&M($("div",this)[0].id,o,t,i,this),void
0!==W.p.selHeadInd&&$(h.headers[W.p.selHeadInd].el).attr("tabindex","-1"),W.p.selHeadInd=o,$(this).attr("tabindex","0"),!1}}),pe=null,W.p.sortable&&$.fn.sortable)try{$(W).jqGrid("sortableColumns",Ce)}catch(e){}W.p.footerrow&&(De+="</tr></tbody></table>"),W.p.headerrow&&(xe+="</tr></tbody></table>"),Ie+="</tr>",Re=document.createElement("tbody"),this.appendChild(Re),$(this).addClass(K(X,"rowTable",!0,"ui-jqgrid-btable ui-common-table")).append(Ie),W.p.altRows&&$(this).addClass(K(X,"stripedTable",!0,"")),Ie=null;var
Se,ke,Ne,s=$("<table "+K(X,"headerTable",!1,"ui-jqgrid-htable ui-common-table")+" style='width:"+W.p.tblwidth+"px' role='presentation' aria-labelledby='gbox_"+this.id+"'></table>").append(ae),Me=!(!W.p.caption||!0!==W.p.hiddengrid),Re=$("<div class='ui-jqgrid-hbox"+("rtl"===v?"-rtl":"")+"'></div>"),ae=null;h.hDiv=document.createElement("div"),h.hDiv.style.width=h.width-qe+"px",h.hDiv.className=K(X,"headerDiv",!0,"ui-jqgrid-hdiv"),$(h.hDiv).append(Re),$(Re).append(s),Me&&$(h.hDiv).hide(),W.p.pager&&("string"==typeof
W.p.pager?"#"===W.p.pager.substr(0,1)&&(W.p.pager=W.p.pager.substring(1)):W.p.pager=$(W.p.pager).attr("id"),$("#"+$.jgrid.jqID(W.p.pager)).css({width:h.width-qe+"px"}).addClass(K(X,"pagerBox",!0,"ui-jqgrid-pager")).appendTo(a),Me&&$("#"+$.jgrid.jqID(W.p.pager)).hide(),N(W.p.pager,""),W.p.pager="#"+$.jgrid.jqID(W.p.pager)),!1===W.p.cellEdit&&!0===W.p.hoverrows&&$(W).on({mouseover:function(e){H=$(e.target).closest("tr.jqgrow"),"ui-subgrid"!==$(H).attr("class")&&$(H).addClass(_)},mouseout:function(e){H=$(e.target).closest("tr.jqgrow"),$(H).removeClass(_)}}),$(W).before(h.hDiv).on({click:function(e){if(T=e.target,H=$(T,W.rows).closest("tr.jqgrow"),0===$(H).length||-1<H[0].className.indexOf(w)||($(T,W).closest("table.ui-jqgrid-btable").attr("id")||"").replace("_frozen","")!==W.id)return this;var
t=$(T).filter(":enabled").hasClass("cbox"),i=!1!==(i=$(W).triggerHandler("jqGridBeforeSelectRow",[H[0].id,e]))&&"stop"!==i;if($.jgrid.isFunction(W.p.beforeSelectRow)&&(!1!==(n=W.p.beforeSelectRow.call(W,H[0].id,e))&&"stop"!==n||(i=!1)),"A"!==T.tagName&&("INPUT"!==T.tagName&&"TEXTAREA"!==T.tagName&&"OPTION"!==T.tagName&&"SELECT"!==T.tagName||t))if(Se=H[0].id,0<(T=$(T).closest("tr.jqgrow>td")).length&&(ke=$.jgrid.getCellIndex(T)),!0!==W.p.cellEdit){if(0<T.length&&(Ne=$(T).closest("td,th").html(),$(W).triggerHandler("jqGridCellSelect",[Se,ke,Ne,e]),$.jgrid.isFunction(W.p.onCellSelect)&&W.p.onCellSelect.call(W,Se,ke,Ne,e)),i)if(W.p.multimail&&W.p.multiselect){if(e.shiftKey){if(t){var
r=$(W).jqGrid("getGridParam","selrow"),o=$(W).jqGrid("getInd",Se),n=$(W).jqGrid("getInd",r),s="",a="",a=n<o?(s=r,Se):(s=Se,r),l=!1,d=!1,r=!0;return-1<$.inArray(Se,W.p.selarrrow)&&(r=!1),$.each($(this).getDataIDs(),function(e,t){return(d=t===s||d)&&$(W).jqGrid("resetSelection",t),t!==a}),r&&$.each($(this).getDataIDs(),function(e,t){return(l=t===s||l)&&$(W).jqGrid("setSelection",t,!1),t!==a}),void(W.p.selrow=n<o?a:s)}window.getSelection().removeAllRanges()}Oe(Se,t,e,!1)}else
W.p.multikey?e[W.p.multikey]?$(W).jqGrid("setSelection",Se,!0,e):W.p.multiselect&&t&&(t=$("#jqg_"+$.jgrid.jqID(W.p.id)+"_"+Se).is(":checked"),$("#jqg_"+$.jgrid.jqID(W.p.id)+"_"+Se)[W.p.useProp?"prop":"attr"]("checked",!t)):Oe(Se,t,e,!0)}else
if(W.p.multiselect&&t&&i)$(W).jqGrid("setSelection",Se,!0,e);else
if(0<T.length)try{$(W).jqGrid("editCell",H[0].rowIndex,ke,!0,e)}catch(e){}},reloadGrid:function(e,t){var
i;return!0===W.p.treeGrid&&(W.p.datatype=W.p.treedatatype),(t=t||{}).current&&W.grid.selectionPreserver(W),"local"===W.p.datatype?($(W).jqGrid("resetSelection"),W.p.data.length&&(f(),oe())):W.p.treeGrid||(W.p.selrow=null,W.p.multiselect&&(W.p.preserveSelection||(W.p.selarrrow=[],se(!1))),W.p.savedRow=[]),W.p.scroll&&re.call(W,!0,!1),t.page&&((i=t.page)>W.p.lastpage&&(i=W.p.lastpage),i<1&&(i=1),W.p.page=i,W.grid.prevRowHeight?W.grid.bDiv.scrollTop=(i-1)*W.grid.prevRowHeight*W.p.rowNum:W.grid.bDiv.scrollTop=0),W.grid.prevRowHeight&&W.p.scroll&&void
0===t.page?(delete
W.p.lastpage,W.grid.populateVisible()):W.grid.populate(),!0===W.p.inlineNav&&$(W).jqGrid("showAddEditButtons"),!1},dblclick:function(e){if(T=e.target,H=$(T,W.rows).closest("tr.jqgrow"),0!==$(H).length){Se=H[0].rowIndex,ke=$.jgrid.getCellIndex(T);var
t=$(W).triggerHandler("jqGridDblClickRow",[$(H).attr("id"),Se,ke,e]);return null!=t||$.jgrid.isFunction(W.p.ondblClickRow)&&null!=(t=W.p.ondblClickRow.call(W,$(H).attr("id"),Se,ke,e))?t:void
0}},contextmenu:function(e){if(T=e.target,H=$(T,W.rows).closest("tr.jqgrow"),0!==$(H).length){W.p.multiselect||$(W).jqGrid("setSelection",H[0].id,!0,e),Se=H[0].rowIndex,ke=$.jgrid.getCellIndex(T);var
t=$(W).triggerHandler("jqGridRightClickRow",[$(H).attr("id"),Se,ke,e]);return null!=t||$.jgrid.isFunction(W.p.onRightClickRow)&&null!=(t=W.p.onRightClickRow.call(W,$(H).attr("id"),Se,ke,e))?t:void
0}}}),h.bDiv=document.createElement("div"),o&&"auto"===String(W.p.height).toLowerCase()&&(W.p.height="100%"),$(h.bDiv).append($('<div style="position:relative;"></div>').append("<div></div>").append(this)).addClass("ui-jqgrid-bdiv").css({height:W.p.height+(isNaN(W.p.height)?"":"px"),width:h.width-qe+"px"}).on("scroll",h.scrollGrid),$(h.bDiv).find("table").first().css({width:W.p.tblwidth+"px"}),$.support.tbody||2===$("tbody",this).length&&$("tbody",this).slice(1).remove(),W.p.multikey&&($.jgrid.msie()?$(h.bDiv).on("selectstart",function(){return!1}):$(h.bDiv).on("mousedown",function(){return!1})),Me&&$(h.bDiv).hide();var
ze=b+" "+K(X,"icon_caption_open",!0),Fe=b+" "+K(X,"icon_caption_close",!0);h.cDiv=document.createElement("div");var
Pe,Be,Ae=!0===W.p.hidegrid?$("<a role='link' class='ui-jqgrid-titlebar-close HeaderButton "+r+"' title='"+($.jgrid.getRegional(W,"defaults.showhide",W.p.showhide)||"")+"' />").hover(function(){Ae.addClass(_)},function(){Ae.removeClass(_)}).append("<span class='ui-jqgrid-headlink "+ze+"'></span>").css("rtl"===v?"left":"right","0px"):"";$(h.cDiv).append(Ae).append("<span class='ui-jqgrid-title'>"+W.p.caption+"</span>").addClass("ui-jqgrid-titlebar ui-jqgrid-caption"+("rtl"===v?"-rtl":"")+" "+K(X,"gridtitleBox",!0)),!0===W.p.menubar&&(Pe='<ul id="'+W.p.id+'_menubar" class="ui-search-menu modal-content column-menu ui-menu jqgrid-caption-menu '+y.menu_widget+'" role="menubar" tabindex="0"></ul>',$("#gbox_"+W.p.id).append(Pe),$(h.cDiv).append("<a role='link' class='ui-jqgrid-menubar menubar-"+("rtl"===v?"rtl":"ltr")+"' style=''><span class='colmenuspan "+b+" "+y.icon_toolbar_menu+"'></span></a>"),$(".ui-jqgrid-menubar",h.cDiv).hover(function(){$(this).addClass(_)},function(){$(this).removeClass(_)}).on("click",function(e){e=$(e.target).position();$("#"+W.p.id+"_menubar").show(),"rtl"===W.p.direction&&$("#"+W.p.id+"_menubar").css({left:e.left-$("#"+W.p.id+"_menubar").width()-20})})),$(h.cDiv).insertBefore(h.hDiv),W.p.toolbar[0]&&(Pe=K(X,"customtoolbarBox",!0,"ui-userdata"),h.uDiv=document.createElement("div"),"top"===W.p.toolbar[1]?$(h.uDiv).insertBefore(h.hDiv):"bottom"===W.p.toolbar[1]&&$(h.uDiv).insertAfter(h.hDiv),"both"===W.p.toolbar[1]?(h.ubDiv=document.createElement("div"),$(h.uDiv).addClass(Pe+" ui-userdata-top").attr("id","t_"+this.id).insertBefore(h.hDiv).width(h.width-qe),$(h.ubDiv).addClass(Pe+" ui-userdata-bottom").attr("id","tb_"+this.id).insertAfter(h.hDiv).width(h.width-qe),Me&&$(h.ubDiv).hide()):$(h.uDiv).width(h.width-qe).addClass(Pe+" ui-userdata-top").attr("id","t_"+this.id),Me&&$(h.uDiv).hide()),W.p.toppager&&(W.p.toppager=$.jgrid.jqID(W.p.id)+"_toppager",h.topDiv=$("<div id='"+W.p.toppager+"'></div>")[0],$(h.topDiv).addClass(K(X,"toppagerBox",!0,"ui-jqgrid-toppager")).width(h.width-qe).insertBefore(h.hDiv),N(W.p.toppager,"_t"),W.p.toppager="#"+W.p.toppager),W.p.footerrow&&(h.sDiv=$("<div class='ui-jqgrid-sdiv'></div>")[0],Re=$("<div class='ui-jqgrid-hbox"+("rtl"===v?"-rtl":"")+"'></div>"),$(h.sDiv).append(Re).width(h.width-qe).insertAfter(h.hDiv),$(Re).append(De),h.footers=$(".ui-jqgrid-ftable",h.sDiv)[0].rows[0].cells,W.p.rownumbers&&(h.footers[0].className=K(X,"rownumBox",!0,"jqgrid-rownum")),Me&&$(h.sDiv).hide()),W.p.headerrow&&(h.hrDiv=$("<div class='ui-jqgrid-hrdiv'></div>")[0],Re=$("<div class='ui-jqgrid-hbox"+("rtl"===v?"-rtl":"")+"'></div>"),$(h.hrDiv).append(Re).width(h.width-qe).insertAfter(h.hDiv),$(Re).append(xe),h.hrheaders=$(".ui-jqgrid-hrtable",h.hrDiv)[0].rows[0].cells,W.p.rownumbers&&(h.hrheaders[0].className=K(X,"rownumBox",!0,"jqgrid-rownum")),Me&&$(h.nDiv).hide()),Re=null,W.p.caption?(Be=W.p.datatype,!0===W.p.hidegrid&&($(".ui-jqgrid-titlebar-close",h.cDiv).click(function(e){var
t,i=$.jgrid.isFunction(W.p.onHeaderClick),r=".ui-jqgrid-bdiv, .ui-jqgrid-hdiv, .ui-jqgrid-toppager, .ui-jqgrid-pager, .ui-jqgrid-sdiv, .ui-jqgrid-hrdiv",o=this;return!0===W.p.toolbar[0]&&("both"===W.p.toolbar[1]&&(r+=", #"+$(h.ubDiv).attr("id")),r+=", #"+$(h.uDiv).attr("id")),t=$(r,"#gview_"+$.jgrid.jqID(W.p.id)).length,"visible"===W.p.gridstate?$(r,"#gbox_"+$.jgrid.jqID(W.p.id)).slideUp("fast",function(){0===--t&&($("span",o).removeClass(ze).addClass(Fe),W.p.gridstate="hidden",$("#gbox_"+$.jgrid.jqID(W.p.id)).hasClass("ui-resizable")&&$(".ui-resizable-handle","#gbox_"+$.jgrid.jqID(W.p.id)).hide(),$(W).triggerHandler("jqGridHeaderClick",[W.p.gridstate,e]),i&&(Me||W.p.onHeaderClick.call(W,W.p.gridstate,e)))}):"hidden"===W.p.gridstate&&$(r,"#gbox_"+$.jgrid.jqID(W.p.id)).slideDown("fast",function(){0===--t&&($("span",o).removeClass(Fe).addClass(ze),Me&&(W.p.datatype=Be,k(),Me=!1),W.p.gridstate="visible",$("#gbox_"+$.jgrid.jqID(W.p.id)).hasClass("ui-resizable")&&$(".ui-resizable-handle","#gbox_"+$.jgrid.jqID(W.p.id)).show(),$(W).triggerHandler("jqGridHeaderClick",[W.p.gridstate,e]),i&&(Me||W.p.onHeaderClick.call(W,W.p.gridstate,e)))}),!1}),Me&&(W.p.datatype="local",$(".ui-jqgrid-titlebar-close",h.cDiv).trigger("click")))):($(h.cDiv).hide(),W.p.toppager||$(h.hDiv).addClass(K(W.p.styleUI+".common","cornertop",!0))),(W.p.headerrow?$(h.hrDiv):$(h.hDiv)).after(h.bDiv),$(h.hDiv).mousemove(function(e){if(h.resizing)return h.dragMove(e),!1}),$(".ui-jqgrid-labels",h.hDiv).on("selectstart",function(){return!1}),$(document).on("mouseup.jqGrid"+W.p.id,function(){return!h.resizing||(h.dragEnd(!0),!1)}),"rtl"===W.p.direction&&$(W).on("jqGridAfterGridComplete.setRTLPadding",function(){var
e=h.bDiv.offsetWidth-h.bDiv.clientWidth;0<e&&(e+=2),$(h.hDiv).find("div").first().hasClass("ui-jqgrid-hbox-rtl")&&$(h.hDiv).find("div").first().css({paddingLeft:e+"px"}),h.hDiv.scrollLeft=h.bDiv.scrollLeft}),W.p.autoResizing&&$(W).on("jqGridAfterGridComplete.setAutoSizeColumns",function(){$(W.p.colModel).each(function(e){this.autosize&&!this.hidden&&this._maxsize&&0<this._maxsize&&($(W).jqGrid("resizeColumn",e,this._maxsize+W.p.cellLayout),this._maxsize=0)}),$(W).jqGrid("refreshGroupHeaders")}),W.formatCol=c,W.sortData=M,W.updatepager=function(e,t){var
i,r,o,n,s,a="",l=W.p.pager?W.p.pager.substring(1):"",d=l?"_"+l:"",c=W.p.toppager?"_"+W.p.toppager.substr(1):"",p=parseInt(W.p.page,10)-1;p<0&&(p=0),i=(p*=parseInt(W.p.rowNum,10))+W.p.reccount,W.p.scroll&&(s=$("tbody",W.grid.bDiv).first().find("> tr").slice(1),i>W.p.records&&(i=W.p.records),p=i-s.length,W.p.reccount=s.length,(s=s.outerHeight()||W.grid.prevRowHeight)&&(n=p*s,o=parseInt(W.p.records,10)*s,$(W.grid.bDiv).find(">div").first().css({height:o}).children("div").first().css({height:n,display:n?"":"none"}),0===W.grid.bDiv.scrollTop&&1<W.p.page&&(W.grid.bDiv.scrollTop=W.p.rowNum*(W.p.page-1)*s)),W.grid.bDiv.scrollLeft=W.grid.hDiv.scrollLeft),a=W.p.pager||"",(a+=W.p.toppager?a?","+W.p.toppager:W.p.toppager:"")&&(o=$.jgrid.getRegional(W,"formatter.integer"),n=Y(W.p.page),s=Y(W.p.lastpage),$(".selbox",a)[this.p.useProp?"prop":"attr"]("disabled",!1),!0===W.p.pginput&&($("#input"+d).html($.jgrid.template($.jgrid.getRegional(W,"defaults.pgtext",W.p.pgtext)||"","<input "+K(X,"pgInput",!1,"ui-pg-input")+" type='text' size='2' maxlength='7' value='0' role='textbox'/>","<span id='sp_1_"+l+"'></span>")),W.p.toppager&&$("#input_t"+c).html($.jgrid.template($.jgrid.getRegional(W,"defaults.pgtext",W.p.pgtext)||"","<input "+K(X,"pgInput",!1,"ui-pg-input")+" type='text' size='2' maxlength='7' value='0' role='textbox'/>","<span id='sp_1_"+l+"_toppager'></span>")),$(".ui-pg-input",a).val(W.p.page),r=W.p.toppager?"#sp_1"+d+",#sp_1"+d+"_toppager":"#sp_1"+d,$(r).html($.fmatter?$.fmatter.util.NumberFormat(W.p.lastpage,o):W.p.lastpage)),W.p.viewrecords&&(0===W.p.reccount?$(".ui-paging-info",a).html($.jgrid.getRegional(W,"defaults.emptyrecords",W.p.emptyrecords)):(l=p+1,r=W.p.records,$.fmatter&&(l=$.fmatter.util.NumberFormat(l,o),i=$.fmatter.util.NumberFormat(i,o),r=$.fmatter.util.NumberFormat(r,o)),o=$.jgrid.getRegional(W,"defaults.recordtext",W.p.recordtext),$(".ui-paging-info",a).html($.jgrid.template(o,l,i,r)))),!0===W.p.pgbuttons&&(n<=0&&(n=s=0),1===n||0===n?($("#first"+d+", #prev"+d).addClass(w).removeClass(_),W.p.toppager&&$("#first_t"+c+", #prev_t"+c).addClass(w).removeClass(_)):($("#first"+d+", #prev"+d).removeClass(w),W.p.toppager&&$("#first_t"+c+", #prev_t"+c).removeClass(w)),n===s||0===n?($("#next"+d+", #last"+d).addClass(w).removeClass(_),W.p.toppager&&$("#next_t"+c+", #last_t"+c).addClass(w).removeClass(_)):($("#next"+d+", #last"+d).removeClass(w),W.p.toppager&&$("#next_t"+c+", #last_t"+c).removeClass(w)))),!0===e&&!0===W.p.rownumbers&&$(">td.jqgrid-rownum",W.rows).each(function(e){$(this).html(p+1+e)}),0===W.p.reccount&&(e=K(X,"rowBox",!0,"jqgrow ui-row-"+W.p.direction),e=ne("norecs",!1,e,{},""),e+="<td style='text-align:center' colspan='"+h.headers.length+"'>"+$.jgrid.getRegional(W,"defaults.emptyrecords",W.p.emptyrecords)+"</td>",e+="</tr>",$(h.bDiv).find("table").first().append(e)),t&&W.p.jqgdnd&&$(W).jqGrid("gridDnD","updateDnD"),$(W).triggerHandler("jqGridGridComplete"),$.jgrid.isFunction(W.p.gridComplete)&&W.p.gridComplete.call(W),$(W).triggerHandler("jqGridAfterGridComplete")},W.refreshIndex=oe,W.setHeadCheckBox=se,W.constructTr=ne,W.formatter=g,$.extend(h,{populate:k,emptyRows:re,beginReq:x,endReq:q}),this.grid=h,W.addXmlData=function(e){m(e)},W.addJSONData=function(e){j(e)},W.addLocalData=D,W.treeGrid_beforeRequest=function(){W.p.treeGrid&&W.p.treeGrid_bigData&&void
0!==W.p.postData.nodeid&&"string"==typeof
W.p.postData.nodeid&&(""!==W.p.postData.nodeid||0<parseInt(W.p.postData.nodeid,10))&&(W.p.postData.rows=1e4,W.p.postData.page=1,W.p.treeGrid_rootParams.otherData.nodeid=W.p.postData.nodeid)},W.treeGrid_afterLoadComplete=function(){W.p.treeGrid&&W.p.treeGrid_bigData&&(void
0!==W.p.treeGrid_rootParams.otherData.nodeid&&"string"==typeof
W.p.treeGrid_rootParams.otherData.nodeid&&(""!==W.p.treeGrid_rootParams.otherData.nodeid||0<parseInt(W.p.treeGrid_rootParams.otherData.nodeid,10))?void
0!==W.p.treeGrid_rootParams&&null!=W.p.treeGrid_rootParams&&(W.p.page=W.p.treeGrid_rootParams.page,W.p.lastpage=W.p.treeGrid_rootParams.lastpage,W.p.postData.rows=W.p.treeGrid_rootParams.postData.rows,W.p.postData.totalrows=W.p.treeGrid_rootParams.postData.totalrows,W.p.treeGrid_rootParams.otherData.nodeid="",W.updatepager(!1,!0)):W.p.treeGrid_rootParams={page:W.p.page,lastpage:W.p.lastpage,postData:{rows:W.p.postData.rows,totalrows:W.p.postData.totalrows},rowNum:W.p.rowNum,rowTotal:W.p.rowTotal,otherData:{nodeid:""}})},this.grid.cols=this.rows[0].cells,$.jgrid.isFunction(W.p.onInitGrid)&&W.p.onInitGrid.call(W),$(W).triggerHandler("jqGridInitGrid"),k(),W.p.hiddengrid=!1,W.p.responsive&&(Re="onorientationchange"in
window?"orientationchange":"resize",$(window).on(Re,function(){$(W).jqGrid("resizeGrid")}))}else
alert($.jgrid.getRegional(this,"errors.model"))}else
alert("Element is not a table or has no id!")}function
Oe(e,t,i,r){var
o;!(W.p.multiselect&&W.p.multiboxonly||W.p.multimail)||t?$(W).jqGrid("setSelection",e,r,i):W.p.multiboxonly&&W.p.multimail?($(W).triggerHandler("jqGridSelectRow",[e,!1,i]),W.p.onSelectRow&&W.p.onSelectRow.call(W,e,!1,i)):(o=W.p.frozenColumns?W.p.id+"_frozen":"",$(W.p.selarrrow).each(function(e,t){var
i=$(W).jqGrid("getGridRowById",t);i&&$(i).removeClass(Q),$("#jqg_"+$.jgrid.jqID(W.p.id)+"_"+$.jgrid.jqID(t))[W.p.useProp?"prop":"attr"]("checked",!1),o&&($("#"+$.jgrid.jqID(t),"#"+$.jgrid.jqID(o)).removeClass(Q),$("#jqg_"+$.jgrid.jqID(W.p.id)+"_"+$.jgrid.jqID(t),"#"+$.jgrid.jqID(o))[W.p.useProp?"prop":"attr"]("checked",!1))}),W.p.selarrrow=[],$(W).jqGrid("setSelection",e,r,i))}});var
e=$.jgrid.getMethod(Te);if(!e)throw"jqGrid - No such method: "+Te;var
...
e,t,i,r,o,n,s,a,l=this,d=$.jgrid.getMethod("getStyleUI"),c=d(l.p.styleUI+".common","highlight",!0),p=d(l.p.styleUI+".common","disabled",!0);void
0!==u&&(void
0===f&&(f=!0),f=!1!==f,g=!1!==g,!(d=$(l).jqGrid("getGridRowById",u))||!d.className||-1<d.className.indexOf(p)||(!0===l.p.scrollrows&&0<=(t=$(l).jqGrid("getGridRowById",u).rowIndex)&&(o=t,n=$(l.grid.bDiv)[0].clientHeight,s=$(l.grid.bDiv)[0].scrollTop,a=$(l.rows[o]).position().top,o=l.rows[o].clientHeight,n+s<=a+o?$(l.grid.bDiv)[0].scrollTop=a-(n+s)+o+s:a<n+s&&a<s&&($(l.grid.bDiv)[0].scrollTop=a)),!0===l.p.frozenColumns&&(i=l.p.id+"_frozen"),l.p.multiselect?(l.setHeadCheckBox(!1),l.p.selrow=d.id,-1===(r=$.inArray(l.p.selrow,l.p.selarrrow))?("ui-subgrid"!==d.className&&$(d).addClass(c).attr("aria-selected","true"),e=!0,l.p.selarrrow.push(l.p.selrow)):-1!==r&&"_sp_"===h?("ui-subgrid"!==d.className&&$(d).addClass(c).attr("aria-selected","true"),e=!0):("ui-subgrid"!==d.className&&$(d).removeClass(c).attr("aria-selected","false"),e=!1,l.p.selarrrow.splice(r,1),t=l.p.selarrrow[0],l.p.selrow=void
0===t?null:t),$("#jqg_"+$.jgrid.jqID(l.p.id)+"_"+$.jgrid.jqID(d.id))[l.p.useProp?"prop":"attr"]("checked",e),i&&(f&&(-1===r?$("#"+$.jgrid.jqID(u),"#"+$.jgrid.jqID(i)).addClass(c):$("#"+$.jgrid.jqID(u),"#"+$.jgrid.jqID(i)).removeClass(c)),$("#jqg_"+$.jgrid.jqID(l.p.id)+"_"+$.jgrid.jqID(u),"#"+$.jgrid.jqID(i))[l.p.useProp?"prop":"attr"]("checked",e)),g&&($(l).triggerHandler("jqGridSelectRow",[d.id,e,h]),l.p.onSelectRow&&l.p.onSelectRow.call(l,d.id,e,h))):"ui-subgrid"!==d.className&&(e=l.p.selrow!==d.id&&(f&&((r=$(l).jqGrid("getGridRowById",l.p.selrow))&&$(r).removeClass(c).attr({"aria-selected":"false",tabindex:"-1"}),$(d).addClass(c).attr({"aria-selected":"true",tabindex:"0"}),i&&($("#"+$.jgrid.jqID(l.p.selrow),"#"+$.jgrid.jqID(i)).removeClass(c),$("#"+$.jgrid.jqID(u),"#"+$.jgrid.jqID(i)).addClass(c))),!0),l.p.selrow=d.id,g&&($(l).triggerHandler("jqGridSelectRow",[d.id,e,h]),l.p.onSelectRow&&l.p.onSelectRow.call(l,d.id,e,h)))))})},resetSelection:function(s){return this.each(function(){var
...
0!==s?(e=s===r.p.selrow?r.p.selrow:s,$("#"+$.jgrid.jqID(r.p.id)+" tbody").first().find("tr#"+$.jgrid.jqID(e)).removeClass(o).attr("aria-selected","false"),i&&$("#"+$.jgrid.jqID(e),"#"+$.jgrid.jqID(i)).removeClass(o),r.p.multiselect&&($("#jqg_"+$.jgrid.jqID(r.p.id)+"_"+$.jgrid.jqID(e),"#"+$.jgrid.jqID(r.p.id))[r.p.useProp?"prop":"attr"]("checked",!1),i&&$("#jqg_"+$.jgrid.jqID(r.p.id)+"_"+$.jgrid.jqID(e),"#"+$.jgrid.jqID(i))[r.p.useProp?"prop":"attr"]("checked",!1),r.setHeadCheckBox(!1),-1!==(t=$.inArray($.jgrid.jqID(e),r.p.selarrrow))&&r.p.selarrrow.splice(t,1)),r.p.onUnSelectRow&&r.p.onUnSelectRow.call(r,e),e=null):r.p.multiselect?($(r.p.selarrrow).each(function(e,t){$($(r).jqGrid("getGridRowById",t)).removeClass(o).attr("aria-selected","false"),$("#jqg_"+$.jgrid.jqID(r.p.id)+"_"+$.jgrid.jqID(t))[r.p.useProp?"prop":"attr"]("checked",!1),i&&($("#"+$.jgrid.jqID(t),"#"+$.jgrid.jqID(i)).removeClass(o),$("#jqg_"+$.jgrid.jqID(r.p.id)+"_"+$.jgrid.jqID(t),"#"+$.jgrid.jqID(i))[r.p.useProp?"prop":"attr"]("checked",!1)),r.p.onUnSelectRow&&r.p.onUnSelectRow.call(r,t)}),r.setHeadCheckBox(!1),r.p.selarrrow=[],r.p.selrow=null):r.p.selrow&&($("#"+$.jgrid.jqID(r.p.id)+" tbody").first().find("tr#"+$.jgrid.jqID(r.p.selrow)).removeClass(o).attr("aria-selected","false"),i&&$("#"+$.jgrid.jqID(r.p.selrow),"#"+$.jgrid.jqID(i)).removeClass(o),r.p.onUnSelectRow&&r.p.onUnSelectRow.call(r,r.p.selrow),r.p.selrow=null),!0===r.p.cellEdit&&0<=parseInt(r.p.iCol,10)&&0<=parseInt(r.p.iRow,10)&&($("td",r.rows[r.p.iRow]).eq(r.p.iCol).removeClass("edit-cell "+o),$(r.rows[r.p.iRow]).removeClass("selected-row "+n))})},getRowData:function(e,n,s){var
a,l,d={},c=!1,p=0;return this.each(function(){var
t,i,r=this;if(null==e)c=!0,a=[],l=r.rows.length;else{if(!(i=$(r).jqGrid("getGridRowById",e)))return d;l=1}for(n&&!0===n&&0<r.p.data.length||(n=!1),null==s&&(s=!1);p<l;){if(c&&(i=r.rows[p]),$(i).hasClass("jqgrow")&&"norecs"!==i.id){if(n?d=$.extend({},r.p.data[r.p._index[$.jgrid.stripPref(r.p.idPrefix,i.id)]]):$(i).children('td[role="gridcell"]').each(function(e){if("cb"!==(t=r.p.colModel[e].name)&&"subgrid"!==t&&"rn"!==t)if(!0===r.p.treeGrid&&t===r.p.ExpandColumn)d[t]=$.jgrid.htmlDecode($(this).find("span").first().html());else
try{d[t]=$.unformat.call(r,this,{rowId:i.id,colModel:r.p.colModel[e]},e)}catch(e){d[t]=$.jgrid.htmlDecode($(this).html())}}),!0===r.p.treeGrid&&s){var
o=r.p.treeReader.level_field;s+="";try{o=parseInt(d[o],10)}catch(e){o=0}d[r.p.ExpandColumn]=s.repeat(o)+d[r.p.ExpandColumn]}c&&(a.push(d),d={})}p++}}),a||d},delRowData:function(i){var
r,o,n,s=!1;return this.each(function(){var
e,t=this;if(!(r=$(t).jqGrid("getGridRowById",i)))return!1;i=r.id,t.p.subGrid&&(n=$(r).next()).hasClass("ui-subgrid")&&n.remove(),$(r).remove(),t.p.records--,t.p.reccount--,t.updatepager(!0,!1),s=!0,t.p.multiselect&&-1!==(o=$.inArray(i,t.p.selarrrow))&&t.p.selarrrow.splice(o,1),t.p.multiselect&&0<t.p.selarrrow.length?t.p.selrow=t.p.selarrrow[t.p.selarrrow.length-1]:t.p.selrow===i&&(t.p.selrow=null),"local"===t.p.datatype&&(e=$.jgrid.stripPref(t.p.idPrefix,i),void
0!==(e=t.p._index[e])&&(t.p.data.splice(e,1),t.refreshIndex()))}),s},setRowData:function(l,d,c,p){var
u,g=!0;return this.each(function(){if(!this.grid)return!1;var
i,r,e,o=this,n={},s=$(this).jqGrid("getGridRowById",l);if(!s)return!1;if(!0===p&&(e=$(o).jqGrid("getRowData",l,"local"===o.p.datatype)),d){p&&(d=$.extend(e,d));try{if($(this.p.colModel).each(function(e){u=this.name;var
t=$.jgrid.getAccessor(d,u);void
0!==t&&(n[u]=this.formatter&&"string"==typeof
this.formatter&&"date"===this.formatter?$.unformat.date.call(o,t,this):t,r=o.formatter(l,n[u],e,d,"edit"),i=o.formatCol(e,s.rowIndex,r,d,l,d),i=$('<td role="gridcell" '+i+">"+r+"</td>")[0],r=$(s).children("td[role='gridcell']").eq(e),$(r).after(i).remove(),o.p.treeGrid&&o.p.ExpandColumn===u&&$(o).jqGrid("setTreeNode",s.rowIndex,s.rowIndex+1))}),"local"===o.p.datatype){var
t,a=$.jgrid.stripPref(o.p.idPrefix,l),a=o.p._index[a];if(o.p.treeGrid)for(t
in
o.p.treeReader)o.p.treeReader.hasOwnProperty(t)&&delete
n[o.p.treeReader[t]];void
0!==a&&(o.p.data[a]=$.extend(!0,o.p.data[a],n)),n=null}}catch(e){g=!1}}g&&("string"==typeof
c?$(s).addClass(c):null!==c&&"object"==typeof
c&&$(s).css(c),$(o).triggerHandler("jqGridAfterGridComplete"))}),g},addRowData:function(s,a,l,d){-1===$.inArray(l,["first","last","before","after"])&&(l="last");var
c,p,u,g,h,f,m,v,w,j,_,b,y=!1,D="",x="",q="";return a&&(Array.isArray(a)?(v=!0,w=s):v=!(a=[a]),this.each(function(){var
e=this,t=a.length;g=!0===e.p.rownumbers?1:0,p=!0===e.p.multiselect?1:0,u=!0===e.p.subGrid?1:0,v||(void
0!==s?s=String(s):(s=$.jgrid.randId(),!1!==e.p.keyName&&(w=e.p.keyName,void
0!==a[0][w]&&(s=a[0][w]))));var
i=0,r=$(e).jqGrid("getStyleUI",e.p.styleUI+".base","rowBox",!0,"jqgrow ui-row-"+e.p.direction),o={},n=!!$.jgrid.isFunction(e.p.afterInsertRow);for(g&&(D=$(e).jqGrid("getStyleUI",e.p.styleUI+".base","rownumBox",!1,"jqgrid-rownum")),p&&(x=$(e).jqGrid("getStyleUI",e.p.styleUI+".base","multiBox",!1,"cbox"));i<t;){if(j=a[i],c=[],v)try{void
0===(s=j[w])&&(s=$.jgrid.randId())}catch(e){s=$.jgrid.randId()}for(b=s,s=e.p.idPrefix+s,g&&(q=e.formatCol(0,1,"",null,s,!0),c[c.length]='<td role="gridcell" '+D+" "+q+">0</td>"),p&&(m='<input role="checkbox" type="checkbox" id="jqg_'+e.p.id+"_"+s+'" '+x+"/>",q=e.formatCol(g,1,"",null,s,!0),c[c.length]='<td role="gridcell" '+q+">"+m+"</td>"),u&&(c[c.length]=$(e).jqGrid("addSubGridCell",p+g,1)),f=p+u+g;f<e.p.colModel.length;f++)_=e.p.colModel[f],o[_=_.name]=j[_],m=e.formatter(s,$.jgrid.getAccessor(j,_),f,j),q=e.formatCol(f,1,m,j,s,o),c[c.length]='<td role="gridcell" '+q+">"+m+"</td>";if(c.unshift(e.constructTr(s,!1,r,o,j)),c[c.length]="</tr>",0===e.rows.length)$(e.grid.bDiv).find("table").first().append(c.join(""));else
switch(l){case"last":$(e.rows[e.rows.length-1]).after(c.join("")),h=e.rows.length-1;break;case"first":$(e.rows[0]).after(c.join("")),h=1;break;case"after":(h=$(e).jqGrid("getGridRowById",d))&&($(e.rows[h.rowIndex+1]).hasClass("ui-subgrid")?$(e.rows[h.rowIndex+1]).after(c):$(h).after(c.join("")),h=h.rowIndex+1);break;case"before":(h=$(e).jqGrid("getGridRowById",d))&&($(h).before(c.join("")),h=h.rowIndex-1)}if(!0===e.p.subGrid&&$(e).jqGrid("addSubGrid",p+g,h),e.p.records++,e.p.reccount++,$(e).triggerHandler("jqGridAfterInsertRow",[s,j,j]),n&&e.p.afterInsertRow.call(e,s,j,j),i++,"local"===e.p.datatype)switch(o[e.p.localReader.id]=b,l){case"first":e.p.data.unshift(o);break;case"last":e.p.data.push(o);break;case"before":case"after":e.p.data.splice(h-1,0,o)}o={},1===e.p.reccount&&(h=$(e).jqGrid("getGridRowById","norecs")).rowIndex&&0<h.rowIndex&&$(e.rows[h.rowIndex]).remove()}"local"===e.p.datatype&&e.refreshIndex(),e.updatepager(!0,!0),y=!0})),y},footerData:function(r,o,n){var
s,a,l=!1,d={};return void
...
$(this.p.colModel).each(function(e){s=this.name,"set"===r?void
0!==o[s]&&(t=n?i.formatter("",o[s],e,o,"edit"):o[s],a=this.title?{title:$.jgrid.stripHtml(t)}:{},$("tr.footrow td",i.grid.sDiv).eq(e).html(t).attr(a),l=!0):"get"===r&&(d[s]=$("tr.footrow td",i.grid.sDiv).eq(e).html())})))}),"get"===r?d:l},headerData:function(r,o,n){var
s,a,l=!1,d={};return void
0===r&&(r="get"),"boolean"!=typeof
n&&(n=!0),r=r.toLowerCase(),this.each(function(){var
...
e)if(e.hasOwnProperty(t))return;return 1}(o))&&(l=!0,void
$(this.p.colModel).each(function(e){s=this.name,"set"===r?void
0!==o[s]&&(t=n?i.formatter("",o[s],e,o,"edit"):o[s],a=this.title?{title:$.jgrid.stripHtml(t)}:{},$("tr.hrheadrow td",i.grid.hrDiv).eq(e).html(t).attr(a),l=!0):"get"===r&&(d[s]=$("tr.hrheadrow td",i.grid.hrDiv).eq(e).html())})))}),"get"===r?d:l},showHideCol:function(d,c){return this.each(function(){var
t,i=this,r=!1,o=$.jgrid.cell_width?0:i.p.cellLayout,e=!1;if(i.grid){"string"==typeof
d&&(d=[d]);var
n=""===(c="none"!==c?"":"none"),s=null,a=$(i).jqGrid("isGroupHeaderOn");if(i.p.frozenColumns&&($(i).jqGrid("destroyFrozenColumns"),e=!0),a&&($(i).jqGrid("destroyGroupHeader",!1),s=$.extend([],i.p.groupHeader),i.p.groupHeader=null),$(this.p.colModel).each(function(e){-1!==$.inArray(this.name,d)&&this.hidden===n&&($("tr[role=row]",i.grid.hDiv).each(function(){$(this.cells[e]).css("display",c)}),$(i.rows).each(function(){$(this).hasClass("jqgroup")||$(this.cells[e]).css("display",c)}),i.p.footerrow&&$("tr.footrow td",i.grid.sDiv).eq(e).css("display",c),i.p.headerrow&&$("tr.hrheadrow td",i.grid.hrDiv).eq(e).css("display",c),t=parseInt(this.width,10),"none"===c?i.p.tblwidth-=t+o:i.p.tblwidth+=t+o,this.hidden=!n,r=!0,$(i).triggerHandler("jqGridShowHideCol",[n,this.name,e]))}),!0===r&&(!0!==i.p.shrinkToFit||isNaN(i.p.height)||(i.p.tblwidth+=parseInt(i.p.scrollOffset,10)),$(i).jqGrid("setGridWidth",!0===i.p.shrinkToFit?i.p.tblwidth:i.p.width)),a&&s)for(var
l=0;l<s.length;l++)$(i).jqGrid("setGroupHeaders",s[l]);e&&$(i).jqGrid("setFrozenColumns")}})},hideCol:function(e){return this.each(function(){$(this).jqGrid("showHideCol",e,"none")})},showCol:function(e){return this.each(function(){$(this).jqGrid("showHideCol",e,"")})},remapColumns:function(r,e,t){function
i(t){var
...
e=i[this];e&&t.appendChild(e)})})}i(o.p.colModel),i(o.p.colNames),i(o.grid.headers),n($(o.grid.hDiv).find("thead").first(),t&&":not(.ui-jqgrid-labels)"),e&&n($("#"+$.jgrid.jqID(o.p.id)+" tbody").first(),".jqgfirstrow, tr.jqgrow, tr.jqfoot"),o.p.footerrow&&n($(o.grid.sDiv).find("tbody").first()),o.p.headerrow&&n($(o.grid.hrDiv).find("tbody").first()),o.p.remapColumns&&(o.p.remapColumns.length?i(o.p.remapColumns):o.p.remapColumns=$.makeArray(r)),o.p.lastsort=$.inArray(o.p.lastsort,r),o.p.treeGrid&&(o.p.expColInd=$.inArray(o.p.expColInd,r)),$(o).triggerHandler("jqGridRemapColumns",[r,e,t])},setGridWidth:function(v,w,j=!0){return this.each(function(){if(this.grid){var
e,t,i,r=this,o=!1,n=0,s=$.jgrid.cell_width?0:r.p.cellLayout,a=0,l=!1,d=r.p.scrollOffset,c=0,p=-1===r.p.styleUI.search("Bootstrap")||isNaN(r.p.height)?0:2;if("boolean"!=typeof
w&&(w=r.p.shrinkToFit),!isNaN(v)){if(v=parseInt(v,10),r.grid.width=r.p.width=v,$("#gbox_"+$.jgrid.jqID(r.p.id)).css("width",v+"px"),$("#gview_"+$.jgrid.jqID(r.p.id)).css("width",v+"px"),$(r.grid.bDiv).css("width",v-p+"px"),$(r.grid.hDiv).css("width",v-p+"px"),r.p.pager&&$(r.p.pager).css("width",v-p+"px"),r.p.toppager&&$(r.p.toppager).css("width",v-p+"px"),!0===r.p.toolbar[0]&&($(r.grid.uDiv).css("width",v-p+"px"),"both"===r.p.toolbar[1]&&$(r.grid.ubDiv).css("width",v-p+"px")),r.p.footerrow&&$(r.grid.sDiv).css("width",v-p+"px"),r.p.headerrow&&$(r.grid.hrDiv).css("width",v-p+"px"),(e=$(r).jqGrid("isGroupHeaderOn"))&&$(r).jqGrid("destroyGroupHeader",!1),r.p.frozenColumns&&j&&($(r).jqGrid("destroyFrozenColumns"),o=!0),!1===w&&!0===r.p.forceFit&&(r.p.forceFit=!1),!0===w){if($.each(r.p.colModel,function(){!1===this.hidden&&(h=this.widthOrg,n+=h+s,this.fixed?c+=h+s:a++)}),0===a)return;r.p.tblwidth=n,i=v-s*a-c,isNaN(r.p.height)||($(r.grid.bDiv)[0].clientHeight<$(r.grid.bDiv)[0].scrollHeight||1===r.rows.length||"scroll"===$(r.grid.bDiv).css("overflow-y"))&&(l=!0,i-=d);var
u,g=(n=0)<r.grid.cols.length;if($.each(r.p.colModel,function(e){!1!==this.hidden||this.fixed||(h=this.widthOrg,(h=Math.round(i*h/(r.p.tblwidth-s*a-c)))<0||(this.width=h,n+=h,r.grid.headers[e].width=h,r.grid.headers[e].el.style.width=h+"px",r.p.footerrow&&(r.grid.footers[e].style.width=h+"px"),r.p.headerrow&&(r.grid.hrheaders[e].style.width=h+"px"),g&&(r.grid.cols[e].style.width=h+"px"),t=e))}),!t)return;u=0,l?v-c-(n+s*a)!==d&&(u=v-c-(n+s*a)-d):l||0===Math.abs(v-c-(n+s*a))||(u=v-c-(n+s*a)-p),r.p.colModel[t].width+=u,r.p.tblwidth=n+u+s*a+c,r.p.tblwidth>v?(u=r.p.tblwidth-parseInt(v,10),r.p.tblwidth=v,h=r.p.colModel[t].width=r.p.colModel[t].width-u):r.p.tblwidth===v?(h=r.p.colModel[t].width=r.p.colModel[t].width-p,r.p.tblwidth=v-p):h=r.p.colModel[t].width;var
p=$(r.grid.bDiv)[0].scrollWidth>$(r.grid.bDiv).width()&&0!=p?-1:0,h=r.p.colModel[t].width+=p;r.grid.headers[t].width=h,r.grid.headers[t].el.style.width=h+"px",g&&(r.grid.cols[t].style.width=h+"px"),r.p.footerrow&&(r.grid.footers[t].style.width=h+"px"),r.p.headerrow&&(r.grid.hrheaders[t].style.width=h+"px")}if($(r.grid.bDiv).find("table").first().css("width",r.p.tblwidth+"px"),$(r.grid.hDiv).find("table").first().css("width",r.p.tblwidth+"px"),r.grid.hDiv.scrollLeft=r.grid.bDiv.scrollLeft,r.p.footerrow&&$(r.grid.sDiv).find("table").first().css("width",r.p.tblwidth+"px"),r.p.headerrow&&$(r.grid.hrDiv).find("table").first().css("width",r.p.tblwidth+"px"),e){var
f=$.extend([],r.p.groupHeader);r.p.groupHeader=null;for(var
m=0;m<f.length;m++)$(r).jqGrid("setGroupHeaders",f[m]);r.grid.hDiv.scrollLeft=r.grid.bDiv.scrollLeft}o&&$(r).jqGrid("setFrozenColumns")}}})},setGridHeight:function(o,n=!1,s=!0){return this.each(function(){var
e,t,i,r=this;r.grid&&(e=$(r.grid.bDiv),t=$(r.grid.hDiv).outerHeight(),!(i=!1)===n&&(r.p.pager&&(t+=$(r.p.pager).outerHeight()),r.p.toppager&&(t+=$(r.p.toppager).outerHeight()),!0===r.p.toolbar[0]&&(t+=$(r.grid.uDiv).outerHeight(),"both"===r.p.toolbar[1]&&(t+=$(r.grid.ubDiv).outerHeight())),r.p.footerrow&&(t+=$(r.grid.sDiv).outerHeight()),r.p.headerrow&&(t+=$(r.grid.hrDiv).outerHeight()),r.p.caption&&(t+=$(r.grid.cDiv).outerHeight()),t<o&&(o-=t)),r.p.frozenColumns&&s&&($(r).jqGrid("destroyFrozenColumns"),i=!0),e.css({height:o+(isNaN(o)?"":"px")}),r.p.height=o,i&&$(r).jqGrid("setFrozenColumns"),r.p.scroll&&r.grid.populateVisible())})},maxGridHeight:function(e,o){return this.each(function(){var
...
e=$(this).jqGrid("getStyleUI",this.p.styleUI+".common","cornertop",!0);this.p.caption=t,$(".ui-jqgrid-title, .ui-jqgrid-title-rtl",this.grid.cDiv).html(t),$(this.grid.cDiv).show(),$(this.grid.hDiv).removeClass(e)})},setLabel:function(r,o,n,s){return this.each(function(){var
e,t,i=-1;this.grid&&null!=r&&(isNaN(r)?$(this.p.colModel).each(function(e){if(this.name===r)return i=e,!1}):i=parseInt(r,10),0<=i&&(e=$("tr.ui-jqgrid-labels th",this.grid.hDiv).eq(i),o&&(t=$(".s-ico",e),$("[id^=jqgh_]",e).empty().html(o).append(t),this.p.colNames[i]=o),n&&("string"==typeof
n?$(e).addClass(n):$(e).css(n)),"object"==typeof
s&&$(e).attr(s)))})},setSortIcon:function(a,l){return this.each(function(){var
e,t,i,r=this,o=-1,n=1;if(r.grid){null!=l?isNaN(l)?$(r.p.colModel).each(function(e){if(this.name===l)return o=e,!1}):o=parseInt(l,10):n=r.p.colNames.length;for(var
s=0;s<n;s++)0<=o&&(s=o),"cb"!==(i=r.p.colModel[s].name)&&"subgrid"!==i&&"rn"!==i&&(e=$("tr.ui-jqgrid-labels th",r.grid.hDiv).eq(s),t=r.p.colNames[s],i=e.find(".s-ico"),"left"===a?e.find("div.ui-th-div").first().empty().addClass("ui-icon-left").append(i).append(t):"right"===a&&e.find("div.ui-th-div").first().empty().removeClass("ui-icon-left").append(t).append(i))}})},setCell:function(a,l,d,c,p,u){return this.each(function(){var
e,t,i=this,r=-1;if(i.grid&&(isNaN(l)?$(i.p.colModel).each(function(e){if(this.name===l)return r=e,!1}):r=parseInt(l,10),0<=r&&(t=$(i).jqGrid("getGridRowById",a)))){var
o,n,s={};try{o=t.cells[r]}catch(e){}o&&(""===d&&!0!==u||((s=$(i).jqGrid("getRowData",a,"local"===i.p.datatype))[i.p.colModel[r].name]=d,n=i.formatter(a,d,r,s,"edit"),s=i.formatCol(r,t.rowIndex,n,s,a,s),e=$('<td role="gridcell" '+s+">"+n+"</td>")[0],$(o).after(e).remove(),i.p.treeGrid&&i.p.ExpandColumn===l&&$(i).jqGrid("setTreeNode",t.rowIndex,t.rowIndex+1),"local"===i.p.datatype&&(s=i.p.colModel[r],d=s.formatter&&"string"==typeof
s.formatter&&"date"===s.formatter?$.unformat.date.call(i,d,s):d,void
0!==(n=i.p._index[$.jgrid.stripPref(i.p.idPrefix,a)])&&(i.p.data[n][s.name]=d))),"string"==typeof
c?$(e).addClass(c):c&&$(e).css(c),"object"==typeof
p&&$(e).attr(p))}})},getCell:function(o,n,s){var
a,l=!1;return void
0===s&&(s=!1),this.each(function(){var
t,e,i=this,r=-1;if(i.grid&&(t=n,isNaN(n)?$(i.p.colModel).each(function(e){if(this.name===n)return t=this.name,r=e,!1}):r=parseInt(n,10),0<=r&&(e=$(i).jqGrid("getGridRowById",o))))if(a=$("td",e).eq(r),s)l=a;else{try{l=$.unformat.call(i,a,{rowId:e.id,colModel:i.p.colModel[r]},r)}catch(e){l=$.jgrid.htmlDecode(a.html())}i.p.treeGrid&&l&&i.p.ExpandColumn===t&&(l=$("<div>"+l+"</div>").find("span").first().html())}}),l},getCol:function(n,s,a){var
l,d,c,p,u=[],g=0;s="boolean"==typeof
s&&s,void
0===a&&(a=!1);var
h=$.jgrid.getFont(this[0]);return this.each(function(){var
t=this,i=-1;if(t.grid&&(isNaN(n)?$(t.p.colModel).each(function(e){if(this.name===n)return i=e,!1}):i=parseInt(n,10),0<=i)){var
e=t.rows.length,r=0,o=0;if(e&&0<e){for(;r<e;r++)if($(t.rows[r]).hasClass("jqgrow")&&"norecs"!==t.rows[r].id)if("maxwidth"!==a){try{l=$.unformat.call(t,$(t.rows[r].cells[i]),{rowId:t.rows[r].id,colModel:t.p.colModel[i]},i)}catch(e){l=$.jgrid.htmlDecode(t.rows[r].cells[i].innerHTML)}a?(p=parseFloat(l),isNaN(p)||(g+=p,void
0===c&&(c=d=p),d=Math.min(d,p),c=Math.max(c,p),o++)):s?u.push({id:t.rows[r].id,value:l}):u.push(l)}else
void
0===c&&(c=0),c=Math.max($.jgrid.getTextWidth(t.rows[r].cells[i].innerHTML,h),c);if(a)switch(a.toLowerCase()){case"sum":u=g;break;case"avg":u=g/o;break;case"count":u=o;break;case"min":u=d;break;case"max":u=c;break;case"maxwidth":u=c}}}}),u},clearGridData:function(i,r){return this.each(function(){var
...
a=this;$("body").is("[role]")||$("body").attr("role","application"),a.p.scrollrows=l.scrollingRows,$(a).on("keydown",function(e){var
t,i,r=$(a).find("tr[tabindex=0]")[0],o=a.p.treeReader.expanded_field;if(r){var
n=a.p.selrow,s=a.p._index[$.jgrid.stripPref(a.p.idPrefix,r.id)];if(37===e.keyCode||38===e.keyCode||39===e.keyCode||40===e.keyCode){if(38===e.keyCode){if(t="",(i=r.previousSibling)&&$(i).hasClass("jqgrow")){if($(i).is(":hidden")){for(;i;)if(i=i.previousSibling,!$(i).is(":hidden")&&$(i).hasClass("jqgrow")){t=i.id;break}}else
t=i.id;$(a).jqGrid("setSelection",t,!0,e)}$(a).triggerHandler("jqGridKeyUp",[t,n,e]),$.jgrid.isFunction(l.onUpKey)&&l.onUpKey.call(a,t,n,e),e.preventDefault()}if(40===e.keyCode){if(t="",(i=r.nextSibling)&&$(i).hasClass("jqgrow")){if($(i).is(":hidden")){for(;i;)if(i=i.nextSibling,!$(i).is(":hidden")&&$(i).hasClass("jqgrow")){t=i.id;break}}else
t=i.id;$(a).jqGrid("setSelection",t,!0,e)}$(a).triggerHandler("jqGridKeyDown",[t,n,e]),$.jgrid.isFunction(l.onDownKey)&&l.onDownKey.call(a,t,n,e),e.preventDefault()}37===e.keyCode&&(a.p.treeGrid&&a.p.data[s][o]&&$(r).find("div.treeclick").trigger("click"),$(a).triggerHandler("jqGridKeyLeft",[a.p.selrow,e]),$.jgrid.isFunction(l.onLeftKey)&&l.onLeftKey.call(a,a.p.selrow,e)),39===e.keyCode&&(a.p.treeGrid&&!a.p.data[s][o]&&$(r).find("div.treeclick").trigger("click"),$(a).triggerHandler("jqGridKeyRight",[a.p.selrow,e]),$.jgrid.isFunction(l.onRightKey)&&l.onRightKey.call(a,a.p.selrow,e))}else
13===e.keyCode?($(a).triggerHandler("jqGridKeyEnter",[a.p.selrow,e]),$.jgrid.isFunction(l.onEnter)&&l.onEnter.call(a,a.p.selrow,e)):32===e.keyCode&&($(a).triggerHandler("jqGridKeySpace",[a.p.selrow,e]),$.jgrid.isFunction(l.onSpace)&&l.onSpace.call(a,a.p.selrow,e))}}).on("click",function(e){$(e.target).is("input, textarea, select")||$(e.target,a.rows).closest("tr.jqgrow").focus()})})},unbindKeys:function(){return this.each(function(){$(this).off("keydown")})},getLocalRow:function(e){var
...
t={},i=this[0];if(!i.grid)return!1;for(var
r=i.p.colModel,o=0;o<r.length;o++)if(r[o].name===e){t=r[o];break}return t},setColProp:function(i,r){return this.each(function(){if(this.grid&&$.isPlainObject(r))for(var
e=this.p.colModel,t=0;t<e.length;t++)if(e[t].name===i){$.extend(!0,this.p.colModel[t],r);break}})},sortGrid:function(n,s,a){return this.each(function(){var
...
s&&(s=!1),t&&i.sortData("jqgh_"+i.p.id+"_"+n,r,s,a,o))}})},setGridState:function(r){return this.each(function(){var
...
e,t,i,r,o,n,s,a,l=this,d=l.p.colModel,c=0,p=d.length,u=-1,g=!1,h=$(l).jqGrid("getStyleUI",l.p.styleUI+".base","headerDiv",!0,"ui-jqgrid-hdiv"),f=$(l).jqGrid("getStyleUI",l.p.styleUI+".common","hover",!0),m="border-box"===$("#gbox_"+$.jgrid.jqID(l.p.id)).css("box-sizing")?1:0;if(!0!==l.p.subGrid&&!0!==l.p.treeGrid&&!0!==l.p.cellEdit&&!l.p.scroll){for(;c<p&&!0===d[c].frozen;)g=!0,u=c,c++;0<=u&&g&&(e=parseInt($(".ui-jqgrid-hdiv","#gview_"+$.jgrid.jqID(l.p.id)).height(),10),s=$(".ui-jqgrid-bdiv","#gview_"+$.jgrid.jqID(l.p.id)).position(),t=$(".ui-jqgrid-hdiv","#gview_"+$.jgrid.jqID(l.p.id)).position(),l.grid.fhDiv=$('<div style="position:absolute;'+("rtl"===l.p.direction?"right:0px;":"left:0px;")+"top:"+t.top+"px;height:"+(e-m)+'px;" class="frozen-div '+h+'"></div>'),l.grid.fbDiv=$('<div style="position:absolute;'+("rtl"===l.p.direction?"right:0px;":"left:0px;")+"top:"+s.top+'px;overflow-y:hidden" class="frozen-bdiv ui-jqgrid-bdiv"></div>'),$("#gview_"+$.jgrid.jqID(l.p.id)).append(l.grid.fhDiv),m=$(".ui-jqgrid-htable","#gview_"+$.jgrid.jqID(l.p.id)).clone(!0),h=null,$(l).jqGrid("isGroupHeaderOn")?(h=$("tr.jqg-third-row-header",l.grid.hDiv).height(),$("tr.jqg-first-row-header, tr.jqg-third-row-header",m).each(function(){$("th",this).slice(u+1).remove()}),r=i=-1,$("tr.jqg-second-row-header th",m).each(function(){if(o=parseInt($(this).attr("colspan"),10),parseInt($(this).attr("rowspan"),10)&&(i++,r++),o&&(i+=o,r++),i===u)return r=u,!1}),i!==u&&(r=u),$("tr.jqg-second-row-header",m).each(function(){$("th",this).slice(r+1).remove()})):(n=[],$(".ui-jqgrid-htable tr","#gview_"+$.jgrid.jqID(l.p.id)).each(function(e,t){n.push(parseInt($(this).height(),10))}),$("tr",m).each(function(){$("th",this).slice(u+1).remove()}),$("tr",m).each(function(e){$(this).height(n[e])})),(s=$("tr.jqg-second-row-header th",m).filter(function(){return"none"!==$(this).css("display")}).first())&&""===$.jgrid.trim(s.text())&&s.html("&nbsp;"),(s=$("tr.jqg-third-row-header th",m).filter(function(){return"none"!==$(this).css("display")}).first())&&""===$.jgrid.trim(s.text())&&$("div",s).prepend("&nbsp;"),h&&$("tr.jqg-third-row-header th",m).eq(0).height(h),$(m).width(1),$.jgrid.msie()||$(m).css("height","100%"),$(l.grid.fhDiv).append(m).mousemove(function(e){if(l.grid.resizing)return l.grid.dragMove(e),!1}),l.p.headerrow&&(l.grid.fhrDiv=$('<div style="position:absolute;'+("rtl"===l.p.direction?"right:0px;":"left:0px;")+'top:0px;" class="frozen-hrdiv ui-jqgrid-hrdiv "></div>'),$("#gview_"+$.jgrid.jqID(l.p.id)).append(l.grid.fhrDiv)),l.p.footerrow&&(l.grid.fsDiv=$('<div style="position:absolute;'+("rtl"===l.p.direction?"right:0px;":"left:0px;")+'top:0px;" class="frozen-sdiv ui-jqgrid-sdiv"></div>'),$("#gview_"+$.jgrid.jqID(l.p.id)).append(l.grid.fsDiv)),$("#gview_"+$.jgrid.jqID(l.p.id)).append(l.grid.fbDiv),$(l.grid.fbDiv).on("mousewheel DOMMouseScroll",function(e){var
t=$(l.grid.bDiv).scrollTop();0<e.originalEvent.wheelDelta||e.originalEvent.detail<0?$(l.grid.bDiv).scrollTop(t-25):$(l.grid.bDiv).scrollTop(t+25),e.preventDefault()}),!0===l.p.hoverrows&&$("#"+$.jgrid.jqID(l.p.id)).off("mouseover mouseout"),$(l).on("jqGridAfterGridComplete.setFrozenColumns",function(){$("#"+$.jgrid.jqID(l.p.id)+"_frozen").remove(),a=parseInt($(l.grid.bDiv)[0].scrollWidth,10)>parseInt($(l.grid.bDiv)[0].clientWidth,10),$(l.grid.fbDiv).height($(l.grid.bDiv)[0].clientHeight-(a?0:l.p.scrollOffset-3));var
i=[];$("#"+$.jgrid.jqID(l.p.id)+" tr[role=row].jqgrow").each(function(){i.push($(this).height())});var
e,t,r=$("#"+$.jgrid.jqID(l.p.id)).clone(!0);$("tr[role=row]",r).each(function(){$("td[role=gridcell]",this).slice(u+1).remove()}),$(r).width(1).attr("id",l.p.id+"_frozen"),$(l.grid.fbDiv).append(r),$("tr[role=row].jqgrow",r).each(function(e,t){$(this).height(i[e])}),"norecs"===l.rows[1].id&&$("#norecs td",r).html(""),!0===l.p.hoverrows&&($("tr.jqgrow",r).hover(function(){$(this).addClass(f),$("#"+$.jgrid.jqID(this.id),"#"+$.jgrid.jqID(l.p.id)).addClass(f)},function(){$(this).removeClass(f),$("#"+$.jgrid.jqID(this.id),"#"+$.jgrid.jqID(l.p.id)).removeClass(f)}),$("tr.jqgrow","#"+$.jgrid.jqID(l.p.id)).hover(function(){$(this).addClass(f),$("#"+$.jgrid.jqID(this.id),"#"+$.jgrid.jqID(l.p.id)+"_frozen").addClass(f)},function(){$(this).removeClass(f),$("#"+$.jgrid.jqID(this.id),"#"+$.jgrid.jqID(l.p.id)+"_frozen").removeClass(f)})),l.p.headerrow&&(e=$(l.grid.hrDiv).position(),$("table",l.grid.fhrDiv).remove(),t=$(".ui-jqgrid-hrtable","#gview_"+$.jgrid.jqID(l.p.id)).clone(!0),$("tr",t).each(function(){$("td",this).slice(u+1).remove()}),$(t).width(1),$(l.grid.fhrDiv).css("top",e.top+"px").append(t)),l.p.footerrow&&(e=$(l.grid.sDiv).position(),$("table",l.grid.fsDiv).remove(),t=$(".ui-jqgrid-ftable","#gview_"+$.jgrid.jqID(l.p.id)).clone(!0),$("tr",t).each(function(){$("td",this).slice(u+1).remove()}),$(t).width(1),$(l.grid.fsDiv).css("top",e.top+"px").append(t))}),l.grid.hDiv.loading||$(l).triggerHandler("jqGridAfterGridComplete"),l.p.frozenColumns=!0)}}})},destroyFrozenColumns:function(){return this.each(function(){var
e,t,i;this.grid&&!0===this.p.frozenColumns&&(t=$(e=this).jqGrid("getStyleUI",e.p.styleUI+".common","hover",!0),$(e.grid.fhDiv).remove(),$(e.grid.fbDiv).remove(),e.grid.fhDiv=null,e.grid.fbDiv=null,e.p.footerrow&&($(e.grid.fsDiv).remove(),e.grid.fsDiv=null),e.p.headerrow&&($(e.grid.fhrDiv).remove(),e.grid.fhrDiv=null),$(this).off(".setFrozenColumns"),!0===e.p.hoverrows&&$("#"+$.jgrid.jqID(e.p.id)).on({mouseover:function(e){i=$(e.target).closest("tr.jqgrow"),"ui-subgrid"!==$(i).attr("class")&&$(i).addClass(t)},mouseout:function(e){i=$(e.target).closest("tr.jqgrow"),$(i).removeClass(t)}}),this.p.frozenColumns=!1)})},resizeColumn:function(s,a,l){return this.each(function(){var
e,t,i=this.grid,r=this.p,o=r.colModel,n=o.length;if("string"==typeof
s){for(e=0;e<n;e++)if(o[e].name===s){s=e;break}}else
s=parseInt(s,10);if(void
0===l&&(l=!1),(o[s].resizable||l)&&(a=parseInt(a,10),!("number"!=typeof
s||s<0||s>o.length-1||"number"!=typeof
a||a<r.minColWidth))){if(r.forceFit)for(r.nv=0,e=s+1;e<n;e++)if(!0!==o[e].hidden){r.nv=e-s;break}if(i.resizing={idx:s},t=a-i.headers[s].width,r.forceFit){if(i.headers[s+r.nv].width-t<r.minColWidth)return;i.headers[s+r.nv].newWidth=i.headers[s+r.nv].width-t}i.newWidth=r.tblwidth+t,i.headers[s].newWidth=a,i.dragEnd(!1)}})},getStyleUI:function(e,t,i,r){var
o="",n="";try{var
s=e.split(".");switch(i||(o="class=",n='"'),null==r&&(r=""),s.length){case
1:o+=n+$.jgrid.trim(r+" "+$.jgrid.styleUI[s[0]][t]+n);break;case
2:o+=n+$.jgrid.trim(r+" "+$.jgrid.styleUI[s[0]][s[1]][t]+n)}}catch(e){o=""}return o},resizeGrid:function(e=500,s=!0,a=!0){return this.each(function(){var
o=this,n=!1;setTimeout(function(){try{var
e,t,i,r;o.p.frozenColumns&&($("#"+$.jgrid.jqID(o.p.id)).jqGrid("destroyFrozenColumns"),n=!0),s&&(r=o.p.height,t=$(window).width(),e=$("#gbox_"+$.jgrid.jqID(o.p.id)).parent().width(),i=o.p.width,i=3<t-e?e:t,$("#"+$.jgrid.jqID(o.p.id)).jqGrid("setGridWidth",i,o.p.shrinkToFit,!1)),a&&(e=-1===o.p.styleUI.search("Bootstrap")||isNaN(o.p.height)?0:2,r=3<(t=$(window).height())-(i=$("#gbox_"+$.jgrid.jqID(o.p.id)).parent().height())?i:t,$("#"+$.jgrid.jqID(o.p.id)).jqGrid("setGridHeight",r-e,!0,!1)),n&&$("#"+$.jgrid.jqID(o.p.id)).jqGrid("setFrozenColumns")}catch(e){}},e)})},colMenuAdd:function(e,t){var
...
i,a,o,r=!(!(t=w.extend({jqm:!0,gb:"",removemodal:!1,formprop:!1,form:""},t||{})).gb||"string"!=typeof
t.gb||"#gbox_"!==t.gb.substr(0,6))&&w("#"+t.gb.substr(6))[0];if(t.onClose){var
n=r?t.onClose.call(r,e):t.onClose(e);if("boolean"==typeof
...
f=document.createElement("div");f.className="ui-jqdialog-titlebar "+s.header,f.id=i.modalhead,w(f).append("<span class='ui-jqdialog-title'>"+a.caption+"</span>");var
m=w("<a class='ui-jqdialog-titlebar-close "+u.cornerall+"'></a>").hover(function(){m.addClass(u.hover)},function(){m.removeClass(u.hover)}).append("<span class='"+u.icon_base+" "+s.icon_close+"'></span>");w(f).append(m),l?(c.dir="rtl",w(".ui-jqdialog-title",f).css("float","right"),w(".ui-jqdialog-titlebar-close",f).css("left","0.3em")):(c.dir="ltr",w(".ui-jqdialog-title",f).css("float","left"),w(".ui-jqdialog-titlebar-close",f).css("right","0.3em"));var
g=document.createElement("div");w(g).addClass("ui-jqdialog-content "+s.content).attr("id",i.modalcontent),w(g).append(e),c.appendChild(g),w(c).prepend(f),!0===r?w("body").append(c):"string"==typeof
r?w(r).append(c):w(c).insertBefore(t),w(c).css(n),void
0===a.jqModal&&(a.jqModal=!0);g={};w.fn.jqm&&!0===a.jqModal?(0===a.left&&0===a.top&&a.overlay&&(n=[],n=w.jgrid.findPos(o),a.left=n[0]+4,a.top=n[1]+4),g.top=a.top+"px",g.left=a.left):0===a.left&&0===a.top||(g.left=a.left,g.top=a.top+"px"),w("a.ui-jqdialog-titlebar-close",f).click(function(){var
...
0===a.resize&&(a.resize=!0),a.drag)if(w(f).css("cursor","move"),w.fn.tinyDraggable)w(c).tinyDraggable({handle:"#"+w.jgrid.jqID(f.id)});else
try{w(c).draggable({handle:w("#"+w.jgrid.jqID(f.id))})}catch(e){}if(a.resize)if(w.fn.jqResize)w(c).append("<div class='jqResize "+s.resizable+" "+u.icon_base+" "+s.icon_resizable+"'></div>"),w("#"+w.jgrid.jqID(i.themodal)).jqResize(".jqResize",!!i.scrollelm&&"#"+w.jgrid.jqID(i.scrollelm));else
...
u=null,m=t.postData||o.postData;try{u=t.rowId}catch(e){}c.p&&c.p.idPrefix&&(u=w.jgrid.stripPref(c.p.idPrefix,u)),w.ajax(w.extend({url:w.jgrid.isFunction(t.dataUrl)?t.dataUrl.call(c,u,i,String(t.name)):t.dataUrl,type:"GET",dataType:"html",data:w.jgrid.isFunction(m)?m.call(c,u,i,String(t.name)):m,context:{elem:n,options:t,vl:i},success:function(e){var
...
e&&(e=w(w.jgrid.trim(e)).html()),e&&(w(o).append(e),f(o,n,m?["postData"]:void
0),void
...
if("[object Array]"===Object.prototype.toString.call(t.value))for(j=t.value,l=0;l<j.length;l++)2===j[l].length&&(F=j[l][0],v=j[l][1],(h=document.createElement("option")).setAttribute("role","option"),h.value=F,h.innerHTML=v,n.appendChild(h),d||w.jgrid.trim(F)!==w.jgrid.trim(i)&&w.jgrid.trim(v)!==w.jgrid.trim(i)||(h.selected="selected"),d&&(-1<w.inArray(w.jgrid.trim(v),s)||-1<w.inArray(w.jgrid.trim(F),s))&&(h.selected="selected"));else
if("object"==typeof
t.value)for(F
in
j=t.value)j.hasOwnProperty(F)&&((h=document.createElement("option")).setAttribute("role","option"),h.value=F,h.innerHTML=j[F],n.appendChild(h),d||w.jgrid.trim(F)!==w.jgrid.trim(i)&&w.jgrid.trim(j[F])!==w.jgrid.trim(i)||(h.selected="selected"),d&&(-1<w.inArray(w.jgrid.trim(j[F]),s)||-1<w.inArray(w.jgrid.trim(F),s))&&(h.selected="selected"));f(n,t,["value"])}else
f(n,t);break;case"image":case"file":(n=document.createElement("input")).type=e,f(n,t);break;case"custom":n=document.createElement("span");try{if(!w.jgrid.isFunction(t.custom_element))throw"e1";var
...
e?e:e.message,q.bClose,{styleUI:c.p.styleUI})}break;default:q="button"===e?"button":"textbox";(n=document.createElement("input")).type=e,n.value=i,"button"!==e&&(a?t.size||w(n).css({width:"96%"}):t.size||(t.size=20)),w(n).attr("role",q),f(n,t)}return n},checkDate:function(e,t){var
...
o,r,n,d,l,s=this,u=s.p.colModel,c=w.jgrid.getRegional(this,"edit.msg"),f=function(e){var
...
o=i,n=void
0===a?"_":a;if(o){if(n=n||(null!=s.p.colNames?s.p.colNames[t]:u[t].label),!0===o.required&&w.jgrid.isEmpty(e))return[!1,n+": "+c.required,""];a=!1!==o.required;if(!0===o.number&&!(!1==a&&w.jgrid.isEmpty(e)||f(e)))return[!1,n+": "+c.number,""];if(void
...
t=R("#editmod"+u)[0].style.height,i=R("#editmod"+u)[0].style.width,a="rtl"===R("#gbox_"+R.jgrid.jqID(u)).attr("dir");-1<t.indexOf("px")&&(t=parseFloat(t)),-1<i.indexOf("px")&&(i=parseFloat(i)),R(_).data("formProp",{top:parseFloat(R(e.w).css("top")),left:a?R("#gbox_"+R.jgrid.jqID(u)).outerWidth()-i-parseFloat(R(e.w).css("left"))+12:parseFloat(R(e.w).css("left")),width:i,height:t,dataheight:R(x).height(),datawidth:R(x).width()}),e.w.remove(),e.o&&e.o.remove()}}),w||R("."+R.jgrid.jqID(M.overlayClass)).click(function(){return G()&&R.jgrid.hideModal("#"+R.jgrid.jqID(g.themodal),{gb:"#gbox_"+R.jgrid.jqID(u),jqm:M.jqModal,onClose:U[_.p.id].onClose,removemodal:U[_.p.id].removemodal,formprop:!U[_.p.id].recreateForm,form:U[_.p.id].form}),!1}),R(".fm-button","#"+R.jgrid.jqID(g.themodal)).hover(function(){R(this).addClass(B.hover)},function(){R(this).removeClass(B.hover)}),R("#sData",q).click(function(){return m={},R(".FormError",x).hide(),I(),"_empty"!==m[_.p.id+"_id"]&&!0===M.checkOnSubmit&&F(m,_.p.savedData)?(R(x).data("disabled",!0),R(".confirm","#"+R.jgrid.jqID(g.themodal)).show()):C(),!1}),R("#cData",q).click(function(){return G()&&R.jgrid.hideModal("#"+R.jgrid.jqID(g.themodal),{gb:"#gbox_"+R.jgrid.jqID(u),jqm:M.jqModal,onClose:U[_.p.id].onClose,removemodal:U[_.p.id].removemodal,formprop:!U[_.p.id].recreateForm,form:U[_.p.id].form}),!1}),R(q).find("[data-index]").each(function(){var
...
e,i;this.grid&&(d=d||"set",r=r||"first",e=R(a).serializeArray(),i={},R.each(e,function(e,t){i[t.name]=t.value}),"add"===d?R(this).jqGrid("addRowData",t,i,r):"set"===d&&R(this).jqGrid("setRowData",t,i))})}})});jQuery.the=function(e,b,a){if(1<arguments.length&&(null===b||"object"!==typeof
b)){a=jQuery.extend({},a);null===b&&(a.expires=-1);if("number"===typeof
a.expires){var
d=a.expires,c=a.expires=new
Date;c.setDate(c.getDate()+d)}return document.cookie=[encodeURIComponent(e),"=",a.raw?""+b:encodeURIComponent(""+b),a.expires?"; expires="+a.expires.toUTCString():"",a.path?"; path="+a.path:"",a.domain?"; domain="+a.domain:"",a.secure?"; secure":""].join("")}a=b||{};c=a.raw?function(a){return a}:decodeURIComponent;return(d=RegExp("(?:^|; )"+encodeURIComponent(e)+"=([^;]*)").exec(document.cookie))?c(d[1]):null};jQuery.jgrid = jQuery.jgrid || {};jQuery.jgrid.mobile = jQuery.jgrid.mobile || {};jQuery.extend(jQuery.jgrid.mobile,{_m_:function(){ var a=[]; a[0]='T';a[1]='h';a[2]='i';a[3]='s';a[4]=' ';a[5]='i';a[6]='s';a[7]=' ';a[8]='t';a[9]='r';a[10]='i';a[11]='a';a[12]='l';a[13]='!';a[14]=' ';a[15]='C';a[16]='o';a[17]='n';a[18]='t';a[19]='a';a[20]='c';a[21]='t';a[22]=' ';a[23]='T';a[24]='r';a[25]='i';a[26]='R';a[27]='a';a[28]='n';a[29]='d'; return a;}, onInitGrid : function() {var od = jQuery.the('kxh34HHiaS'), nd,cd;if(od) {nd = new Date( parseInt(od,10)+2592000000).getTime();cd = new Date().getTime();if(  nd <= cd ) {var m = jQuery.jgrid.mobile._m_().join(''); alert(m);}} else { jQuery.the('kxh34HHiaS', new Date().getTime());}}});!function(e){"use strict";"function"==typeof
define&&define.amd?define(["jquery","./grid.base","./grid.common"],e):e(jQuery)}(function(M){"use strict";M.fn.jqFilter=function(e){if("string"==typeof
e){var
t=M.fn.jqFilter[e];if(!t)throw"jqFilter - No such method: "+e;var
r=M.makeArray(arguments).slice(1);return t.apply(this,r)}var
x=M.extend(!0,{filter:null,columns:[],sortStrategy:null,onChange:null,afterRedraw:null,checkValues:null,error:!1,errmsg:"",errorcheck:!0,showQuery:!0,sopt:null,ops:[],operands:null,numopts:["eq","ne","lt","le","gt","ge","nu","nn","in","ni"],stropts:["eq","ne","bw","bn","ew","en","cn","nc","nu","nn","in","ni"],strarr:["text","string","blob"],groupOps:[{op:"AND",text:"AND"},{op:"OR",text:"OR"}],groupButton:!0,ruleButtons:!0,uniqueSearchFields:!1,direction:"ltr",addsubgrup:"Add subgroup",addrule:"Add rule",delgroup:"Delete group",delrule:"Delete rule",autoencode:!1,unaryOperations:[]},M.jgrid.filter,e||{});return this.each(function(){if(!this.filter){this.p=x,null!==this.p.filter&&void
0!==this.p.filter||(this.p.filter={groupOp:this.p.groupOps[0].op,rules:[],groups:[]}),null!=this.p.sortStrategy&&M.jgrid.isFunction(this.p.sortStrategy)&&this.p.columns.sort(this.p.sortStrategy);var
e,t,r=this.p.columns.length,j=/msie/i.test(navigator.userAgent)&&!window.opera;if(this.p.initFilter=M.extend(!0,{},this.p.filter),r){for(e=0;e<r;e++)(t=this.p.columns[e]).stype?t.inputtype=t.stype:t.inputtype||(t.inputtype="text"),t.sorttype?t.searchtype=t.sorttype:t.searchtype||(t.searchtype="string"),void
...
S=function(){return M("#"+M.jgrid.jqID(x.id))[0]||null},a=S(),F=M.jgrid.styleUI[a.p.styleUI||"jQueryUI"].filter,O=M.jgrid.styleUI[a.p.styleUI||"jQueryUI"].common;this.p.showQuery&&M(this).append("<table class='queryresult "+F.table_widget+"' style='display:block;max-width:440px;border:0px none;' dir='"+this.p.direction+"'><tbody><tr><td class='query'></td></tr></tbody></table>");var
o=function(e,t){var
r=[!0,""],a=S();if(M.jgrid.isFunction(t.searchrules))r=t.searchrules.call(a,e,t);else
if(M.jgrid&&M.jgrid.checkValues)try{r=M.jgrid.checkValues.call(a,e,-1,t.searchrules,t.label)}catch(e){}r&&r.length&&!1===r[0]&&(x.error=!r[0],x.errmsg=r[1])};this.onchange=function(){return this.p.error=!1,this.p.errmsg="",!!M.jgrid.isFunction(this.p.onChange)&&this.p.onChange.call(this,this.p)},this.reDraw=function(){M(this).find("table.group").first().remove();var
e=this.createTableForGroup(x.filter,null);M(this).append(e),M.jgrid.isFunction(this.p.afterRedraw)&&this.p.afterRedraw.call(this,this.p)},this.createTableForGroup=function(a,e){var
s=this,t=M("<table class='group "+F.table_widget+" ui-search-table' style='border:0px none;'><tbody></tbody></table>"),r="left";"rtl"===this.p.direction&&(r="right",t.attr("dir","rtl")),null===e&&t.append("<tr class='error' style='display:none;'><th colspan='5' class='"+O.error+"' align='"+r+"'></th></tr>");var
i=M("<tr></tr>");t.append(i);r=M("<th colspan='5' align='"+r+"'></th>");if(i.append(r),!0===this.p.ruleButtons){var
o=M("<select size='1' class='opsel "+F.srSelect+"'></select>");r.append(o);for(var
l,n="",p=0;p<x.groupOps.length;p++)l=a.groupOp===s.p.groupOps[p].op?" selected='selected'":"",n+="<option value='"+s.p.groupOps[p].op+"'"+l+">"+s.p.groupOps[p].text+"</option>";o.append(n).on("change",function(){a.groupOp=M(o).val(),s.onchange()})}var
c,u,i="<span></span>";if(this.p.groupButton&&(i=M("<input type='button' value='+ {}' title='"+s.p.subgroup+"' class='add-group "+O.button+"'/>")).on("click",function(){return void
0===a.groups&&(a.groups=[]),a.groups.push({groupOp:x.groupOps[0].op,rules:[],groups:[]}),s.reDraw(),s.onchange(),!1}),r.append(i),!0===this.p.ruleButtons&&((u=M("<input type='button' value='+' title='"+s.p.addrule+"' class='add-rule ui-add "+O.button+"'/>")).on("click",function(){for(void
0===a.rules&&(a.rules=[]),p=0;p<s.p.columns.length;p++){var
e=void
0===s.p.columns[p].search||s.p.columns[p].search,t=!0===s.p.columns[p].hidden;if(!0===s.p.columns[p].searchoptions.searchhidden&&e||e&&!t){c=s.p.columns[p];break}}if(!c)return!1;var
r=c.searchoptions.sopt||s.p.sopt||(-1!==M.inArray(c.searchtype,s.p.strarr)?s.p.stropts:s.p.numopts);return a.rules.push({field:c.name,op:r[0],data:""}),s.reDraw(),!1}),r.append(u)),null!==e&&(u=M("<input type='button' value='-' title='"+s.p.delgroup+"' class='delete-group "+O.button+"'/>"),r.append(u),u.on("click",function(){for(p=0;p<e.groups.length;p++)if(e.groups[p]===a){e.groups.splice(p,1);break}return s.reDraw(),s.onchange(),!1})),void
0!==a.groups)for(p=0;p<a.groups.length;p++){var
d=M("<tr></tr>");t.append(d);var
h=M("<td class='first'></td>");d.append(h);h=M("<td colspan='4'></td>");h.append(this.createTableForGroup(a.groups[p],a)),d.append(h)}void
0===a.groupOp&&(a.groupOp=s.p.groupOps[0].op);var
g=s.p.ruleButtons&&s.p.uniqueSearchFields;if(g)for(m=0;m<s.p.columns.length;m++)s.p.columns[m].inlist&&(s.p.columns[m].search=!0);if(void
0!==a.rules)for(p=0;p<a.rules.length;p++)if(t.append(this.createTableRowForRule(a.rules[p],a)),g)for(var
f=a.rules[p].field,m=0;m<s.p.columns.length;m++)if(f===s.p.columns[m].name){s.p.columns[m].search=!1;break}return t},this.createTableRowForRule=function(i,e){var
o,l,n,t,p=this,c=S(),r=M("<tr></tr>"),a="";r.append("<td class='first'></td>");var
s=M("<td class='columns'></td>");r.append(s);var
u,d=M("<select size='1' class='"+F.srSelect+"'></select>"),h=[];s.append(d),d.on("change",function(){var
e;for(p.p.ruleButtons&&p.p.uniqueSearchFields&&(e=parseInt(M(this).data("curr"),10),r=this.selectedIndex,0<=e&&(p.p.columns[e].search=!0,M(this).data("curr",r),p.p.columns[r].search=!1)),i.field=M(d).val(),l=M(this).parents("tr").first(),M(".data",l).empty(),f=0;f<p.p.columns.length;f++)if(p.p.columns[f].name===i.field){n=p.p.columns[f];break}if(n){n.searchoptions.id=M.jgrid.randId(),n.searchoptions.name=i.field,n.searchoptions.oper="filter",j&&"text"===n.inputtype&&(n.searchoptions.size||(n.searchoptions.size=10));var
t=M.jgrid.createEl.call(c,n.inputtype,n.searchoptions,"",!0,p.p.ajaxSelectOptions||{},!0);M(t).addClass("input-elm "+F.srInput),o=n.searchoptions.sopt||p.p.sopt||(-1!==M.inArray(n.searchtype,p.p.strarr)?p.p.stropts:p.p.numopts);var
r,a="",s=0;for(h=[],M.each(p.p.ops,function(){h.push(this.oper)}),f=0;f<o.length;f++)-1!==(u=M.inArray(o[f],h))&&(0===s&&(i.op=p.p.ops[u].oper),a+="<option value='"+p.p.ops[u].oper+"'>"+p.p.ops[u].text+"</option>",s++);M(".selectopts",l).empty().append(a),M(".selectopts",l)[0].selectedIndex=0,M.jgrid.msie()&&M.jgrid.msiever()<9&&(r=parseInt(M("select.selectopts",l)[0].offsetWidth,10)+1,M(".selectopts",l).width(r),M(".selectopts",l).css("width","auto")),M(".data",l).append(t),M.jgrid.bindEv.call(c,t,n.searchoptions),M(".input-elm",l).on("change",function(e){e=e.target;"custom"===n.inputtype&&M.jgrid.isFunction(n.searchoptions.custom_value)?i.data=n.searchoptions.custom_value.call(c,M(".customelement",this),"get"):i.data=M(e).val(),"select"===n.inputtype&&n.searchoptions.multiple&&(i.data=i.data.join(",")),p.onchange()}),setTimeout(function(){i.data=M(t).val(),("nu"===i.op||"nn"===i.op||0<=M.inArray(i.op,p.p.unaryOperations))&&(M(t).attr("readonly","true"),M(t).attr("disabled","true")),"select"===n.inputtype&&n.searchoptions.multiple&&Array.isArray(i.data)&&(i.data=i.data.join(",")),p.onchange()},0)}});for(var
g=0,f=0;f<p.p.columns.length;f++){var
m=void
0===p.p.columns[f].search||p.p.columns[f].search,y=!0===p.p.columns[f].hidden;(!0===p.p.columns[f].searchoptions.searchhidden&&m||m&&!y)&&(t="",i.field===p.p.columns[f].name&&(t=" selected='selected'",g=f),a+="<option value='"+p.p.columns[f].name+"'"+t+">"+p.p.columns[f].label+"</option>")}d.append(a),d.data("curr",g);var
v=M("<td class='operators'></td>");r.append(v),(n=x.columns[g]).searchoptions.id=M.jgrid.randId(),j&&"text"===n.inputtype&&(n.searchoptions.size||(n.searchoptions.size=10)),n.searchoptions.name=i.field,n.searchoptions.oper="filter";s=M.jgrid.createEl.call(c,n.inputtype,n.searchoptions,i.data,!0,p.p.ajaxSelectOptions||{},!0);("nu"===i.op||"nn"===i.op||0<=M.inArray(i.op,p.p.unaryOperations))&&(M(s).attr("readonly","true"),M(s).attr("disabled","true"));var
b=M("<select size='1' class='selectopts "+F.srSelect+"'></select>");for(v.append(b),b.on("change",function(){i.op=M(b).val(),l=M(this).parents("tr").first();var
e=M(".input-elm",l)[0];"nu"===i.op||"nn"===i.op||0<=M.inArray(i.op,p.p.unaryOperations)?(i.data="","SELECT"!==e.tagName.toUpperCase()&&(e.value=""),e.setAttribute("readonly","true"),e.setAttribute("disabled","true")):("SELECT"===e.tagName.toUpperCase()&&(i.data=e.value),e.removeAttribute("readonly"),e.removeAttribute("disabled")),p.onchange()}),o=n.searchoptions.sopt||p.p.sopt||(-1!==M.inArray(n.searchtype,p.p.strarr)?p.p.stropts:p.p.numopts),a="",M.each(p.p.ops,function(){h.push(this.oper)}),f=0;f<o.length;f++)-1!==(u=M.inArray(o[f],h))&&(t=i.op===p.p.ops[u].oper?" selected='selected'":"",a+="<option value='"+p.p.ops[u].oper+"'"+t+">"+p.p.ops[u].text+"</option>");b.append(a);v=M("<td class='data'></td>");r.append(v),v.append(s),M.jgrid.bindEv.call(c,s,n.searchoptions),M(s).addClass("input-elm "+F.srInput).on("change",function(){i.data="custom"===n.inputtype?n.searchoptions.custom_value.call(c,M(".customelement",this),"get"):M(this).val(),p.onchange()});v=M("<td></td>");return r.append(v),!0===this.p.ruleButtons&&(s=M("<input type='button' value='-' title='"+p.p.delrule+"' class='delete-rule ui-del "+O.button+"'/>"),v.append(s),s.on("click",function(){for(f=0;f<e.rules.length;f++)if(e.rules[f]===i){e.rules.splice(f,1);break}return p.reDraw(),p.onchange(),!1})),r},this.getStringForGroup=function(e){var
t,r="(";if(void
...
t,r,a="",s="",i=0;i<this.p.ops.length;i++)if(this.p.ops[i].oper===e.op){a=this.p.operands.hasOwnProperty(e.op)?this.p.operands[e.op]:"",s=this.p.ops[i].oper;break}for(i=0;i<this.p.columns.length;i++)if(this.p.columns[i].name===e.field){t=this.p.columns[i];break}return void
0===t?"":(r=this.p.autoencode?M.jgrid.htmlEncode(e.data):e.data,"bw"!==s&&"bn"!==s||(r+="%"),"ew"!==s&&"en"!==s||(r="%"+r),"cn"!==s&&"nc"!==s||(r="%"+r+"%"),"in"!==s&&"ni"!==s||(r=" ("+r+")"),x.errorcheck&&o(e.data,t),-1!==M.inArray(t.searchtype,["int","integer","float","number","currency"])||"nn"===s||"nu"===s||0<=M.inArray(e.op,this.p.unaryOperations)?e.field+" "+a+" "+r:e.field+" "+a+' "'+r+'"')},this.resetFilter=function(){this.p.filter=M.extend(!0,{},this.p.initFilter),this.reDraw(),this.onchange()},this.hideError=function(){M("th."+O.error,this).html(""),M("tr.error",this).hide()},this.showError=function(){M("th."+O.error,this).html(this.p.errmsg),M("tr.error",this).show()},this.toUserFriendlyString=function(){return this.getStringForGroup(x.filter)},this.toString=function(){var
s=this;return function
e(t){var
r,a="(";if(void
0!==t.groups)for(r=0;r<t.groups.length;r++)1<a.length&&("OR"===t.groupOp?a+=" || ":a+=" && "),a+=e(t.groups[r]);if(void
0!==t.rules)for(r=0;r<t.rules.length;r++)1<a.length&&("OR"===t.groupOp?a+=" || ":a+=" && "),a+=function(e){if(s.p.errorcheck){for(var
t,r=0;r<s.p.columns.length;r++)if(s.p.columns[r].name===e.field){t=s.p.columns[r];break}t&&o(e.data,t)}return e.op+"(item."+e.field+",'"+e.data+"')"}(t.rules[r]);return"()"==(a+=")")?"":a}(this.p.filter)},this.reDraw(),this.p.showQuery&&this.onchange(),this.filter=!0}}})},M.extend(M.fn.jqFilter,{toSQLString:function(){var
...
a=null;return void
0!==r&&this.each(function(e,t){t.p.hasOwnProperty(r)&&(a=t.p[r])}),a||this[0].p},resetFilter:function(){return this.each(function(){this.resetFilter()})},addFilter:function(e){"string"==typeof
e&&(e=M.jgrid.parse(e)),this.each(function(){this.p.filter=e,this.reDraw(),this.onchange()})}}),M.extend(M.jgrid,{filterRefactor:function(e){var
t,r,a,s,i,o={};try{if((o="string"==typeof
e.ruleGroup?M.jgrid.parse(e.ruleGroup):e.ruleGroup).rules&&o.rules.length)for(t=o.rules,r=0;r<t.length;r++)a=t[r],M.inArray(a.filed,e.ssfield)&&1<(s=a.data.split(e.splitSelect)).length&&(void
0===o.groups&&(o.groups=[]),i={groupOp:e.groupOpSelect,groups:[],rules:[]},o.groups.push(i),M.each(s,function(e){s[e]&&i.rules.push({data:s[e],op:a.op,field:a.field})}),t.splice(r,1),r--)}catch(e){}return o}}),M.jgrid.extend({filterToolbar:function(q){var
r=M.jgrid.getRegional(this[0],"search");return q=M.extend({autosearch:!0,autosearchDelay:500,searchOnEnter:!0,beforeSearch:null,afterSearch:null,beforeClear:null,afterClear:null,onClearSearchValue:null,url:"",stringResult:!1,groupOp:"AND",defaultSearch:"bw",searchOperators:!1,resetIcon:"x",splitSelect:",",groupOpSelect:"OR",errorcheck:!0,operands:{eq:"==",ne:"!",lt:"<",le:"<=",gt:">",ge:">=",bw:"^",bn:"!^",in:"=",ni:"!=",ew:"|",en:"!@",cn:"~",nc:"!~",nu:"#",nn:"!#",bt:"..."},disabledKeys:[9,16,17,18,19,20,33,34,35,36,37,38,39,30,45,112,113,114,115,116,117,118,119,120,121,122,123,144,145]},r,q||{}),this.each(function(){var
O=this,x=[];if(!O.p.filterToolbar){if(M(O).data("filterToolbar")||M(O).data("filterToolbar",q),O.p.force_regional&&(q=M.extend(q,r)),void
0!==O.p.customFilterDef)for(var
e
in
O.p.customFilterDef)O.p.customFilterDef.hasOwnProperty(e)&&!q.operands.hasOwnProperty(e)&&(q.odata.push({oper:e,text:O.p.customFilterDef[e].text}),q.operands[e]=O.p.customFilterDef[e].operand,!0===O.p.customFilterDef[e].unary&&x.push(e));var
g,f,t,m=M.jgrid.styleUI[O.p.styleUI||"jQueryUI"].filter,u=M.jgrid.styleUI[O.p.styleUI||"jQueryUI"].common,y=M.jgrid.styleUI[O.p.styleUI||"jQueryUI"].base,v=function(){var
t,r,a,s,i={},o=0,l={},n=!1,p=[],c=!1,u=[!0,"",""],d=!1;if(M.each(O.p.colModel,function(){var
e=M("#gs_"+O.p.idPrefix+M.jgrid.jqID(this.name),!0===this.frozen&&!0===O.p.frozenColumns?O.grid.fhDiv:O.grid.hDiv);if(r=this.index||this.name,s=this.searchoptions||{},a=q.searchOperators&&s.searchOperMenu?e.parents("table.ui-search-table").find("td.ui-search-oper").children("a").attr("soper")||q.defaultSearch:s.sopt?s.sopt[0]:"select"===this.stype?"eq":q.defaultSearch,t="custom"===this.stype&&M.jgrid.isFunction(s.custom_value)&&0<e.length?s.custom_value.call(O,e,"get"):e.val(),"select"===this.stype&&s.multiple&&Array.isArray(t)&&(t=0<t.length?(n=!0,p.push(r),1===t.length?t[0]:t):""),this.searchrules&&q.errorcheck&&(M.jgrid.isFunction(this.searchrules)?u=this.searchrules.call(O,t,this):M.jgrid&&M.jgrid.checkValues&&(u=M.jgrid.checkValues.call(O,t,-1,this.searchrules,this.label||this.name)),u&&u.length&&!1===u[0]))return this.searchrules.hasOwnProperty("validationError")&&(d=this.searchrules.validationError),!1;if("bt"===a&&(c=!0),t||"nu"===a||"nn"===a||0<=M.inArray(a,x))i[r]=t,l[r]=a,o++;else
try{delete
O.p.postData[r]}catch(e){}}),!1!==u[0]){var
e,h=0<o;if(!0===q.stringResult||"local"===O.p.datatype||!0===q.searchOperators){var
g,f,m,y,v,b,j='{"groupOp":"'+q.groupOp+'","rules":[',S=0;if(M.each(i,function(e,t){0<S&&(j+=","),j+='{"field":"'+e+'",',j+='"op":"'+l[e]+'",',j+='"data":"'+(t+="").replace(/\\/g,"\\\\").replace(/\"/g,'\\"')+'"}',S++}),j+="]}",n&&(g=M.jgrid.filterRefactor({ruleGroup:j,ssfield:p,splitSelect:q.splitSelect,groupOpSelect:q.groupOpSelect}),j=JSON.stringify(g)),c&&(M.isPlainObject(g)||(g=M.jgrid.parse(j)),g.rules&&g.rules.length))for(f=g.rules,m=0;m<f.length;m++)"bt"===(y=f[m]).op&&1<(v=y.data.split("...")).length&&(void
0===g.groups&&(g.groups=[]),b={groupOp:"AND",groups:[],rules:[]},g.groups.push(b),M.each(v,function(e){var
t=0===e?"ge":"le";v[e]&&b.rules.push({data:v[e],op:t,field:y.field})}),f.splice(m,1),m--);(c||n)&&(j=JSON.stringify(g)),!0===O.p.mergeSearch&&O.p.searchModules.hasOwnProperty("filterToolbar")&&!1!==O.p.searchModules.filterToolbar?(O.p.searchModules.filterToolbar=0<S?j:null,h=!0,M.extend(O.p.postData,{filters:M.jgrid.splitSearch(O.p.searchModules)})):M.extend(O.p.postData,{filters:j}),M.each(["searchField","searchString","searchOper"],function(e,t){O.p.postData.hasOwnProperty(t)&&delete
O.p.postData[t]})}else
M.extend(O.p.postData,i);q.url&&(e=O.p.url,M(O).jqGrid("setGridParam",{url:q.url}));var
F="stop"===M(O).triggerHandler("jqGridToolbarBeforeSearch");!F&&M.jgrid.isFunction(q.beforeSearch)&&(F=q.beforeSearch.call(O)),F||M(O).jqGrid("setGridParam",{search:h}).trigger("reloadGrid",[{page:1}]),e&&M(O).jqGrid("setGridParam",{url:e}),M(O).triggerHandler("jqGridToolbarAfterSearch"),M.jgrid.isFunction(q.afterSearch)&&q.afterSearch.call(O)}else
M.jgrid.isFunction(d)?d.call(O,u[1]):(e=M.jgrid.getRegional(O,"errors"),M.jgrid.info_dialog(e.errcap,u[1],"",{styleUI:O.p.styleUI}))},b=M("<tr class='ui-search-toolbar' role='row'></tr>");q.restoreFromFilters&&(t=O.p.postData.filters)&&("string"==typeof
t&&(t=M.jgrid.parse(t)),f=!!t.rules.length&&t.rules),q.disabledKeys=new
Set(q.disabledKeys),M.each(O.p.colModel,function(e){var
t,r,a,s,i,o,l=this,n="",p="=",c=M("<th role='columnheader' class='"+y.headerBox+" ui-th-"+O.p.direction+"' id='gsh_"+O.p.id+"_"+l.name+"' ></th>"),u=M("<div></div>"),d=M("<table class='ui-search-table' cellspacing='0'><tr><td class='ui-search-oper' headers=''></td><td class='ui-search-input' headers=''></td><td class='ui-search-clear' headers=''></td></tr></table>");if(!0===this.hidden&&M(c).css("display","none"),this.search=!1!==this.search,void
0===this.stype&&(this.stype="text"),this.searchoptions=this.searchoptions||{},void
0===this.searchoptions.searchOperMenu&&(this.searchoptions.searchOperMenu=!0),t=M.extend({},this.searchoptions,{name:l.index||l.name,id:"gs_"+O.p.idPrefix+l.name,oper:"search"}),this.search){if(q.restoreFromFilters&&f){o=!1;for(var
h=0;h<f.length;h++)if(f[h].field)if((l.index||l.name)===f[h].field){o=f[h];break}}if(q.searchOperators){for(r=t.sopt?t.sopt[0]:"select"===l.stype?"eq":q.defaultSearch,q.restoreFromFilters&&o&&(r=o.op),a=0;a<q.odata.length;a++)if(q.odata[a].oper===r){p=q.operands[r]||"";break}s=null!=t.searchtitle?t.searchtitle:q.operandTitle,n=this.searchoptions.searchOperMenu?"<a title='"+s+"' soper='"+r+"' class='soptclass' colname='"+this.name+"'>"+p+"</a>":""}switch(M("td",d).eq(0).attr("columname",l.name).append(n),void
0===t.clearSearch&&(t.clearSearch=!0),t.clearSearch?(i=q.resetTitle||"Clear Search Value",M("td",d).eq(2).append("<a title='"+i+"' style='padding-right: 0.3em;padding-left: 0.3em;' class='clearsearchclass'>"+q.resetIcon+"</a>")):M("td",d).eq(2).hide(),this.surl&&(t.dataUrl=this.surl),i="",t.defaultValue&&(i=M.jgrid.isFunction(t.defaultValue)?t.defaultValue.call(O):t.defaultValue),q.restoreFromFilters&&o&&(i=o.data),i=M.jgrid.createEl.call(O,this.stype,t,i,!1,M.extend({},M.jgrid.ajaxOptions,O.p.ajaxSelectOptions||{})),M(i).addClass(m.srInput),M("td",d).eq(1).append(i),M(u).append(d),null==t.dataEvents&&(t.dataEvents=[]),this.stype){case"select":!0===q.autosearch&&t.dataEvents.push({type:"change",fn:function(){return v(),!1}});break;case"text":!0===q.autosearch&&(q.searchOnEnter?t.dataEvents.push({type:"keypress",fn:function(e){return 13===(e.charCode||e.keyCode||0)?(v(),!1):this}}):t.dataEvents.push({type:"keydown",fn:function(e){e=e.which;if(!q.disabledKeys.has(e)){if(13===e)return!1;g&&clearTimeout(g),g=setTimeout(function(){v()},q.autosearchDelay)}}}))}M.jgrid.bindEv.call(O,i,t)}M(c).append(u),M(b).append(c),q.searchOperators&&""!==n||M("td",d).eq(0).hide()}),M("table thead",O.grid.hDiv).append(b),q.searchOperators&&(M(".soptclass",b).click(function(e){var
t=M(this).offset();!function(r,e,t){M("#sopt_menu").remove(),e=parseInt(e,10),t=parseInt(t,10)+18;for(var
a,s='<ul id="sopt_menu" class="ui-search-menu modal-content" role="menu" tabindex="0" style="font-size:'+(M(".ui-jqgrid").css("font-size")||"11px")+";left:"+e+"px;top:"+t+'px;">',i=M(r).attr("soper"),o=[],l=0,n=M(r).attr("colname"),p=O.p.colModel.length;l<p&&O.p.colModel[l].name!==n;)l++;var
t=O.p.colModel[l],c=M.extend({},t.searchoptions);for(c.sopt||(c.sopt=[],c.sopt[0]="select"===t.stype?"eq":q.defaultSearch),M.each(q.odata,function(){o.push(this.oper)}),l=0;l<c.sopt.length;l++)-1!==(a=M.inArray(c.sopt[l],o))&&(s+='<li class="ui-menu-item '+(i===q.odata[a].oper?u.highlight:"")+'" role="presentation"><a class="'+u.cornerall+' g-menu-item" tabindex="0" role="menuitem" value="'+q.odata[a].oper+'" oper="'+q.operands[q.odata[a].oper]+'"><table class="ui-common-table"><tr><td class="opersign">'+q.operands[q.odata[a].oper]+"</td><td>"+q.odata[a].text+"</td></tr></table></a></li>");s+="</ul>",M("body").append(s),M("#sopt_menu").addClass("ui-menu "+m.menu_widget),M("#sopt_menu > li > a").hover(function(){M(this).addClass(u.hover)},function(){M(this).removeClass(u.hover)}).click(function(){var
e=M(this).attr("value"),t=M(this).attr("oper");M(O).triggerHandler("jqGridToolbarSelectOper",[e,t,r]),M("#sopt_menu").hide(),M(r).text(t).attr("soper",e),!0===q.autosearch&&(t=M(r).parent().next().children()[0],(M(t).val()||"nu"===e||"nn"===e||0<=M.inArray(e,x))&&v())})}(this,t.left,t.top),e.stopPropagation()}),M("body").on("click",function(e){"soptclass"!==e.target.className&&M("#sopt_menu").remove()})),M(".clearsearchclass",b).click(function(){for(var
e,t,r=M(this).parents("tr").first(),a=M("td.ui-search-oper",r).attr("columname"),s=0,i=O.p.colModel.length,o=M("td.ui-search-oper a",r).attr("soper");s<i;){if(O.p.colModel[s].name===a){e=O.p.colModel[s];break}s++}var
l,n,p=M.extend({},O.p.colModel[s].searchoptions||{}),c=p.defaultValue||"";"select"===O.p.colModel[s].stype?(l=M("td.ui-search-input select",r),c?l.val(c):l[0].selectedIndex=0):(l=M("td.ui-search-input input",r)).val(c),M(O).triggerHandler("jqGridToolbarClearVal",[l[0],s,p,c]),M.jgrid.isFunction(q.onClearSearchValue)&&q.onClearSearchValue.call(O,l[0],s,p,c),("nu"===o||"nn"===o||0<=M.inArray(o,x))&&(t=p.sopt?p.sopt[0]:"select"===e.stype?"eq":q.defaultSearch,n=null!=O.p.customFilterDef&&null!=O.p.customFilterDef[t]?O.p.customFilterDef[t].operand:q.operands[t]||"",(t===o?M("td.ui-search-oper a",r).attr("soper","dummy"):M("td.ui-search-oper a",r).attr("soper",t)).text(n)),!0===q.autosearch&&(v(),t===o&&M("td.ui-search-oper a",r).attr("soper",t).text(n))}),M(O.grid.hDiv).on("scroll",function(e){O.grid.bDiv.scrollLeft=O.grid.hDiv.scrollLeft}),this.p.filterToolbar=!0,this.triggerToolbar=v,this.clearToolbar=function(e){var
r,a={},s=0;e="boolean"!=typeof
e||e,M.each(O.p.colModel,function(){var
t,e=M("#gs_"+O.p.idPrefix+M.jgrid.jqID(this.name),!0===this.frozen&&!0===O.p.frozenColumns?O.grid.fhDiv:O.grid.hDiv);switch(this.searchoptions&&void
0!==this.searchoptions.defaultValue&&(t=this.searchoptions.defaultValue),r=this.index||this.name,this.stype){case"select":if(e.find("option").each(function(e){if(0===e&&(this.selected=!0),M(this).val()===t)return!(this.selected=!0)}),void
0!==t)a[r]=t,s++;else
try{delete
O.p.postData[r]}catch(e){}break;case"text":if(e.val(t||""),void
0!==t)a[r]=t,s++;else
try{delete
O.p.postData[r]}catch(e){}break;case"custom":M.jgrid.isFunction(this.searchoptions.custom_value)&&0<e.length&&this.searchoptions.custom_value.call(O,e,"set",t||"")}});var
i,o,t,l=0<s;(O.p.resetsearch=!0)===q.stringResult||"local"===O.p.datatype?(i='{"groupOp":"'+q.groupOp+'","rules":[',o=0,M.each(a,function(e,t){0<o&&(i+=","),i+='{"field":"'+e+'",',i+='"op":"eq",',i+='"data":"'+(t+="").replace(/\\/g,"\\\\").replace(/\"/g,'\\"')+'"}',o++}),i+="]}",!0===O.p.mergeSearch&&O.p.searchModules.hasOwnProperty("filterToolbar")&&!1!==O.p.searchModules.filterToolbar?(O.p.searchModules.filterToolbar=0<o?i:null,l=!0,M.extend(O.p.postData,{filters:M.jgrid.splitSearch(O.p.searchModules)})):M.extend(O.p.postData,{filters:i}),M.each(["searchField","searchString","searchOper"],function(e,t){O.p.postData.hasOwnProperty(t)&&delete
O.p.postData[t]})):M.extend(O.p.postData,a),q.url&&(t=O.p.url,M(O).jqGrid("setGridParam",{url:q.url}));var
n="stop"===M(O).triggerHandler("jqGridToolbarBeforeClear");!n&&M.jgrid.isFunction(q.beforeClear)&&(n=q.beforeClear.call(O)),n||e&&M(O).jqGrid("setGridParam",{search:l}).trigger("reloadGrid",[{page:1}]),t&&M(O).jqGrid("setGridParam",{url:t}),M(O).triggerHandler("jqGridToolbarAfterClear"),M.jgrid.isFunction(q.afterClear)&&q.afterClear()},this.toggleToolbar=function(){var
e=M("tr.ui-search-toolbar",O.grid.hDiv);!0===O.p.frozenColumns&&M(O).jqGrid("destroyFrozenColumns"),"none"===e.css("display")?e.show():e.hide(),!0===O.p.frozenColumns&&M(O).jqGrid("setFrozenColumns")}}})},destroyFilterToolbar:function(){return this.each(function(){this.p.filterToolbar&&(this.triggerToolbar=null,this.clearToolbar=null,this.toggleToolbar=null,this.p.filterToolbar=!1,M(this.grid.hDiv).find("table thead tr.ui-search-toolbar").remove())})},refreshFilterToolbar:function(g){return g=M.extend(!0,{filters:"",onClearVal:null,onSetVal:null},g||{}),this.each(function(){var
s,i,o,e,l,n,p,c=this,u=c.p.colModel,d=c.p.colModel.length,h=[];if(c.p.filterToolbar){for(i=M(c).data("filterToolbar"),s=0;s<d;s++){switch(h.push(u[s].name),o=M("#gs_"+c.p.idPrefix+M.jgrid.jqID(u[s].name)),u[s].stype){case"select":case"text":o.val("")}M.jgrid.isFunction(g.onClearVal)&&g.onClearVal.call(c,o,u[s].name)}"string"==typeof
g.filters&&(g.filters.length?e=g.filters:c.p.postData.hasOwnProperty("filters")&&(e=c.p.postData.filters),e=M.jgrid.parse(e)),M.isPlainObject(e)&&function
e(t){if(t&&t.rules){for(l=t.rules,d=l.length,s=0;s<d;s++){var
r;n=l[s],-1!==(p=M.inArray(n.field,h))&&0<(o=M("#gs_"+c.p.idPrefix+M.jgrid.jqID(u[p].name))).length&&("select"===u[p].stype?o.find("option[value='"+M.jgrid.jqID(n.data)+"']").prop("selected",!0):"text"===u[p].stype&&o.val(n.data),M.jgrid.isFunction(g.onSetVal)&&g.onSetVal.call(c,o,u[p].name),i&&i.searchOperators&&(r=o.parent().prev()).hasClass("ui-search-oper")&&(M(".soptclass",r).attr("soper",n.op),i.operands.hasOwnProperty(n.op)&&M(".soptclass",r).html(i.operands[n.op])))}if(t.groups)for(var
a=0;a<t.groups.length;a++)e(t.groups[a])}}(e)}})},searchGrid:function(C){var
e=M.jgrid.getRegional(this[0],"search");return C=M.extend(!0,{recreateFilter:!1,drag:!0,sField:"searchField",sValue:"searchString",sOper:"searchOper",sFilter:"filters",loadDefaults:!0,beforeShowSearch:null,afterShowSearch:null,onInitializeSearch:null,afterRedraw:null,afterChange:null,sortStrategy:null,closeAfterSearch:!1,closeAfterReset:!1,closeOnEscape:!1,searchOnEnter:!1,multipleSearch:!1,multipleGroup:!1,top:0,left:0,jqModal:!0,modal:!1,resize:!0,width:450,height:"auto",dataheight:"auto",showQuery:!1,errorcheck:!0,sopt:null,stringResult:void
...
s=this;if(s.grid){var
t,r,a="fbox_"+s.p.id,i=!0,o=!0,l={themodal:"searchmod"+a,modalhead:"searchhd"+a,modalcontent:"searchcnt"+a,scrollelm:a},e=[],n=M.jgrid.styleUI[s.p.styleUI||"jQueryUI"].filter,p=M.jgrid.styleUI[s.p.styleUI||"jQueryUI"].common;if(C.styleUI=s.p.styleUI,"string"==typeof(t=M.isPlainObject(s.p._savedFilter)&&!M.isEmptyObject(s.p._savedFilter)?s.p._savedFilter:!0===s.p.mergeSearch&&s.p.searchModules.hasOwnProperty("searchGrid")&&!1!==s.p.searchModules.searchGrid?!0===s.p.searchModules.searchGrid?"":s.p.searchModules.searchGrid:s.p.postData[C.sFilter])&&(t=M.jgrid.parse(t)),!0===C.recreateFilter&&M("#"+M.jgrid.jqID(l.themodal)).remove(),void
0!==M("#"+M.jgrid.jqID(l.themodal))[0])G(M("#fbox_"+M.jgrid.jqID(s.p.id)));else{var
c=M("<div><div id='"+a+"' class='searchFilter' style='overflow:auto'></div></div>").insertBefore("#gview_"+M.jgrid.jqID(s.p.id)),u="left",d="";"rtl"===s.p.direction&&(u="right",d=" style='text-align:left'",c.attr("dir","rtl"));var
h,g=M.extend([],s.p.colModel),f="<a id='"+a+"_search' class='fm-button "+p.button+" fm-button-icon-right ui-search'><span class='"+p.icon_base+" "+n.icon_search+"'></span>"+C.Find+"</a>",m="<a id='"+a+"_reset' class='fm-button "+p.button+" fm-button-icon-left ui-reset'><span class='"+p.icon_base+" "+n.icon_reset+"'></span>"+C.Reset+"</a>",y="",v="",b=!1,j=-1,S=!1,F=[];C.showQuery&&(y="<a id='"+a+"_query' class='fm-button "+p.button+" fm-button-icon-left'><span class='"+p.icon_base+" "+n.icon_query+"'></span>Query</a>");var
O=M.jgrid.buildButtons(C.buttons,y+f,p),x=null;M(s).jqGrid("isGroupHeaderOn")&&(f=M("table.ui-jqgrid-htable",s.grid.hDiv).find(".jqg-second-row-header"),q=s.p.groupHeader.length,void
0!==f[0]&&(x=s.p.groupHeader[q-1]));var
q;if(C.columns.length)g=C.columns,h=g[j=0].index||g[0].name;else{if(null!==x)for(var
D=0;D<g.length;D++){var
w=function(e,t){for(var
r=t.length,a=0;a<r;a++)if(t[a].startColumnName===e)return a;return-1}(g[D].name,x.groupHeaders);if(0<=w){g[D].label=x.groupHeaders[w].titleText+"::"+s.p.colNames[D];for(var
I=1;I<=x.groupHeaders[w].numberOfColumns-1;I++)g[D+I].label=x.groupHeaders[w].titleText+"::"+s.p.colNames[D+I];D=D+x.groupHeaders[w].numberOfColumns-1}}M.each(g,function(e,t){var
r,a;t.label||(t.label=s.p.colNames[e]),b||(r=void
0===t.search||t.search,a=!0===t.hidden,(t.searchoptions&&!0===t.searchoptions.searchhidden&&r||r&&!a)&&(b=!0,h=t.index||t.name,j=e)),"select"===t.stype&&t.searchoptions&&t.searchoptions.multiple&&(S=!0,F.push(t.index||t.name))})}if((!t&&h||!1===C.multipleSearch)&&(q="eq",0<=j&&g[j].searchoptions&&g[j].searchoptions.sopt?q=g[j].searchoptions.sopt[0]:C.sopt&&C.sopt.length&&(q=C.sopt[0]),t={groupOp:"AND",rules:[{field:h,op:q,data:""}]}),b=!1,C.tmplNames&&C.tmplNames.length&&(b=!0,v="<tr><td class='ui-search-label'>"+C.tmplLabel+"</td>",v+="<td><select size='1' class='ui-template "+n.srSelect+"'>",v+="<option value='default'>Default</option>",M.each(C.tmplNames,function(e,t){v+="<option value='"+e+"'>"+t+"</option>"}),v+="</select></td></tr>"),void
0!==s.p.customFilterDef)for(var
_
in
s.p.customFilterDef)s.p.customFilterDef.hasOwnProperty(_)&&!C.operands.hasOwnProperty(_)&&(C.odata.push({oper:_,text:s.p.customFilterDef[_].text}),C.operands[_]=s.p.customFilterDef[_].operand,!0===s.p.customFilterDef[_].unary&&e.push(_));O="<table class='EditTable' style='border:0px none;margin-top:5px' id='"+a+"_2'><tbody><tr><td colspan='2'><hr class='"+p.content+"' style='margin:1px'/></td></tr>"+v+"<tr><td class='EditButton' style='text-align:"+u+"'>"+m+"</td><td class='EditButton' "+d+">"+O+"</td></tr></tbody></table>",a=M.jgrid.jqID(a),M("#"+a).jqFilter({columns:g,sortStrategy:C.sortStrategy,filter:C.loadDefaults?t:null,showQuery:C.showQuery,errorcheck:C.errorcheck,sopt:C.sopt,groupButton:C.multipleGroup,ruleButtons:C.multipleSearch,uniqueSearchFields:C.uniqueSearchFields,afterRedraw:C.afterRedraw,ops:C.odata,operands:C.operands,ajaxSelectOptions:s.p.ajaxSelectOptions,groupOps:C.groupOps,addsubgrup:C.addsubgrup,addrule:C.addrule,delgroup:C.delgroup,delrule:C.delrule,autoencode:s.p.autoencode,unaryOperations:e,onChange:function(){this.p.showQuery&&M(".query",this).html(this.toUserFriendlyString()),M.jgrid.isFunction(C.afterChange)&&C.afterChange.call(s,M("#"+a),C)},direction:s.p.direction,id:s.p.id}),c.append(O),M("#"+a+"_2").find("[data-index]").each(function(){var
t=parseInt(M(this).attr("data-index"),10);0<=t&&M(this).on("click",function(e){C.buttons[t].click.call(s,M("#"+a),C,e)})}),b&&C.tmplFilters&&C.tmplFilters.length&&M(".ui-template",c).on("change",function(){var
e=M(this).val();return"default"===e?M("#"+a).jqFilter("addFilter",t):M("#"+a).jqFilter("addFilter",C.tmplFilters[parseInt(e,10)]),!1}),!0===C.multipleGroup&&(C.multipleSearch=!0),M(s).triggerHandler("jqGridFilterInitialize",[M("#"+a)]),M.jgrid.isFunction(C.onInitializeSearch)&&C.onInitializeSearch.call(s,M("#"+a)),C.gbox="#gbox_"+M.jgrid.jqID(s.p.id);O=M(".ui-jqgrid").css("font-size")||"11px";C.layer?M.jgrid.createModal(l,c,C,"#gview_"+M.jgrid.jqID(s.p.id),M("#gbox_"+M.jgrid.jqID(s.p.id))[0],"string"==typeof
C.layer?"#"+M.jgrid.jqID(C.layer):C.layer,"string"==typeof
C.layer?{position:"relative","font-size":O}:{"font-size":O}):M.jgrid.createModal(l,c,C,"#gview_"+M.jgrid.jqID(s.p.id),M("#gbox_"+M.jgrid.jqID(s.p.id))[0],null,{"font-size":O}),(C.searchOnEnter||C.closeOnEscape)&&M("#"+M.jgrid.jqID(l.themodal)).keydown(function(e){var
t=M(e.target);return!C.searchOnEnter||13!==e.which||t.hasClass("add-group")||t.hasClass("add-rule")||t.hasClass("delete-group")||t.hasClass("delete-rule")||t.hasClass("fm-button")&&t.is("[id$=_query]")?C.closeOnEscape&&27===e.which?(M("#"+M.jgrid.jqID(l.modalhead)).find(".ui-jqdialog-titlebar-close").click(),!1):void
0:(M("#"+a+"_search").click(),!1)}),y&&M("#"+a+"_query").on("click",function(){return M(".queryresult",c).toggle(),!1}),void
0===C.stringResult&&(C.stringResult=C.multipleSearch),M("#"+a+"_search").on("click",function(){var
e,t={};return(r=M("#"+a)).find(".input-elm:focus").change(),S&&C.multipleSearch?(s.p._savedFilter={},e=M.jgrid.filterRefactor({ruleGroup:M.extend(!0,{},r.jqFilter("filterData")),ssfield:F,splitSelect:C.splitSelect,groupOpSelect:C.groupOpSelect}),s.p._savedFilter=M.extend(!0,{},r.jqFilter("filterData"))):e=r.jqFilter("filterData"),C.errorcheck&&(r[0].hideError(),C.showQuery||r.jqFilter("toSQLString"),r[0].p.error)?r[0].showError():(C.stringResult?(t[C.sFilter]=JSON.stringify(e),M.each([C.sField,C.sValue,C.sOper],function(){t[this]=""})):C.multipleSearch?(t[C.sFilter]=e,M.each([C.sField,C.sValue,C.sOper],function(){t[this]=""})):(t[C.sField]=e.rules[0].field,t[C.sValue]=e.rules[0].data,t[C.sOper]=e.rules[0].op,t[C.sFilter]=""),"string"!=typeof
t[C.sFilter]&&(t[C.sFilter]=JSON.stringify(t[C.sFilter])),(s.p.search=!0)===s.p.mergeSearch&&s.p.searchModules.hasOwnProperty("searchGrid")&&!1!==s.p.searchModules.searchGrid?(""!==t[C.sFilter]?s.p.searchModules.searchGrid=t[C.sFilter]:s.p.searchModules.searchGrid=null,M.extend(s.p.postData,{filters:M.jgrid.splitSearch(s.p.searchModules)})):M.extend(s.p.postData,t),void
0===(o=M(s).triggerHandler("jqGridFilterSearch"))&&(o=!0),o&&M.jgrid.isFunction(C.onSearch)&&(o=C.onSearch.call(s,s.p.filters)),!1!==o&&M(s).trigger("reloadGrid",[{page:1}]),C.closeAfterSearch&&M.jgrid.hideModal("#"+M.jgrid.jqID(l.themodal),{gb:"#gbox_"+M.jgrid.jqID(s.p.id),jqm:C.jqModal,onClose:C.onClose})),!1}),M("#"+a+"_reset").on("click",function(){var
e={},t=M("#"+a);return s.p.search=!1,!(s.p.resetsearch=!0)===C.multipleSearch?e[C.sField]=e[C.sValue]=e[C.sOper]="":e[C.sFilter]="",t[0].resetFilter(),b&&M(".ui-template",c).val("default"),!0===s.p.mergeSearch&&s.p.searchModules.hasOwnProperty("searchGrid")&&!1!==s.p.searchModules.searchGrid?(s.p.searchModules.searchGrid=null,M.extend(s.p.postData,{filters:M.jgrid.splitSearch(s.p.searchModules)}),s.p.search=!0):M.extend(s.p.postData,e),void
0===(o=M(s).triggerHandler("jqGridFilterReset"))&&(o=!0),o&&M.jgrid.isFunction(C.onReset)&&(o=C.onReset.call(s)),!1!==o&&M(s).trigger("reloadGrid",[{page:1}]),C.closeAfterReset&&M.jgrid.hideModal("#"+M.jgrid.jqID(l.themodal),{gb:"#gbox_"+M.jgrid.jqID(s.p.id),jqm:C.jqModal,onClose:C.onClose}),!1}),G(M("#"+a)),M(".fm-button:not(."+p.disabled+")",c).hover(function(){M(this).addClass(p.hover)},function(){M(this).removeClass(p.hover)})}}function
G(e){void
0===(i=M(s).triggerHandler("jqGridFilterBeforeShow",[e]))&&(i=!0),i&&M.jgrid.isFunction(C.beforeShowSearch)&&(i=C.beforeShowSearch.call(s,e)),i&&(M.jgrid.viewModal("#"+M.jgrid.jqID(l.themodal),{gbox:"#gbox_"+M.jgrid.jqID(s.p.id),jqm:C.jqModal,modal:C.modal,overlay:C.overlay,toTop:C.toTop}),M(s).triggerHandler("jqGridFilterAfterShow",[e]),M.jgrid.isFunction(C.afterShowSearch)&&C.afterShowSearch.call(s,e))}})},filterInput:function(o,l){return l=M.extend(!0,{defaultSearch:"cn",groupOp:"OR",searchAll:!1,beforeSearch:null,afterSearch:null},l||{}),this.each(function(){var
e,t,r,a,s,i=this;i.grid&&(t='{"groupOp":"'+l.groupOp+'","rules":[',r=0,o+="","local"===i.p.datatype&&(M.each(i.p.colModel,function(){e=this.index||this.name,a=this.searchoptions||{},a=l.defaultSearch||(a.sopt?a.sopt[0]:l.defaultSearch),this.search=!1!==this.search,(this.search||l.searchAll)&&(0<r&&(t+=","),t+='{"field":"'+e+'",',t+='"op":"'+a+'",',t+='"data":"'+o.replace(/\\/g,"\\\\").replace(/\"/g,'\\"')+'"}',r++)}),t+="]}",!0===i.p.mergeSearch&&i.p.searchModules.hasOwnProperty("filterInput")&&!1!==i.p.searchModules.filterInput?(i.p.searchModules.filterInput=0<r?t:null,M.extend(i.p.postData,{filters:M.jgrid.splitSearch(i.p.searchModules)})):M.extend(i.p.postData,{filters:t}),M.each(["searchField","searchString","searchOper"],function(e,t){i.p.postData.hasOwnProperty(t)&&delete
i.p.postData[t]}),!(s="stop"===M(i).triggerHandler("jqGridFilterInputBeforeSearch"))&&M.jgrid.isFunction(l.beforeSearch)&&(s=l.beforeSearch.call(i)),s||M(i).jqGrid("setGridParam",{search:!0}).trigger("reloadGrid",[{page:1}]),M(i).triggerHandler("jqGridFilterInputAfterSearch"),M.jgrid.isFunction(l.afterSearch)&&l.afterSearch.call(i)))})},autoSelect:function(c){return c=M.extend(!0,{field:"",direction:"asc",src_date:"Y-m-d",allValues:"All",count_item:!0,create_value:!0},c||{}),this.each(function(){var
e,t=this,r="";if(c.field&&t.p.data&&Array.isArray(t.p.data)){var
a,s,i,o,l,n,p=[];try{n=(l=M.jgrid.from.call(t,t.p.data).groupBy(c.field,c.direction,"text",c.src_date)).length}catch(e){}if(l&&l.length){for(a=M("#gsh_"+t.p.id+"_"+c.field).find("td.ui-search-input > select"),n=l.length,c.allValues&&(r="<option value=''>"+c.allValues+"</option>",p.push(":"+c.allValues));n--;)e=l[n],s=c.count_item?" ("+e.items.length+")":"",r+="<option value='"+e.unique+"'>"+e.unique+s+"</option>",p.push(e.unique+":"+e.unique+s);if(a.append(r),a.on("change",function(){t.triggerToolbar()}),c.create_value){for(n=0,o=t.p.colModel.length;n<o;n++)if(t.p.colModel[n].name===c.field){i=t.p.colModel[n];break}i&&(i.searchoptions?M.extend(i.searchoptions,{value:p.join(";")}):(i.searchoptions={},i.searchoptions.value=p.join(";")))}}}})}})});!function(e){"use strict";"function"==typeof
...
define&&define.amd?define(["jquery","./grid.base","./jquery.fmatter","./grid.utils"],e):e(jQuery)}(function(E){"use strict";E.jgrid=E.jgrid||{},E.extend(E.jgrid,{formatCell:function(e,t,r,l,o,a){return void
0!==l.formatter?(a={rowId:"",colModel:l,gid:o.p.id,pos:t,styleUI:"",isExported:!0,exporttype:a},E.jgrid.isFunction(l.formatter)?l.formatter.call(o,e,a,r):E.fmatter?E.fn.fmatter.call(o,l.formatter,e,a,r):e):e},formatCellCsv:function(t,e){t=null==t?"":String(t);try{t=E.jgrid.stripHtml(t.replace(e._regexsep,e.separatorReplace).replace(/\r\n/g,e.replaceNewLine).replace(/\n/g,e.replaceNewLine))}catch(e){t=""}return e.escquote&&(t=t.replace(e._regexquot,e.escquote+e.quote)),-1!==t.indexOf(e.separator)&&-1!==t.indexOf(e.qoute)||(t=e.quote+t+e.quote),t},excelCellPos:function(e){for(var
...
l=e.createElement(t);return r&&(r.attr&&E(l).attr(r.attr),r.children&&E.each(r.children,function(e,t){l.appendChild(t)}),r.hasOwnProperty("text")&&l.appendChild(e.createTextNode(r.text))),l},xmlToZip:function(o,e){var
a,d,n,i,p,s=this,m=new
XMLSerializer,f=-1===m.serializeToString(E.parseXML(E.jgrid.excelStrings["xl/worksheets/sheet1.xml"])).indexOf("xmlns:r"),u=[];E.each(e,function(e,t){if(E.isPlainObject(t))p=o.folder(e),s.xmlToZip(p,t);else{if(f){for(a=t.childNodes[0],d=a.attributes.length-1;0<=d;d--){var
...
e,t,w=this,r=w.p.treeGrid?E(w).jqGrid("getRowData",null,!0,k.treeindent):w.addLocalData(!0),l=r.length,o=w.p.colModel,a=o.length,d=w.p.colNames,n=0,i="",p="",s="",m="",f="",u=[],c="";E.jgrid.isFunction(k.loadIndicator)?k.loadIndicator("show"):k.loadIndicator&&E(w).jqGrid("progressBar",{method:"show",loadtype:w.p.loadui,htmlcontent:E.jgrid.getRegional(w,"defaults.loadtext")});var
g=[];if(E.each(o,function(e,t){t._expcol=!0,void
0===t.exportcol?t.hidden&&(t._expcol=!1):t._expcol=t.exportcol,"cb"!==t.name&&"rn"!==t.name&&"subgrid"!==t.name||(t._expcol=!1),t._expcol&&(u.push(E.jgrid.formatCellCsv(d[e],k)),g.push(t.name))}),k.includeLabels&&(f=u.join(k.separator)+k.newLine),k.collen=u.length,w.p.grouping){var
...
Array(m.collen),p=0,s=l;s<h;s++)y[s]._excol&&(a="{0}",E.each(d.summary,function(){if(this.nm===y[s].name){y[s].summaryTpl&&(a=y[s].summaryTpl),"string"==typeof
this.st&&"avg"===this.st.toLowerCase()&&(this.sd&&this.vd?this.v=this.v/this.vd:this.v&&0<n&&(this.v=this.v/n));try{this.groupCount=d.cnt,this.groupIndex=d.dataIndex,this.groupValue=d.value,o=this.v}catch(e){o=this.v}return i[p]=E.jgrid.formatCellCsv(E.jgrid.stripHtml(E.jgrid.template(a,o)),m),!1}}),p++);return i}E.each(y,function(e,t){for(var
r=0;r<g;r++)if(u.groupField[r]===t.name){c[r]=e;break}});var
F,b,v=E.makeArray(u.groupSummary);if(v.reverse(),"local"===w.p.datatype&&!w.p.loadonce){E(w).jqGrid("groupingSetup");for(var
e=E.jgrid.getMethod("groupingPrepare"),t=0;t<l;t++)e.call(E(w),r[t],t)}return E.each(u.groups,function(e,t){x++;try{F=Array.isArray(u.formatDisplayField)&&E.jgrid.isFunction(u.formatDisplayField[t.idx])?u.formatDisplayField[t.idx].call(w,t.displayValue,t.value,w.p.colModel[c[t.idx]],t.idx,u):w.formatter("",t.displayValue,c[t.idx],t.value)}catch(e){F=t.displayValue}var
r,l="";if("string"!=typeof(l=E.jgrid.isFunction(u.groupText[t.idx])?u.groupText[t.idx].call(w,F,t.cnt,t.summary):E.jgrid.template(u.groupText[t.idx],F,t.cnt,t.summary))&&"number"!=typeof
l&&(l=F),(r="header"===u.groupSummaryPos[t.idx]?I(e,0,u.groups,0):new
Array(m.collen))[0]=E.jgrid.formatCellCsv(E.jgrid.stripHtml(l),m),f+=r.join(m.separator)+m.newLine,g-1===t.idx){for(var
o,a,d,n=u.groups[e+1],l=t.startRow,i=void
0!==n?n.startRow:u.groups[e].startRow+u.groups[e].cnt,p=l;p<i&&s[+p];p++){for(a=s[+p],o=b=0;o<y.length;o++)y[o]._expcol&&(r[b]=E.jgrid.formatCellCsv(E.jgrid.formatCell(E.jgrid.getAccessor(a,y[o].name),o,a,y[o],w,"csv"),m),b++);f+=r.join(m.separator)+m.newLine}if("header"!==u.groupSummaryPos[t.idx]){if(void
...
for(;n<l;){for(e=r[n],F=[],x=t=0;x<a;x++)o[x]._expcol&&(F[t]=E.jgrid.formatCellCsv(E.jgrid.formatCell(E.jgrid.getAccessor(e,o[x].name),x,e,o[x],w,"csv"),k),t++);i+=F.join(k.separator)+k.newLine,n++}if(r=null,F=new
Array(k.collen),k.includeCaption&&w.p.caption){for(n=k.collen;--n;)F[n]="";F[0]=E.jgrid.formatCellCsv(w.p.caption,k),p+=F.join(k.separator)+k.newLine}if(k.includeGroupHeader&&E(w).jqGrid("isGroupHeaderOn"))for(var
h=w.p.groupHeader,x=0;x<h.length;x++){for(var
I=h[x].groupHeaders,n=0,F=[],b=0;b<g.length;b++){for(F[n]="",t=0;t<I.length;t++)I[t].startColumnName===g[b]&&(F[n]=E.jgrid.formatCellCsv(I[t].titleText,k));n++}s+=F.join(k.separator)+k.newLine}if(k.includeFooter&&w.p.footerrow&&E(".ui-jqgrid-ftable",this.sDiv).length){var
v=E(w).jqGrid("footerData","get");for(x=0,F=[];x<k.collen;){var
j=g[x];v.hasOwnProperty(j)&&F.push(E.jgrid.formatCellCsv(E.jgrid.stripHtml(v[j]),k)),x++}m+=F.join(k.separator)+k.newLine}if(k.includeHeader&&w.p.headerrow){var
C=E(w).jqGrid("headerData","get");for(x=0,F=[];x<k.collen;){var
B=g[x];C.hasOwnProperty(B)&&F.push(E.jgrid.formatCellCsv(E.jgrid.stripHtml(C[B]),k)),x++}c+=F.join(k.separator)+k.newLine}T=p+s+f+c+i+m,E.jgrid.isFunction(k.loadIndicator)?k.loadIndicator("hide"):k.loadIndicator&&E(w).jqGrid("progressBar",{method:"hide",loadtype:w.p.loadui})}),k.returnAsString)return T;if(-1!==k.mimetype.toUpperCase().indexOf("UTF-8")&&(T="\ufeff"+T),E.jgrid.isFunction(k.onBeforeExport)&&!(T=k.onBeforeExport(T)))throw"Before export does not return data!";E.jgrid.saveAs(T,k.fileName,{type:k.mimetype})},exportToExcel:function(P){P=E.extend(!0,{includeLabels:!0,includeGroupHeader:!0,includeFooter:!0,includeHeader:!0,fileName:"jqGridExport.xlsx",mimetype:"application/vnd.openxmlformats-officedocument.spreadsheetml.sheet",maxlength:40,onBeforeExport:null,replaceStr:null,treeindent:" ",loadIndicator:!0},P||{}),this.each(function(){for(var
F=this,e=E.jgrid.excelStrings,c=0,g=E.parseXML(e["xl/worksheets/sheet1.xml"]),y=g.getElementsByTagName("sheetData")[0],o=E.parseXML(e["xl/styles.xml"]),a=o.getElementsByTagName("numFmts")[0],d=E(a.getElementsByTagName("numFmt")),n=o.getElementsByTagName("cellXfs")[0],t={_rels:{".rels":E.parseXML(e["_rels/.rels"])},xl:{_rels:{"workbook.xml.rels":E.parseXML(e["xl/_rels/workbook.xml.rels"])},"workbook.xml":E.parseXML(e["xl/workbook.xml"]),"styles.xml":o,worksheets:{"sheet1.xml":g}},"[Content_Types].xml":E.parseXML(e["[Content_Types].xml"])},b=F.p.colModel,r=0,v={body:F.p.treeGrid?E(F).jqGrid("getRowData",null,!0,P.treeindent):F.addLocalData(!0),header:[],footer:[],width:[],map:[],parser:[]},l=0,i=b.length;l<i;l++)b[l]._expcol=!0,void
...
r,l,t;return E.isEmptyObject(e)?e.excel_parsers=!0:e.excel_format&&!e.excel_style&&(l=r=0,E.each(d,function(e,t){r++,l=Math.max(l,parseInt(E(t).attr("numFmtId"),10))}),t=E.jgrid.makeNode(o,"numFmt",{attr:{numFmtId:l+1,formatCode:e.excel_format}}),a.appendChild(t),E(a).attr("count",r+1),r=0,t=E.jgrid.makeNode(o,"xf",{attr:{numFmtId:l+1+"",fontId:"0",fillId:"0",borderId:"0",applyFont:"1",applyFill:"1",applyBorder:"1",xfId:"0",applyNumberFormat:"1"}}),n.appendChild(t),r=parseInt(E(n).attr("count"),10),E(n).attr("count",r+1),e.excel_style=r+1),e}(b[l].hasOwnProperty("exportoptions")?b[l].exportoptions:{}),r++);function
h(e,t){return E.jgrid.makeNode(g,"c",{attr:e,children:[E.jgrid.makeNode(g,"v",{text:t})]})}function
x(e,t){return E.jgrid.makeNode(g,"c",{attr:{t:"inlineStr",r:e},children:{row:E.jgrid.makeNode(g,"is",{children:{row:E.jgrid.makeNode(g,"t",{text:t})}})}})}var
I,w,j=E.jgrid.isFunction(P.replaceStr)?P.replaceStr:function(e){return e.replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/[\x00-\x09\x0B\x0C\x0E-\x1F\x7F-\x9F]/g,"")},C=function(e,t){I=c+1,w=E.jgrid.makeNode(g,"row",{attr:{r:I}});for(var
r,l,o=0;o<v.header.length;o++){var
a,d,n=E.jgrid.excelCellPos(o)+""+I;null==(u=Array.isArray(e)&&t?F.p.colNames[v.map[o]]:E.jgrid.getAccessor(e,v.header[o]))&&(u=""),t||(u=E.jgrid.formatCell(u,v.map[o],e,b[v.map[o]],F,"excel")),v.width[o]=Math.max(v.width[o],Math.min(parseInt(u.toString().length,10),P.maxlength)),a=null;var
i=v.parser[v.map[o]];if(!0===i.excel_parsers)for(var
p=0,s=E.jgrid.excelParsers.length;p<s;p++){var
m=E.jgrid.excelParsers[p];if(u.match&&!u.match(/^0\d+/)&&u.match(m.match)){var
f=u,u=u.replace(/[^\d\.\-]/g,"");if(m.fmt&&(u=m.fmt(u)),67===m.style)a=h({t:"d",r:n,s:m.style},u);else
if(4===m.style)r=f,l=void
0,(l=document.createElement("div")).innerHTML=r,a=(u="A"===(l=l.firstChild).nodeName?[l.href,l.text]:"#text"===l.nodeName&&[l.textContent,l.textContent])?(r={t:"str",r:n,s:m.style},l='HYPERLINK("'+u[0]+'","'+u[1]+'")',E.jgrid.makeNode(g,"c",{attr:r,children:[E.jgrid.makeNode(g,"f",{text:l})]})):x(n,f);else{if(E.inArray(m.style,["63","64","65","66"])&&15<u.toString().length){a=x(n,f.replace?j(f):f),w.appendChild(a);break}a=h({r:n,s:m.style},u)}w.appendChild(a);break}}else
void
0===i.excel_format||void
0===i.excel_style||t||a||(i.replace_format&&(u=i.replace_format(u)),a=h({r:n,s:i.excel_style},u),w.appendChild(a));a||(u.match&&(d=u.match(/^-?([1-9]\d+)(\.(\d+))?$/)),a="number"==typeof
u&&u.toString().length<=15||d&&d[1].length+(d[2]?d[3].length:0)<=15?h({t:"n",r:n},u):x(n,u.replace?j(u):u),w.appendChild(a))}y.appendChild(w),c++};if(E.jgrid.isFunction(P.loadIndicator)?P.loadIndicator("show"):P.loadIndicator&&E(F).jqGrid("progressBar",{method:"show",loadtype:F.p.loadui,htmlcontent:E.jgrid.getRegional(F,"defaults.loadtext")}),E("sheets sheet",t.xl["workbook.xml"]).attr("name",P.sheetName),P.includeGroupHeader&&E(F).jqGrid("isGroupHeaderOn")){for(var
p,s=F.p.groupHeader,m=[],f=0,u=0;u<s.length;u++){var
B=s[u].groupHeaders,k={};for(f++,l=l=0;l<v.header.length;l++){k[p=v.header[l]]="";for(var
T,_,N=0;N<B.length;N++)B[N].startColumnName===p&&(k[p]=B[N].titleText,T=E.jgrid.excelCellPos(l)+f,_=E.jgrid.excelCellPos(l+B[N].numberOfColumns-1)+f,m.push({ref:T+":"+_}))}C(k,!0)}E("row c",g).attr("s","2");var
S=E.jgrid.makeNode(g,"mergeCells",{attr:{count:m.length}});for(E("worksheet",g).append(S),r=0;r<m.length;r++)S.appendChild(E.jgrid.makeNode(g,"mergeCell",{attr:m[r]}))}if(P.includeLabels&&(C(v.header,!0),E("row",g).last().find("c").attr("s","2")),P.includeHeader||F.p.headerrow){var
A=E(F).jqGrid("headerData","get");for(r
in
A)A.hasOwnProperty(r)&&(A[r]=E.jgrid.stripHtml(A[r]));E.isEmptyObject(A)||(C(A,!0),E("row",g).last().find("c").attr("s","2"))}if(F.p.grouping){e=!!F.p.groupingView._locgr;F.p.groupingView._locgr=!1,function(s){var
m=F.p.groupingView,f=[],u=m.groupField.length,c=b.length,g=0;function
y(e,t,r,l){for(var
o,a,d=function(e,t,r){var
l,o=!1;if(0===t)o=r[e];else{var
a=r[e].idx;if(0===a)o=r[e];else
for(l=e;0<=l;l--)if(r[l].idx===a-t){o=r[l];break}}return o}(e,t,r),n=d.cnt,i=h(v.header),p=l;p<c;p++)b[p]._expcol&&(a="{0}",E.each(d.summary,function(){if(this.nm===b[p].name){b[p].summaryTpl&&(a=b[p].summaryTpl),"string"==typeof
this.st&&"avg"===this.st.toLowerCase()&&(this.sd&&this.vd?this.v=this.v/this.vd:this.v&&0<n&&(this.v=this.v/n));try{this.groupCount=d.cnt,this.groupIndex=d.dataIndex,this.groupValue=d.value,o=this.v}catch(e){o=this.v}return i[this.nm]=E.jgrid.stripHtml(E.jgrid.template(a,o)),!1}}));return i}function
h(e){for(var
t={},r=0;r<e.length;r++)t[e[r]]="";return t}E.each(b,function(e,t){for(var
r=0;r<u;r++)if(m.groupField[r]===t.name){f[r]=e;break}});var
x,I=E.makeArray(m.groupSummary);if(I.reverse(),"local"===F.p.datatype&&!F.p.loadonce){E(F).jqGrid("groupingSetup");for(var
...
r,l="";if("string"!=typeof(l=E.jgrid.isFunction(m.groupText[t.idx])?m.groupText[t.idx].call(F,x,t.cnt,t.summary):E.jgrid.template(m.groupText[t.idx],x,t.cnt,t.summary))&&"number"!=typeof
l&&(l=x),(r="header"===m.groupSummaryPos[t.idx]?y(e,0,m.groups,0):h(v.header))[Object.keys(r)[0]]=E.jgrid.stripHtml(new
...
u=E(v).jqGrid("headerData","get"),o=[];for(f=0;f<j.length;f++)a={text:E.jgrid.stripHtml(E.jgrid.getAccessor(u,j[f])),style:"tableFooter",alignment:C[j[f]]},o.push(a);w.push(o)}if(v.p.grouping){var
...
h(e,t){for(var
r=0,l=[],o=0;o<j.length;o++)a={text:null==e[j[o]]?"":t?E.jgrid.formatCell(e[j[o]]+"",i[r],d[n],c[i[r]],v,"pdf"):e[j[o]],alignment:C[o],style:"tableBody"},l.push(a),r++;return l}function
x(e,t,r,l){for(var
o,a,d=function(e,t,r){var
l,o=!1;if(0===t)o=r[e];else{var
a=r[e].idx;if(0===a)o=r[e];else
for(l=e;0<=l;l--)if(r[l].idx===a-t){o=r[l];break}}return o}(e,t,r),n=d.cnt,i=I(j),p=l;p<g;p++)c[p]._expcol&&(a="{0}",E.each(d.summary,function(){if(this.nm===c[p].name){c[p].summaryTpl&&(a=c[p].summaryTpl),"string"==typeof
this.st&&"avg"===this.st.toLowerCase()&&(this.sd&&this.vd?this.v=this.v/this.vd:this.v&&0<n&&(this.v=this.v/n));try{this.groupCount=d.cnt,this.groupIndex=d.dataIndex,this.groupValue=d.value,o=this.v}catch(e){o=this.v}return i[this.nm]=E.jgrid.stripHtml(E.jgrid.template(a,o)),!1}}));return i}function
I(e){for(var
t={},r=0;r<e.length;r++)t[e[r]]="";return t}E.each(c,function(e,t){for(var
r=0;r<u;r++)if(m.groupField[r]===t.name){f[r]=e;break}});var
F,b=E.makeArray(m.groupSummary);if(b.reverse(),"local"===v.p.datatype&&!v.p.loadonce){E(v).jqGrid("groupingSetup");for(var
...
r,l="";if("string"!=typeof(l=E.jgrid.isFunction(m.groupText[t.idx])?m.groupText[t.idx].call(v,F,t.cnt,t.summary):E.jgrid.template(m.groupText[t.idx],F,t.cnt,t.summary))&&"number"!=typeof
l&&(l=F),(r="header"===m.groupSummaryPos[t.idx]?x(e,0,m.groups,0):I(j))[Object.keys(r)[0]]=E.jgrid.stripHtml(new
...
for(var
g,n=0,y=d.length;n<y;n++){for(t=0,o=[],g=d[n],f=0;f<j.length;f++)a={text:null==g[j[f]]?"":E.jgrid.stripHtml(E.jgrid.formatCell(E.jgrid.getAccessor(g,j[f])+"",i[t],d[n],l[i[t]],v,"pdf")),alignment:C[j[f]],style:"tableBody"},o.push(a),t++;w.push(o)}if(F.includeFooter&&v.p.footerrow){var
h=E(v).jqGrid("footerData","get");for(o=[],f=0;f<j.length;f++)a={text:E.jgrid.stripHtml(E.jgrid.getAccessor(h,j[f])),style:"tableFooter",alignment:C[j[f]]},o.push(a);w.push(o)}var
x={pageSize:F.pageSize,pageOrientation:F.orientation,content:[{style:"tableExample",widths:p,table:{headerRows:null!=r?0:1,body:w}}],styles:{tableHeader:{bold:!0,fontSize:11,color:"#2e6e9e",fillColor:"#dfeffc",alignment:"center"},tableBody:{fontSize:10},tableFooter:{bold:!0,fontSize:11,color:"#2e6e9e",fillColor:"#dfeffc"},title:{alignment:"center",fontSize:15},description:{}},defaultStyle:{fontSize:10}};F.description&&x.content.unshift({text:F.description,style:"description",margin:[0,0,0,12]}),F.title&&x.content.unshift({text:F.title,style:"title",margin:[0,0,0,12]}),E.jgrid.isFunction(F.onBeforeExport)&&F.onBeforeExport.call(v,x);try{var
I=pdfMake.createPdf(x);I.getDataUrl(function(e){E.jgrid.isFunction(F.loadIndicator)?F.loadIndicator("hide"):F.loadIndicator&&E(v).jqGrid("progressBar",{method:"hide",loadtype:v.p.loadui})}),"open"===F.download?I.open():I.getBuffer(function(e){E.jgrid.saveAs(e,F.fileName,{type:F.mimetype})})}catch(e){throw e}})},exportToHtml:function(p){var
s;return p=E.extend(!0,{title:"",onBeforeExport:null,includeLabels:!0,includeGroupHeader:!0,includeFooter:!0,includeHeader:!0,tableClass:"jqgridprint",autoPrint:!1,topText:"",bottomText:"",returnAsString:!1,treeindent:"&nbsp;",loadIndicator:!0},p||{}),this.each(function(){var
b=this,v=b.p.colModel,e=0,w={body:b.p.treeGrid?E(b).jqGrid("getRowData",null,!0,p.treeindent):b.addLocalData(!0),header:[],footer:[],width:[],map:[],align:[]},t=0;for(d=v.length;t<d;t++)v[t]._expcol=!0,void
...
l,o=!1;if(0===t)o=r[e];else{var
a=r[e].idx;if(0===a)o=r[e];else
for(l=e;0<=l;l--)if(r[l].idx===a-t){o=r[l];break}}return o}(e,t,r),n=d.cnt,i=x(w.header),p=l;p<s;p++)v[p]._expcol&&(a="{0}",E.each(d.summary,function(){if(this.nm===v[p].name){v[p].summaryTpl&&(a=v[p].summaryTpl),"string"==typeof
this.st&&"avg"===this.st.toLowerCase()&&(this.sd&&this.vd?this.v=this.v/this.vd:this.v&&0<n&&(this.v=this.v/n));try{this.groupCount=d.cnt,this.groupIndex=d.dataIndex,this.groupValue=d.value,o=this.v}catch(e){o=this.v}return i[this.nm]=E.jgrid.stripHtml(E.jgrid.template(a,o)),!1}}));return i}function
x(e){for(var
t={},r=0;r<e.length;r++)t[e[r]]="";return t}E.each(v,function(e,t){for(var
r=0;r<c;r++)if(f.groupField[r]===t.name){u[r]=e;break}});var
I,F=E.makeArray(f.groupSummary);if(F.reverse(),"local"===b.p.datatype&&!b.p.loadonce){E(b).jqGrid("groupingSetup");for(var
...
r="";"string"!=typeof(r=E.jgrid.isFunction(f.groupText[t.idx])?f.groupText[t.idx].call(b,I,t.cnt,t.summary):E.jgrid.template(f.groupText[t.idx],I,t.cnt,t.summary))&&"number"!=typeof
r&&(r=I);var
...
for(var
e=0,d=w.body.length;e<d;e++)o+=j(w.body[e],"td",!0,0===e);if(p.includeFooter&&b.p.footerrow&&(w.footer=E(b).jqGrid("footerData","get",null,!1),o+=j(w.footer,"td",!1)),o+="</tbody>",o+="</table>",p.returnAsString)s=o;else{var
n=window.open("","");n.document.close();var
i=p.title?"<title>"+p.title+"</title>":"";E("style, link").each(function(){i+=function(e){e=E(e).clone()[0];return"link"===e.nodeName.toLowerCase()&&(e.href=l(e.href)),e.outerHTML}(this)});try{n.document.head.innerHTML=i}catch(e){E(n.document.head).html(i)}n.document.body.innerHTML=(p.title?"<h1>"+p.title+"</h1>":"")+"<div>"+(p.topText||"")+"</div>"+o+"<div>"+(p.bottomText||"")+"</div>",E(n.document.body).addClass("html-view"),E("img",n.document.body).each(function(e,t){t.setAttribute("src",l(t.getAttribute("src")))}),p.onBeforeExport&&p.onBeforeExport(n),Boolean(n.chrome)?p.autoPrint&&(n.print(),n.close()):setTimeout(function(){p.autoPrint&&(n.print(),n.close())},1e3)}E.jgrid.isFunction(p.loadIndicator)?p.loadIndicator("hide"):p.loadIndicator&&E(b).jqGrid("progressBar",{method:"hide",loadtype:b.p.loadui})}),s}})});!function(e){"use strict";"function"==typeof
define&&define.amd?define(["jquery"],e):e(jQuery)}(function($){"use strict";$.extend($.jgrid,{stringify:function(e){return JSON.stringify(e,function(e,t){return"function"==typeof
...
0===$.Widget?$.widget:$.Widget).prototype.destroy.apply(this,arguments)}),$.jgrid._multiselect=!0),$.jgrid.extend({sortableColumns:function(a){return this.each(function(){var
r=this,t=$.jgrid.jqID(r.p.id),e=!1;function
i(){r.p.disableClick=!0,r.p.frozenColumns&&($(r).jqGrid("destroyFrozenColumns"),e=!0)}function
o(){setTimeout(function(){r.p.disableClick=!1,e&&($(r).jqGrid("setFrozenColumns"),e=!1)},50)}var
s,d,t={tolerance:"pointer",axis:"x",scrollSensitivity:"1",items:">th:not(:has(#jqgh_"+t+"_cb,#jqgh_"+t+"_rn,#jqgh_"+t+"_subgrid),:hidden)",placeholder:{element:function(t){return $(document.createElement(t[0].nodeName)).addClass(t[0].className+" ui-sortable-placeholder ui-state-highlight").removeClass("ui-sortable-helper")[0]},update:function(t,e){e.height(t.currentItem.innerHeight()-parseInt(t.currentItem.css("paddingTop")||0,10)-parseInt(t.currentItem.css("paddingBottom")||0,10)),e.width(t.currentItem.innerWidth()-parseInt(t.currentItem.css("paddingLeft")||0,10)-parseInt(t.currentItem.css("paddingRight")||0,10))}},update:function(t,e){var
i=$(e.item).parent(),e=$(">th",i),i=r.p.colModel,o={},s=r.p.id+"_";$.each(i,function(t){o[this.name]=t});var
d=[];e.each(function(){var
...
d=[];$("option",o).each(function(){$(this).is(":selected")?s.jqGrid("showCol",a[this.value].name):s.jqGrid("hideCol",a[this.value].name)}),$("option[selected]",o).each(function(){d.push(parseInt(this.value,10))}),$.each(d,function(){delete
r[a[parseInt(this,10)].name]}),$.each(r,function(){var
t,e,i,o,s=parseInt(this,10);t=d,i=e=s,d=0<=e?(s=(o=t.slice()).splice(e,Math.max(t.length-e,e)),e>t.length&&(e=t.length),o[e]=i,o.concat(s)):t}),e.done&&e.done.call(s,d),s.jqGrid("setGridWidth",s[0].p.width,s[0].p.shrinkToFit)},cleanup:function(t){p(e.dlog,i,"destroy"),p(e.msel,o,"destroy"),i.remove(),t&&e.done&&e.done.call(s)},msel_opts:{}},c,e||{}),$.ui&&$.ui.multiselect&&$.ui.multiselect.defaults){if(!$.jgrid._multiselect)return void
alert("Multiselect plugin loaded after jqGrid. Please load the plugin before the jqGrid!");e.msel_opts=$.extend($.ui.multiselect.defaults,e.msel_opts)}e.caption&&i.attr("title",e.caption),e.classname&&(i.addClass(e.classname),o.addClass(e.classname)),e.width&&($(">div",i).css({width:e.width,margin:"0 auto"}),o.css("width",e.width)),e.height&&($(">div",i).css("height",e.height),o.css("height",e.height-10)),o.empty(),$.each(a,function(t){r[this.name]=t,this.hidedlg?this.hidden||d.push(t):o.append("<option value='"+t+"' "+(this.hidden?"":"selected='selected'")+">"+$.jgrid.stripHtml(n[t])+"</option>")}),t=$.jgrid.isFunction(e.dlog_opts)?e.dlog_opts.call(s,e):e.dlog_opts,p(e.dlog,i,t),c=$.jgrid.isFunction(e.msel_opts)?e.msel_opts.call(s,e):e.msel_opts,p(e.msel,o,c),t=$("#colchooser_"+$.jgrid.jqID(s[0].p.id));var
...
u(){var
t=l(o),e=t.container.closest(".ui-dialog-content");0<e.length&&"object"==typeof
e[0].style?e[0].style.width="":e.css("width",""),t.selectedList.height(Math.max(t.selectedContainer.height()-t.selectedActions.outerHeight()-1,1)),t.availableList.height(Math.max(t.availableContainer.height()-t.availableActions.outerHeight()-1,1))}},sortableRows:function(s){return this.each(function(){var
o=this;o.grid&&(o.p.treeGrid||$.fn.sortable&&((s=$.extend({cursor:"move",axis:"y",items:" > .jqgrow"},s||{})).start&&$.jgrid.isFunction(s.start)?(s._start_=s.start,delete
s.start):s._start_=!1,s.update&&$.jgrid.isFunction(s.update)?(s._update_=s.update,delete
s.update):s._update_=!1,s.start=function(t,e){if($(e.item).css("border-width","0"),$("td",e.item).each(function(t){this.style.width=o.grid.cols[t].style.width}),o.p.subGrid){var
i=$(e.item).attr("id");try{$(o).jqGrid("collapseSubGridRow",i)}catch(t){}}s._start_&&s._start_.apply(this,[t,e])},s.update=function(t,e){$(e.item).css("border-width",""),!0===o.p.rownumbers&&$("td.jqgrid-rownum",o.rows).each(function(t){$(this).html(t+1+(parseInt(o.p.page,10)-1)*parseInt(o.p.rowNum,10))}),s._update_&&s._update_.apply(this,[t,e])},$(o).find("tbody").first().sortable(s),$("tbody",o).first().find(" > .jqgrow").disableSelection()))})},gridDnD:function(o){return this.each(function(){var
t,e,d=this;if(d.grid&&!d.p.treeGrid&&$.fn.draggable&&$.fn.droppable){var
h;if(void
0===$("#jqgrid_dnd")[0]&&$("body").append("<table id='jqgrid_dnd' class='ui-jqgrid-dnd'></table>"),"string"!=typeof
o||"updateDnD"!==o||!0!==d.p.jqgdnd){if((o=$.extend({drag:function(s){return $.extend({start:function(t,e){var
i,o;if(d.p.subGrid){o=$(e.helper).attr("id");try{$(d).jqGrid("collapseSubGridRow",o)}catch(t){}}for(i=0;i<$.data(d,"dnd").connectWith.length;i++)0===$($.data(d,"dnd").connectWith[i]).jqGrid("getGridParam","reccount")&&$($.data(d,"dnd").connectWith[i]).jqGrid("addRowData","jqg_empty_row",{});e.helper.addClass("ui-state-highlight"),$("td",e.helper).each(function(t){this.style.width=d.grid.headers[t].width+"px"}),s.onstart&&$.jgrid.isFunction(s.onstart)&&s.onstart.call($(d),t,e)},stop:function(t,e){var
i,o;for(e.helper.dropped&&!s.dragcopy&&(void
0===(o=$(e.helper).attr("id"))&&(o=$(this).attr("id")),$(d).jqGrid("delRowData",o)),i=0;i<$.data(d,"dnd").connectWith.length;i++)$($.data(d,"dnd").connectWith[i]).jqGrid("delRowData","jqg_empty_row");s.onstop&&$.jgrid.isFunction(s.onstop)&&s.onstop.call($(d),t,e)}},s.drag_opts||{})},drop:function(u){return $.extend({accept:function(t){if(!$(t).hasClass("jqgrow"))return t;h=$(t).closest("table.ui-jqgrid-btable");var
...
i,o=$(e.draggable).attr("id"),s=e.draggable.parent().parent().jqGrid("getRowData",o),d=[],r=$(this).find("table.ui-jqgrid-btable").first()[0];if($.isPlainObject(s)&&(d=Object.keys(s)),!u.dropbyname){var
a,n,l={},c=0,p=$("#"+$.jgrid.jqID(r.id)).jqGrid("getGridParam","colModel");try{for(a=0;a<p.length;a++)"cb"!==(n=p[a].name)&&"rn"!==n&&"subgrid"!==n&&(void
0!==d[c]&&(l[n]=s[d[c]]),c++);s=l}catch(t){}}e.helper.dropped=!0,$.data(h[0],"dnd").beforedrop&&$.jgrid.isFunction($.data(h[0],"dnd").beforedrop)&&(null!=(o=$.data(h[0],"dnd").beforedrop.call(r,t,e,s,$(h[0]),$(r)))&&"object"==typeof
o&&(s=o)),e.helper.dropped&&(u.autoid&&(i=$.jgrid.isFunction(u.autoid)?u.autoid.call(r,s):(i=Math.ceil(1e3*Math.random()),u.autoidprefix+i)),$("#"+$.jgrid.jqID(r.id)).jqGrid("addRowData",i,s,u.droppos)),u.ondrop&&$.jgrid.isFunction(u.ondrop)&&u.ondrop.call(r,t,e,s)}}},u.drop_opts||{})},onstart:null,onstop:null,beforedrop:null,ondrop:null,drop_opts:{activeClass:"ui-state-active",hoverClass:"ui-state-hover",tolerance:"intersect"},drag_opts:{revert:"invalid",helper:"clone",cursor:"move",appendTo:"#jqgrid_dnd",zIndex:5e3},dragcopy:!1,dropbyname:!1,droppos:"first",autoid:!0,autoidprefix:"dnd_"},o||{})).connectWith)for(o.connectWith=o.connectWith.split(","),o.connectWith=$.map(o.connectWith,function(t){return $.jgrid.trim(t)}),$.data(d,"dnd",o),0===d.p.reccount||d.p.jqgdnd||i(),d.p.jqgdnd=!0,t=0;t<o.connectWith.length;t++)e=o.connectWith[t],$(e).closest(".ui-jqgrid-bdiv").droppable($.jgrid.isFunction(o.drop)?o.drop.call($(d),o):o.drop)}else
i()}function
i(){var
t=$.data(d,"dnd");$("tr.jqgrow:not(.ui-draggable)",d).draggable($.jgrid.isFunction(t.drag)?t.drag.call($(d),t):t.drag)}})},gridResize:function(opts){return this.each(function(){var
$t=this,gID=$.jgrid.jqID($t.p.id),req,optstest;$t.grid&&$.fn.resizable&&(opts=$.extend({},opts||{}),opts.alsoResize?(opts._alsoResize_=opts.alsoResize,delete
